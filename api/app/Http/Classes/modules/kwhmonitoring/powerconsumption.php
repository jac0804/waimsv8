...
class powerconsumption
{
    private $fieldClass;
    private $tabClass;
    public $modulename = 'Power Consumption Category';
    public $gridname = 'inventory';
    private $companysetup;
    private $coreFunctions;
    private $table = 'powercat';
    private $othersClass;
    private $logger;
    ...
    public function createTab($config)
    {
        ...
        $stockbuttons = ['save', 'delete', 'addsubpowercat'];
    ...
    public function delete($config)
    {
        ...
        $qry = "select group_concat(name) as name from (
                    select distinct name,catid from subpowercat where catid=?
                    union all
                    select distinct name,catid from subpowercat2 where catid=?) as x
                     group by catid";
        $count = $this->coreFunctions->opentable($qry, [$row['line'], $row['line']]);
        if (!empty($count)) {
