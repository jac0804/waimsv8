...
class entrysubpowercat2
{
    private $fieldClass;
    private $tabClass;
    public $modulename = 'Sub-Category (Level 2)';
    public $gridname = 'inventory';
    private $companysetup;
    private $coreFunctions;
    private $table = 'subpowercat2';
    private $othersClass;
    private $logger;
    ...
    private $fields = ['name', 'catid', 'subcatid'];
    ...
    public function createTab($config)
    {
        ...
        $this->modulename = $config['params']['row']['name'] . ' - Sub-Category (Level 2)';
    ...
    public function add($config)
    {
        $data = [];
        $data['line'] = 0;
        $data['catid'] = $config['params']['sourcerow']['catid'];
        $data['subcatid'] = $config['params']['sourcerow']['line'];
        $data['name'] = '';
    ...
    public function loaddata($config)
    {
        ...
        $select = $this->selectqry();
        $select = $select . ",'' as bgcolor ";
        $qry = "select " . $select . " from " . $this->table . " where subcatid=? order by line";
