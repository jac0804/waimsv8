...
class entrydeliverytype
{
  private $fieldClass;
  private $tabClass;
  public $modulename = 'Delivery Type Masterfile';
  public $gridname = 'inventory';
  private $companysetup;
  private $coreFunctions;
  private $table = 'deliverytype';
  private $othersClass;
  ...
  private function report_default_query($config)
  {
    ...
    $query = "select name from deliverytype
    order by line";
  ...
  private function rpt_default_header($data, $filters)
  {
    ...
    $str .= $this->reporter->col('DELIVERY TYPE MASTERFILE', '800', null, false, '1px solid ', '', 'L', 'Century Gothic', '18', 'B', '', '');
    ...
    $str .= $this->reporter->begintable('800');
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('Delivery Type Name', '400', null, false, '1px solid ', 'B', 'L', 'Century Gothic', '12', 'B', '', '2px');
    $str .= $this->reporter->endrow();
    return $str;
  }
