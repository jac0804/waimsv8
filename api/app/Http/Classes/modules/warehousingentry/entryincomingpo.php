...
class entryincomingpo
{
  private $fieldClass;
  private $tabClass;
  public $modulename = 'INCOMING PO';
  ...
  {
    $tab = [$this->gridname => ['gridcolumns' => ['docno', 'itemname', 'uom', 'qty', 'amt', 'ext']]];
  ...
  {
    $qry = " 
      head.trno, head.docno, item.itemname, stock.uom, 
      stock.rrqty as qty, stock.rrcost as amt, stock.ext
    ";
    return $qry;
  }
  ...
  public function loaddata($config)
  {
    ...
    where stock.itemid = '$itemid' and stock.qa = 0";
