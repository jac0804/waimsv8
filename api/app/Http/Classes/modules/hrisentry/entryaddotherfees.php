...
namespace App\Http\Classes\modules\entrollemntentry;
...
class entryaddotherfees
{
    ...
    {
        $tab = [$this->gridname => ['gridcolumns' => ['action', 'description']]];

        $stockbuttons = ['save', 'delete'];
        $obj = $this->tabClass->createtab($tab, $stockbuttons);

        $obj[0][$this->gridname]['columns'][0]['style'] = "width:80px;whiteSpace: normal;min-width:80px;"; //action
        $obj[0][$this->gridname]['columns'][1]['readonly'] = true; //description
    ...
    from jobtskills as js  left join skillrequire as sr on sr.line=js.skills";
    }
