...
class qt
{
  ...
  public $damt = 'isamt';
  public $hamt = 'amt';
  public $fields = ['trno', 'docno', 'dateid', 'due', 'client', 'clientname', 'yourref', 'ourref', 'rem', 'terms', 'forex', 'cur', 'wh', 'address', 'agent', 'tin', 'agentcno'];
  ...
  public function posttrans($config)
  {
    ...
    $qry = "insert into " . $this->hhead . "(trno,doc,docno,client,clientname,address,dateid,
      ...
      head.due,head.cur FROM " . $this->head . " as head left join cntnum on cntnum.trno=head.trno
  ...
  public function unposttrans($config)
  {
    ...
    $qry = "insert into " . $this->head . "(trno,doc,docno,client,clientname,address,dateid,terms,rem,forex,
        yourref,ourref,createdate,createby,editby,editdate,lockdate,lockuser,wh,due,cur,agent)
        ...
        head.createby, head.editby, head.editdate, head.lockdate, head.lockuser,head.wh,head.due,head.cur,head.agent
  ...
  private function getstockselect($config)
  {
    ...
    stock.line,
    item.barcode, 
    ifnull(info.itemdesc,'') as itemname,
    stock.uom, 
    stock.iss,
  ...
  public function default_header($params, $data)
  {
    ...
    $str .= $this->reporter->col('QOUTATION', '600', null, false, $border, '', 'L', $font, '18', 'B', '', '');
