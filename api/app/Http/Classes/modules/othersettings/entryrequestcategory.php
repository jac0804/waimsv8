...
class entryrequestcategory
{
    ...
    private function selectqry()
    {
        ...
        case when isreassigned=0 then 'false' else 'true' end as isreassigned,
    ...
    public function saveallentry($config)
    {
        ...
        foreach ($data as $key => $value) {
            ...
            if ($data[$key]['bgcolor'] != '') {
                ...
                $data2['isoracle'] = $this->othersClass->sanitizekeyfieldFast('isoracle', $data[$key]['isoracle'], $lookups);
