...
class detachment
{
  ...
  public function createTab($access, $config)
  {
    ...
    data_set($col1, 'num.class', 'csnum sbccsreadonly');
    ...
    data_set($col1, 'numdays.class', 'csnumdays sbccsreadonly');
    ...
    data_set($col1, 'hours.class', 'cshours sbccsreadonly');
    ...
    data_set($col1, 'monthsno.class', 'csmonthsno sbccsreadonly');
    ...
    data_set($col1, 'nodays.class', 'csnodays sbccsreadonly');
    ...
    data_set($col1, 'othrs.class', 'csothrs sbccsreadonly');
    ...
    data_set($col1, 'workloc.class', 'csworkloc sbccsreadonly');
    ...
    data_set($col2, 'basicrate.class', 'csbasicrate sbccsreadonly');
    ...
    data_set($col2, 'tbasicrate.class', 'cstbasicrate sbccsreadonly');
    ...
    data_set($col2, 'othrsextra.class', 'csothrsextra sbccsreadonly');
    ...
    data_set($col2, 'cola.class', 'cscola sbccsreadonly');
    ...
    data_set($col2, 'apothrs.class', 'csapothrs sbccsreadonly');
    ...
    data_set($col2, 'paymentname.class', 'cspaymentname sbccsreadonly');
    ...
    data_set($col2, 'opincentive.class', 'csopincentive sbccsreadonly');
    ...
    data_set($col2, 'tallowrate.class', 'cstallowrate sbccsreadonly');
    ...
    data_set($col3, 'leadfrom.class', 'csleadfrom sbccsreadonly');
    ...
    data_set($col3, 'sss.class', 'cssss sbccsreadonly');
    ...
    data_set($col3, 'phic.class', 'csphic sbccsreadonly');
    ...
    data_set($col3, 'hdmf.class', 'cshdmf sbccsreadonly');
    ...
    data_set($col3, 'escalation.class', 'csescalation sbccsreadonly');
    ...
    data_set($col3, 'agentcno.class', 'csagentcno sbccsreadonly');
    ...
    data_set($col3, 'taxdef.class', 'cstaxdef sbccsreadonly');
    ...
    data_set($col3, 'fcontractprice.class', 'csfcontractprice sbccsreadonly');
    ...
    // $tab = ['multiinput1' => ['inputcolumn' => ['col1' => $col1,'col2' => $col2, 'col3' => $col3, 'col4'=>$col4], 'label' => 'CONTRACT RATE']];

    $tab = [ 'multiinput1' => ['inputcolumn' => [  'col1' => $col1,  'col2' => $col2, 'col3' => $col3,'col4' => $col4],'label' => 'CONTRACT RATE'],
             'tableentry' => ['action' => 'payrollentry', 'lookupclass' => 'contracthistory', 'label' => 'CONTRACT HISTORY' ] ];
