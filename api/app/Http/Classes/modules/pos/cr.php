...
class cr
{
  ...
  public function loaddoclisting($config)
  {
    ...
    head.createby,head.editby,head.viewby,num.postedby, date(num.postdate) as postdate,
     ...
     where head.doc=? and head.layref<>'' and num.center = ? and CONVERT(head.dateid,DATE)>=? and CONVERT(head.dateid,DATE)<=? " . $condition . " " . $filtersearch . "
  ...
  public function createTab($access, $config)
  {
    ...
    // $obj[0][$this->gridname]['columns'][$acno]['style'] = 'width: 150px;whiteSpace: normal;min-width:150px;max-width:150px;';
    ...
    $obj[0][$this->gridname]['columns'][$clientname]['label'] = 'Supplier/Customer Name';


    $obj[0][$this->gridname]['columns'][$acno]['type'] = 'label';
    $obj[0][$this->gridname]['columns'][$acno]['label'] = 'Account No.';

    $obj[0][$this->gridname]['columns'][$acnoname]['type'] = 'label';
    $obj[0][$this->gridname]['columns'][$acnoname]['label'] = 'Account Description';
  ...
  public function createHeadField($config)
  {
    ...
    $fields = [['dateid', 'station'], 'dprojectname', ['yourref', 'ourref'], 'layref'];
    $col2 = $this->fieldClass->create($fields);
    data_set($col2, 'ourref.label', 'Type');
    ...
    data_set($col4, 'lblpaid.style', 'font-family:Century Gothic; color:white; font-size:20px;font-weight:bold;');
