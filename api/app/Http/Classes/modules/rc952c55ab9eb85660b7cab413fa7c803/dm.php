...
class dm
{
    ...
    private $stockselect;
    private $fields = ['trno', 'docno', 'dateid', 'due', 'client', 'clientname', 'yourref', 'ourref', 'rem', 'terms', 'forex', 'cur', 'wh', 'address', 'contra', 'tax', 'vattype', 'projectid', 'subproject', 'branch', 'deptid', 'billid', 'shipid', 'billcontactid', 'shipcontactid', 'returndate', 'refunddate', 'phaseid', 'modelid', 'blklotid', 'amenityid', 'subamenityid'];
    ...
    {
        $column = ['action', 'barcode', 'isqty', 'uom', 'itemname', 'isamt', 'disc', 'ext', 'wh', 'ref', 'rem'];
        $sortcolumn = ['action', 'barcode', 'isqty', 'uom', 'itemname', 'isamt', 'disc', 'ext', 'wh', 'ref', 'rem'];
        ...
        $obj[0]['inventory']['columns'][$action]['style'] = 'width: 100px;whiteSpace: normal;min-width:100px;max-width:100px';
   ...
   FROM $this->stock as stock
    ...
    public function createdistribution($config)
    {
        ...
        $qry = '
          select head.dateid,head.client,head.tax,head.contra,head.cur,head.forex,stock.ext,wh.client as wh,ifnull(item.asset,"") as asset,ifnull(item.revenue,"") as
          revenue,stock.isamt,stock.disc,stock.isqty,stock.cost,stock.iss,stock.fcost,head.projectid
