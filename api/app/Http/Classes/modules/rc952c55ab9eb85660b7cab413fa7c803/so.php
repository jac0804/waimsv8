...
class so
{
    ...
    public $damt = 'isamt';
    public $hamt = 'amt';
    public $fields = ['trno', 'docno', 'dateid', 'due', 'client', 'clientname', 'yourref', 'ourref', 'rem', 'terms', 'forex', 'cur', 'wh', 'address', 'agent', 'creditinfo', 'projectid', 'ms_freight', 'mlcp_freight', 'shipto', 'sano', 'pono', 'salestype', 'statid', 'phaseid', 'modelid', 'blklotid', 'amenityid', 'subamenityid', 'tax', 'vattype'];
    ...
    public function createTab($access, $config)
    {
        ...
        $column = ['action', 'barcode', 'isqty', 'uom', 'itemname', 'isamt', 'disc', 'ext', 'rem', 'qa', 'void'];
        $sortcolumn = ['action', 'barcode', 'isqty', 'uom', 'itemname', 'isamt', 'disc', 'ext', 'rem', 'qa', 'void'];
    ...
    public function openhead($config)
    {
        ...
        info.driverid, info.checkerid, info.truckid, info.helperid, info.plateno,
        info.tmpref,
             head.tax,
             head.vattype,
             '' as dvattype";
