...
class mt
{
  ...
  private $fieldClass;
  private $tabClass;
  public $modulename = 'MATERIAL TRANSFER';
  ...
  private $fields = ['trno', 'docno', 'dateid', 'due', 'client', 'clientname', 'yourref', 'ourref', 'rem', 'wh', 'projectid',  'projectto'];
  ...
  public function createtabbutton($config)
  {
    ...
    $obj[$pendingpr]['action'] = "pendingprdetail";
    $obj[$pendingpr]['lookupclass'] = "pendingprdetail_pr";
  ...
  public function createHeadField($config)
  {
    ...
    $fields = ['dateid', 'dprojectname2', 'client'];
  ...
  public function loadheaddata($config)
  {
    ...
    $qryselect = "select 
         ...
         '' as dprojectname,'' as dprojectname2,ifnull(project.code,'') as projectcode ,
         ifnull(project2.code,'') as projectcode2,ifnull(project2.name,'') as projectname2,head.projectto  ";
  ...
  public function openstock($trno, $config)
  {
    ...
    left join stagesmasterfile as st on st.line = stock.stageid where stock.tstrno=0 and stock.trno =? 
    UNION ALL  
    " . $sqlselect . "  
    ...
    left join stagesmasterfile as st on st.line = stock.stageid where stock.tstrno=0 and stock.trno =? order by line";
  ...
  public function setserveditems($refx, $linex)
  {
    ...
    glhead.trno where glhead.doc='TD' and glstock.refx=" . $refx . " and glstock.linex=" . $linex;
