...
class gc
{
  ...
  private $fields = ['trno', 'docno', 'dateid', 'client', 'clientname', 'address', 'yourref', 'ourref', 'rem', 'terms', 'forex', 'cur', 'projectid', 'phaseid', 'modelid', 'blklotid', 'amenityid', 'subamenityid'];
  ...
  public function createdoclisting($config)
  {
    ...
    if ($companyid == 56) { //homeworks
      $getcols = ['action', 'liststatus', 'listdocument', 'listdate', 'client', 'listclientname', 'yourref', 'ourref', 'listpostedby', 'listcreateby', 'listeditby', 'listviewby'];
    } else {
  ...
  public function createtab2($access, $config)
  {
    ...
    if ($companyid == 10) { //afti
      $particularstab = ['tableentry' => ['action' => 'tableentry', 'lookupclass' => 'entryparticulars', 'label' => 'Particulars', 'access' => 'view']];
      $particulars = $this->tabClass->createtab($particularstab, []);
      $return['Particulars'] = ['icon' => 'fa fa-envelope', 'tab' => $particulars];

      $notescreditmemo = ['customform' => ['action' => 'customform', 'lookupclass' => 'notescreditmemo']];
      $return['NOTES'] = ['icon' => 'fa fa-question-circle', 'customform' => $notescreditmemo];
    }
  ...
  public function createTab($access, $config)
  {
    ...
    $columns = ['action', 'acno', 'acnoname', 'db', 'cr', 'postdate', 'checkno', 'client', 'project', 'ref', 'poref', 'podate', 'acnoname', 'rem'];
  ...
  public function createHeadField($config)
  {
    ...
    if ($systype == 'REALESTATE') {
      $fields = [['dateid', 'terms'], 'address', ['yourref', 'ourref']];
    }
  ...
  {
    $qry = " 
            head.trno,left(head.dateid,10) as dateid,d.ref,d.line,coa.acno,coa.acnoname,
            ...
            subam.description as subamenityname,d.sortline  ";
    return $qry;
  }
