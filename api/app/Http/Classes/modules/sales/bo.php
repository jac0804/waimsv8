...
class bo
{
  ...
  public function loaddoclisting($config)
  {
    ...
    switch ($companyid) {
      ...
      case 12: //afti usd
        ...
        head.createby,head.editby,head.viewby,num.postedby,
         head.yourref, head.ourref,ds.receiveby,ds.receivedate,terms.terms,terms.days';
        $orderby = "order by dateid desc, docno desc";
        break;
      case 19: //housegem
        $dateid = "left(head.dateid,10) as dateid";
      ...
      case 24: //goodfound
        ...
        $gjoin = 'left join trxstatus as stat on stat.line=num.statid';
        break;
      default:
        if ($searchfilter == "") $limit = 'limit 150';
        break;
    ...
    head.createby,head.editby,head.viewby,num.postedby,
     ...
     union all
     select head.trno,head.docno,head.clientname,$dateid,$gstat as status,$gstatcolor as statuscolor,
     head.createby,head.editby,head.viewby, num.postedby,
  ...
  public function createHeadField($config)
  {
    ...
    switch ($companyid) {
      case 10: //afti
        ...
        break;
      case 11: //summit
        array_push($fields, 'ms_freight');
        break;
      case 15: //nathina
        array_push($fields, 'dprojectname', 'mlcp_freight', 'ms_freight');
        break;
    }
    ...
    switch ($companyid) {
      case 10: //afti
        $fields = [['yourref', 'ourref'], ['cur', 'forex'], ['dvattype', 'taxdef'], 'dagentname'];
        break;
    }
