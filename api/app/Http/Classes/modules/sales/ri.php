...
class ri
{
  ...
  private $fieldClass;
  private $tabClass;
  public $modulename = 'Repossesed Units';
  ...
  public function createTab($access, $config)
  {
    ...
    $column = ['action', 'itemdescription', 'rrqty', 'uom', 'kgs', 'isamt', 'disc', 'ext', 'cost', 'wh', 'ref', 'loc', 'expiry', 'rem', 'pallet', 'location', 'itemname', 'barcode'];
    $sortcolumn = ['action', 'itemdescription', 'rrqty', 'uom', 'kgs', 'isamt', 'disc', 'ext', 'cost', 'wh', 'ref', 'loc', 'expiry', 'rem', 'pallet', 'location', 'itemname', 'barcode'];
  ...
  public function loadheaddata($config)
  {
    ...
    $qryselect = "select
         ...
         head.branch,'' as dbranchname, head.billid, head.shipid, head.billcontactid, head.shipcontactid,num.statid ";
  ...
  private function getstockselect($config)
  {
    ...
    stock.phaseid,  stock.modelid,stock.blklotid,
    prj.code as project,
  ...
  public function setserveditems($refx, $linex)
  {
    ...
    stock on stock.trno=head.trno where head.doc in ('CM','DN','RI') and stock.refx=" . $refx . " and stock.linex=" . $linex;

    $qry1 = $qry1 . " union all select glstock." . $this->hqty . " from glhead left join glstock on glstock.trno=
    glhead.trno where glhead.doc in ('CM','DN','RI') and glstock.refx=" . $refx . " and glstock.linex=" . $linex;
