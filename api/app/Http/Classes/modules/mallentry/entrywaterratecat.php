...
class entrywaterratecat
{
  private $fieldClass;
  private $tabClass;
  public $modulename = 'WATER RATE CATEGORY';
  ...
  private $fields = ['category', 'iswater'];
  ...
  {
    $qry = "
    head.line, head.category, head.iswater";
    return $qry;
  }
  ...
  public function delete($config)
  {
    ...
    $qry = "
      select categoryid as value from waterrate where categoryid=?
    ";
  ...
  private function loaddataperrecord($line)
  {
    ...
    where head.iswater = 1 and head.line=?";
  ...
  public function loaddata($config)
  {
    ...
    $qry = "select " . $select . " 
    from " . $this->table . " as head
    where head.iswater = 1 " . $filtersearch . "
