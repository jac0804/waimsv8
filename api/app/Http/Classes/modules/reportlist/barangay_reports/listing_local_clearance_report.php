...
class listing_local_clearance_report
{
    public $modulename = 'Listing Local Clearance  Report';
    ...
    public function displayHeader($config)
    {
        ...
        $str .= $this->reporter->begintable($layoutsize);
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col('BARANGAY DONA IMELDA', null, null, false, null, null, 'L', $font, '15', 'B', '', '');
        $str .= $this->reporter->endrow();
        $str .= $this->reporter->endtable();

        $str .= $this->reporter->begintable($layoutsize);
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col('LOCAL CLEARANCE LIST', null, null, false, '10px solid ', '', 'L', $font, '15', 'B', '#800000');
        $str .= $this->reporter->endrow();
        $str .= $this->reporter->endtable();
