...
class employee_13th_month_pay
{
  ...
  public function createHeadField($config)
  {
    ...
    if ($companyid == 68) {
      $fields = ['start', 'end','tpaygroup','radioreporttype'];
    }
  ...
  // public function JDA_query($config)
  // {
  //   $companyid = $config['params']['companyid'];
  //   $reporttype = $config['params']['dataparams']['reporttype'];
  //   // switch ($companyid) {
  ...
  //   switch ($reporttype) {
  //     case '0': // SUMMARY
  //       return $this->JDA_SUMMARY_QRY($config);
  //       break;

  //     case '1': // DETAIL
  //       return $this->JDA_DETAIL_QRY($config);
  //       break;
  //   }
  //       // break;
  //   // }
  ...
  public function JDA_SUMMARY_QRY($config)
  {
    // QUERY
    $client     = $config['params']['dataparams']['client'];
    $divid     = $config['params']['dataparams']['divid'];
  ...
  public function JDA_DETAIL_QRY($config)
  {
    // QUERY
    $client     = $config['params']['dataparams']['client'];
    $divid     = $config['params']['dataparams']['divid'];
  ...
  public function JDA_SUMMARY_Layout($config)
  {
    ...
    $result = $this->JDA_SUMMARY_QRY($config);
    $border = '1px solid';
    $border_line = '';
    $alignment = '';
    $font = $this->companysetup->getrptfont($config['params']);
  ...
  {
    $result = $this->JDA_DETAIL_QRY($config);
