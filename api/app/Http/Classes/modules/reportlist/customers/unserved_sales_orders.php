...
class unserved_sales_orderS
{
  public $modulename = 'Unserved Sales Orders';
  ...
  public function paramsdata($config)
  {
    ...
    $paramstr = "select
          ...
          '' as clientname,
          '' as dclientname,
          '' as dagentname,'' as agent,'' as agentid,'' as agentname,
  ...
  public function reportDefault($config)
  {
    ...
    $query = "select client.clientname as cgrp,
          ...
          client.clientname, item.itemname, item.groupid, item.brand, item.class,stock.disc,
          ...
          head.yourref, item.itemid,item.barcode,'' as subcode,'' as partno,stock.amt,
  ...
  private function default_displayHeader($config)
  {
    ...
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('UNSERVED SALES ORDERS', null, null, false, $border, '', '', $font, '18', 'B', '', '') . '<br />';
    $str .= $this->reporter->endrow();
    $str .= $this->reporter->endtable();
    ...
    $str .= $this->reporter->col('Customer : ' . strtoupper($cus), '575', null, false, $border, '', 'L', $font, $fontsize, '', 'b', '');
    $str .= $this->reporter->col('Center : ' . $filtercenter, '575', null, false, $border, '', 'L', $font, $fontsize, '', 'b', '');
    $str .= $this->reporter->endrow();

    $str .= $this->reporter->startrow(NULL, null, false, $border, '', 'R', $font, $fontsize, '', 'b', '');
    $str .= $this->reporter->col('Agent : ' . strtoupper($age), '575', null, false, $border, '', 'L', $font, $fontsize, '', 'b', '');
    $str .= $this->reporter->col('Date Range :  ' . $start . ' ' . '-' . ' ' . $end, '575', null, false, $border, '', 'L', $font, $fontsize, '', 'b', '');
