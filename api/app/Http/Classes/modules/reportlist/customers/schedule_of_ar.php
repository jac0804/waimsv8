...
class schedule_of_ar
{
    public $modulename = 'Schedule of AR';
    ...
    public function reportDefault_QUERY_POSTED($config)
    {
        ...
        $query = "select clientname, name,crlimit,sum(db) as db,sum(cr) as cr,
                        ...
                        left join client on client.client=h.client
                                ...
                                group by clientid) as a where a.clientid=x.clientid) as pdc " . $addfield . "
                from (select 'p' as tr,detail.trno, detail.clientid,client.client,client.clientname, 
                ...
                group by clientid,client,clientname, name,crlimit " . $addfield . " order by clientname";
