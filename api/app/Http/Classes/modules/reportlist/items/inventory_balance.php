...
class inventory_balance
{
  ...
  private function transpower_selling_price_table_cols($layoutsize, $border, $font, $fontsize, $config)
  {
    ...
    // } else {
    $str .= $this->reporter->col('ITEM CODE', '80', null, false, '1px solid ', 'B', 'L', $font, '10', 'B', '', $padding, '8px');
    $str .= $this->reporter->col('ITEM DESCRIPTION', '550', null, false, '1px solid ', 'B', 'L', $font, '10', 'B', '', $padding, '8px');
    $str .= $this->reporter->col('GROUP', '100', null, false, '1px solid ', 'B', 'L', $font, '10', 'B', '', $padding, '8px');
    $str .= $this->reporter->col('UOM', '50', null, false, '1px solid ', 'B', 'C', $font, '10', 'B', '', $padding, '8px');
    $str .= $this->reporter->col('BALANCE', '80', null, false, '1px solid ', 'B', 'R', $font, '10', 'B', '', $padding, '8px');
    $str .= $this->reporter->col('SRP', '80', null, false, '1px solid ', 'B', 'R', $font, '10', 'B', '', $padding, '8px');
    $str .= $this->reporter->col('TOTAL', '80', null, false, '1px solid ', 'B', 'R', $font, '10', 'B', '', $padding, '8px');
    $str .= $this->reporter->col('COUNT', '80', null, false, '1px solid ', 'B', 'C', $font, '10', 'B', '', $padding, '8px');
    $str .= $this->reporter->endrow();
    return $str;
  }
  ...
  public function transpower_layout_SELLING_PRICE($config)
  {
    ...
    try {
      ...
      foreach ($result as $key => $data) {
        ...
        $str .= $this->reporter->col($data->uom, '50', null, false, '1px solid ', '', 'CT', $font, $font_size, '', '', '');
        $str .= $this->reporter->col($balance, '80', null, false, '1px solid ', '', 'RT', $font, $font_size, '', '', '');
        $str .= $this->reporter->col(number_format($discounted, 2), '80', null, false, '1px solid ', '', 'RT', $font, $font_size, '', '', '');
        $str .= $this->reporter->col($totalext, '80', null, false, '1px solid ', '', 'RT', $font, $font_size, '', '', '');
        $str .= $this->reporter->col('', '80', null, false, '1px solid ', 'B', 'CT', $font, $font_size, '', '', '');
        $str .= $this->reporter->endrow();
      ...
      $str .= $this->reporter->begintable($layoutsize);
      $str .= $this->reporter->startrow();
      $str .= $this->reporter->col('OVERALL STOCKS :', '780', null, false, '1px solid ', 'TB', 'L', $font, $font_size, 'B', '', '', '');
      $str .= $this->reporter->col(number_format($totalbalqty, 2), '160', null, false, '1px solid ', 'TB', 'L', $font, $font_size, 'B', '', '', '');
      $str .= $this->reporter->col(number_format($grandtotal, 2), '160', null, false, '1px solid ', 'TB', 'L', $font, $font_size, 'B', '', '', '');
      $str .= $this->reporter->endrow();
      $str .= $this->reporter->endtable();
  ...
  private function transpower_latest_cost_table_cols($layoutsize, $border, $font, $fontsize, $config)
  {
    ...
    $str .= $this->reporter->begintable($layoutsize);
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('ITEM CODE', '80', null, false, '1px solid ', 'B', 'L', $font, '10', 'B', '', '', '8px');
    $str .= $this->reporter->col('ITEM DESCRIPTION', '550', null, false, '1px solid ', 'B', 'L', $font, '10', 'B', '', '', '8px');
    $str .= $this->reporter->col('GROUP', '100', null, false, '1px solid ', 'B', 'L', $font, '10', 'B', '', '', '8px');
    $str .= $this->reporter->col('UOM', '50', null, false, '1px solid ', 'B', 'C', $font, '10', 'B', '', '', '8px');
    ...
    $str .= $this->reporter->col('TOTAL', '80', null, false, '1px solid ', 'B', 'R', $font, '10', 'B', '', '', '8px');
    $str .= $this->reporter->col('COUNT', '80', null, false, '1px solid ', 'B', 'C', $font, '10', 'B', '', '', '8px');
  ...
  public function reportDefaultLayout_SELLING_PRICE($config)
  {
    ...
    try {
      ...
      foreach ($result as $key => $data) {
        ...
        // Yung commented part ay condition para sa may mga casing na company na tumatawag sa itemname
        // if ($companyid == 47) { // kitchenstar
        //   $itemnameWidth = 400;
        ...
        $lines = $this->reporter->estimateRowLines([
          // [$itemnameValue, $itemnameWidth, '0px'],
          [$data->itemname, 400, '6px'],
          [$data->loc, 100, '6px'],
          [$data->expiry, 100, '6px'],
        ], $font_size);
        ...
        //     $this->reporter->linecounter = 0;
        //     // $page = $page + $count;   
        //     // reset instead of $page = $page + $count;
        //   }
        // }
      }
  ...
  public function reportDefaultLayout_LATEST_COST($config)
  {
    ...
    foreach ($result as $key => $data) {
      ...
      $lines = $this->reporter->estimateRowLines(array(
        // array($itemnameValue, $itemnameWidth, '0px'),
        array($data->itemname, 440, '6px'),
        array($data->loc, 100, '6px'),
        array($data->expiry, 100, '6px'),
      ), $font_size);
      ...
      // Purpose nito sa casing ng company
      // if ($multiheader) {
      //   if ($this->reporter->linecounter >= $page) {
      //     $str .= $this->reporter->endtable();
      //     $str .= $this->reporter->page_break();
  ...
  private function transpower_none_table_cols($layoutsize, $border, $font, $fontsize, $config)
  {
    ...
    $str .= $this->reporter->col('ITEM CODE', '80', null, false, '1px solid ', 'B', 'L', $font, '10', 'B', '', '', '8px');
    $str .= $this->reporter->col('ITEM DESCRIPTION', '590', null, false, '1px solid ', 'B', 'L', $font, '10', 'B', '', '', '8px');
    $str .= $this->reporter->col('GROUP', '100', null, false, '1px solid ', 'B', 'L', $font, '10', 'B', '', '', '8px');
    $str .= $this->reporter->col('BALANCE', '70', null, false, '1px solid ', 'B', 'R', $font, '10', 'B', '', '', '8px');
    if ($itemstock != '(0,1)') {
      $str .= $this->reporter->col('SRP', '70', null, false, '1px solid ', 'B', 'C', $font, '10', 'B', '', '', '8px');
      $str .= $this->reporter->col('TOTAL', '70', null, false, '1px solid ', 'B', 'C', $font, '10', 'B', '', '', '8px');
    } else {
      $str .= $this->reporter->col('MIN', '70', null, false, '1px solid ', 'B', 'R', $font, '10', 'B', '', '', '8px');
      $str .= $this->reporter->col('MAX', '70', null, false, '1px solid ', 'B', 'R', $font, '10', 'B', '', '', '8px');
    }
    $str .= $this->reporter->col('UOM', '50', null, false, '1px solid ', 'B', 'C', $font, '10', 'B', '', '', '8px');
    $str .= $this->reporter->col('COUNT', '70', null, false, '1px solid ', 'B', 'C', $font, '10', 'B', '', '', '8px');
    return $str;
  }
  ...
  public function transpower_NONE_Layout($config)
  {
    ...
    try {
      ...
      foreach ($result as $key => $data) {
        ...
        $str .= $this->reporter->col($data->groupname, '100', null, false, '1px solid ', '', 'LT', $font, $font_size, '', '', '');
        $str .= $this->reporter->col($balance, '70', null, false, '1px solid ', '', 'RT', $font, $font_size, '', '', '');
        if ($itemstock != '(0,1)') {
          $str .= $this->reporter->col('', '70', null, false, '1px solid ', '', 'C', $font, $font_size, '', '', '');
          $str .= $this->reporter->col($isamt, '70', null, false, '1px solid ', '', 'RT', $font, $font_size, '', '', '');
        } else {
          $str .= $this->reporter->col(number_format($data->minimum, 2), '70', null, false, '1px solid ', '', 'RT', $font, $font_size, '', '', '');
          $str .= $this->reporter->col(number_format($data->maximum, 2), '70', null, false, '1px solid ', '', 'RT', $font, $font_size, '', '', '');
        }
        $str .= $this->reporter->col($data->uom, '50', null, false, '1px solid ', '', 'CT', $font, $font_size, '', '', '');
        $str .= $this->reporter->col('', '70', null, false, '1px solid ', 'B', 'CT', $font, $font_size, '', '', '');
        $str .= $this->reporter->endrow();
        $scatgrp = strtoupper($data->category);
        $part = strtoupper($data->part);
        $igrp = isset($data->stockgrp_name) ? strtoupper($data->stockgrp_name) : '';
      ...
      $str .= $this->reporter->startrow();
      $str .= $this->reporter->col('OVERALL STOCKS :', '770', null, false, '1px solid ', 'TB', 'L', $font, $font_size, 'B', '', '', '');
      $str .= $this->reporter->col(number_format($totalbalqty, 2), '140', null, false, '1px solid ', 'TB', 'L', $font, $font_size, 'B', '', '', '');
      $str .= $this->reporter->col('', '190', null, false, '1px solid ', 'TB', 'R', $font, $font_size, 'B', '', '', '');
      $str .= $this->reporter->endrow();
      $str .= $this->reporter->endtable();
      $str .= $this->reporter->printline();
      $str .= $this->reporter->endreport();
