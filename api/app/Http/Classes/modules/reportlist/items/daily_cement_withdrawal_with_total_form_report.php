...
class daily_cement_withdrawal_with_total_form_report
{
  public $modulename = 'Daily Cement Withdrawal With Total Form Report';
  ...
  private function default_displayHeader($config)
  {
    ...
    $str .= $this->reporter->col('WT. AV', '60', null, false, $border, 'TL', 'C', $font, $fontsize - 1, '', '', '');
    $str .= $this->reporter->col('UNIT PRICE', '50', null, false, $border, 'TL', 'C', $font, $fontsize - 1, '', '', '');
    $str .= $this->reporter->col('TOTAL', '50', null, false, $border, 'TLR', 'C', $font, $fontsize - 1, '', '', '');
    $str .= $this->reporter->endrow();
    return $str;
  }
  ...
  public function reportDefaultLayout($config, $result)
  {
    ...
    foreach ($result as $key => $data) {
      ...
      $str .= $this->reporter->col(number_format($data->weightavg, 2), '60', null, false, $border, 'TL', 'R', $font, $fontsize - 1, '', '', '');
      $str .= $this->reporter->col(number_format($data->unitprice, 2), '50', null, false, $border, 'TL', 'R', $font, $fontsize - 1, '', '', '');
      $str .= $this->reporter->col(number_format($data->amt, 2), '50', null, false, $border, 'TLR', 'R', $font, $fontsize - 1, '', '', '');
    ...
    $str .= $this->reporter->col(number_format($totalweightin, 2), '50', null, false, $border, 'T', 'C', $font, $fontsize - 1, '', '', '');
    $str .= $this->reporter->col('', '50', null, false, $border, 'T', 'C', $font, $fontsize - 1, '', '', '');
    $str .= $this->reporter->col('', '50', null, false, $border, 'T', 'C', $font, $fontsize - 1, '', '', '');
    $str .= $this->reporter->col(number_format($totalweightout, 2), '50', null, false, $border, 'T', 'C', $font, $fontsize - 1, '', '', '');
    $str .= $this->reporter->col('', '50', null, false, $border, 'T', 'C', $font, $fontsize - 1, '', '', '');
    $str .= $this->reporter->col(number_format($totalweightavg, 2), '60', null, false, $border, 'T', 'R', $font, $fontsize - 1, '', '', '');
    $str .= $this->reporter->col('', '50', null, false, $border, 'T', 'R', $font, $fontsize - 1, '', '', '');
    $str .= $this->reporter->col(number_format($totalamt, 2), '50', null, false, $border, 'T', 'R', $font, $fontsize - 1, '', '', '');
