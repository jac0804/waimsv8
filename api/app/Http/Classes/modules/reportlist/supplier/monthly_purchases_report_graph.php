...
class monthly_purchases_report_graph
{
  public $modulename = 'Monthly Purchases Report Graph';
  ...
  public function reportdata($config)
  {
    ...
    $graph = $this->default_montly_purchases_graph($config, $result);
  ...
  private function generateDefaultHeader($params)
  {
    ...
    $str .= $this->reporter->begintable('800');
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('Monthly Purchases Report Graph YEAR (' . $params['params']['dataparams']['year'] . ')', null, null, '', '1px solid ', '', 'l', $font, '18', 'B', '', '');
    $str .= $this->reporter->endrow();
    $str .= $this->reporter->startrow('');
  ...
  private function default_montly_purchases_graph($config, $data)
  {
    $year = date('Y');
