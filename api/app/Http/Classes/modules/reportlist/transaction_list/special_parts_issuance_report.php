...
class special_parts_issuance_report
{
  public $modulename = 'Special Parts Issuance Report';
  ...
  public function default_QUERY_POSTED($config)
  {
    ...
    switch ($reporttype) {
      case '1': //detailed
        ...
        left(head.dateid,10) as dateid,stock.ref,head.rem as hrem,item.subcode,item.partno,m.model_name as model, partrequest.name as partreqtype,deliverytype.name as deliverytypename from glstock as stock
        ...
        where head.doc='sh' and head.dateid between '$start' 
        and '$end' $filter
      ...
      case '0': //summary
        ...
        date(head.dateid) as dateid,partrequest.name as partreqtype,deliverytype.name as deliverytypename
        ...
        wh.clientname, wh.client, head.dateid,partrequest.name,deliverytype.name
        order by docno $sorting";
        break;
    }
  ...
  public function default_QUERY_UNPOSTED($config)
  {
    ...
    switch ($reporttype) {
      case '1': //detailed
        $query = "select head.yourref,head.docno,head.clientname as supplier,item.barcode,item.itemname,stock.uom," . $isqty . " as iss,
        stock.isamt,stock.disc,stock.ext,wh.clientname,head.createby,stock.loc,stock.rem,
        left(head.dateid,10) as dateid,stock.ref,head.rem as hrem,item.subcode,item.partno,m.model_name as model, partrequest.name as partreqtype,deliverytype.name as deliverytypename from lastock as stock
      ...
      case '0': //summary
        $query = "select 'UNPOSTED' as status ,head.yourref,
          ...
          left join partrequest on partrequest.line = head.partreqtypeid
          left join deliverytype on deliverytype.line = head.deliverytype
          where head.doc='sh' and head.dateid between '$start' and '$end' $filter 
          group by head.docno,head.yourref,head.clientname,
          wh.clientname,head.dateid, wh.client,partrequest.name,deliverytype.name
  ...
  public function header_DEFAULT($config)
  {
    ...
    $str .= $this->reporter->col('Special Parts Issuance Report (' . $reporttype . ')', null, null, false, $border, '', '', $font, '18', 'B', '', '') . '<br />';
    ...
    if (!empty($result)) {
      foreach ($result as $key => $data) {
        ...
        if ($docno == "" || $docno != $data->docno) {
          ...
          $str .= $this->reporter->begintable($layoutsize);
          $str .= $this->reporter->startrow();
          $str .= $this->reporter->col('Quantity', '45', null, false, $border, 'B', 'C', $font, $fontsize, 'B', '', '', '');
          $str .= $this->reporter->col('UOM', '45', null, false, $border, 'B', 'C', $font, $fontsize, 'B', '', '', '');
          $str .= $this->reporter->col('SKU', '45', null, false, $border, 'B', 'C', $font, $fontsize, 'B', '', '', '');
          $str .= $this->reporter->col('OLD SKU', '45', null, false, $border, 'B', 'C', $font, $fontsize, 'B', '', '', '');
          ...
          $str .= $this->reporter->col('Model', '45', null, false, $border, 'B', 'C', $font, $fontsize, 'B', '', '', '');
          $str .= $this->reporter->col('Remarks', '45', null, false, $border, 'B', 'C', $font, $fontsize, 'B', '', '', '');
          $str .= $this->reporter->col('Unit Price', '45', null, false, $border, 'B', 'C', $font, $fontsize, 'B', '', '', '');
          $str .= $this->reporter->col('(+/-) %', '45', null, false, $border, 'B', 'C', $font, $fontsize, 'B', '', '', '');
          $str .= $this->reporter->col('Total Price', '45', null, false, $border, 'B', 'C', $font, $fontsize, 'B', '', '', '');
          $str .= $this->reporter->col('Location', '45', null, false, $border, 'B', 'C', $font, $fontsize, 'B', '', '', '');
          $str .= $this->reporter->col('Reference', '45', null, false, $border, 'B', 'C', $font, $fontsize, 'B', '', '', '');
        ...
        $str .= $this->reporter->begintable($layoutsize);
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col(number_format($data->iss, 2), '45', null, false, $border, '', 'C', $font, $fontsize, '', '', '', '');
        $str .= $this->reporter->col($data->uom, '45', null, false, $border, '', 'C', $font, $fontsize, '', '', '', '');
        $str .= $this->reporter->col($data->barcode, '45', null, false, $border, '', 'C', $font, $fontsize, '', '', '', '');
        $str .= $this->reporter->col($data->subcode, '45', null, false, $border, '', 'C', $font, $fontsize, '', '', '', '');
        $str .= $this->reporter->col($data->partno, '150', null, false, $border, '', 'C', $font, $fontsize, '', '', '', '');
        $str .= $this->reporter->col($data->itemname, '150', null, false, $border, '', 'L', $font, $fontsize, '', '', '', '');
        $str .= $this->reporter->col($data->model, '45', null, false, $border, '', 'C', $font, $fontsize, '', '', '', '');
        $str .= $this->reporter->col($data->rem, '45', null, false, $border, '', 'C', $font, $fontsize, '', '', '', '');
        $str .= $this->reporter->col(number_format($data->isamt, 2), '45', null, false, $border, '', 'C', $font, $fontsize, '', '', '', '');
        $str .= $this->reporter->col($data->disc, '45', null, false, $border, '', 'C', $font, $fontsize, '', '', '', '');
        $str .= $this->reporter->col(number_format($data->ext, 2), '45', null, false, $border, '', 'C', $font, $fontsize, '', '', '', '');
        $str .= $this->reporter->col($data->loc, '45', null, false, $border, '', 'C', $font, $fontsize, '', '', '', '');
        $str .= $this->reporter->col($data->ref, '45', null, false, $border, '', 'R', $font, $fontsize, '', '', '', '');
  ...
  public function tableheader($layoutsize, $config)
  {
    ...
    $str .= $this->reporter->col('PART REQUEST', '100', null, false, $border, 'TB', 'C', $font, $fontsize, 'B', '', '');
