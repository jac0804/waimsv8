...
class list_of_warehouses_or_vessels_per_type
{
  public $modulename = 'List of Warehouses/Vessels per Type';
  ...
  private function displayHeader($config)
  {
    ...
    $str .= $this->reporter->begintable($this->reportParams['layoutSize']);
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('List of Warehouses/Vessels per Type', null, null, false, '10px solid ', '', '', $font, '18', 'B', '', '');
    $str .= $this->reporter->endrow();
    $str .= $this->reporter->endtable();
