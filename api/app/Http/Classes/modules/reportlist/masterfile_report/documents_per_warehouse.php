...
class documents_per_warehouse
{
    public $modulename = 'DOCUMENTS PER WHSE';
    ...
    {
        $fields = ['radioprint', 'expiry1', 'expiry2', 'start', 'end', 'oicname', 'vesse', 'dwhname'];
    ...
    private function displayHeader($config)
    {
        ...
        $str .= $this->reporter->begintable($this->reportParams['layoutSize']);
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col('DOCUMENTS PER WHSE', null, null, false, '10px solid ', '', '', $font, '18', 'B', '', '');
        $str .= $this->reporter->endrow();
        ...
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col('Warehouse: ' . $whname, null, null, false, '10px solid ', '', '', $font, $font_size, '', '', '');
        if ($expiry1 == "" || $expiry2 == "") {
        ...
        $str .= $this->reporter->begintable($this->reportParams['layoutSize']);
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col('Document', '310', null, false, $border, 'TB', 'C', $font, $font_size, 'B', '', '');
