...
class entryholiday
{
  private $fieldClass;
  private $tabClass;
  public $modulename = 'HOLIDAY';
  public $gridname = 'inventory';
  private $companysetup;
  private $coreFunctions;
  private $table = 'waims_holiday';
  private $othersClass;
  public $style = 'width:100%;';
  public $tablelogs = 'masterfile_log';
  public $tablelogs_del = 'del_masterfile_log';
  private $fields = ['datestart', 'dateend', 'title', 'rem', 'color'];
  ...
  public function createTab($config)
  {
    $tab = [
      $this->gridname => [
        'gridcolumns' => ['action', 'datestart', 'dateend', 'title', 'rem', 'colorselect']
      ]
    ];
