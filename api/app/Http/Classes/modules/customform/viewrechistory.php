...
class viewrechistory
{
    private $fieldClass;
    private $tabClass;
    public $modulename = 'REPLACEMENT CHEQUE HISTORY';
    ...
    public function createTab($config)
    {
        ...
        $cols = ['docno', 'dateid', 'agentname', 'yourref', 'ourref', 'checkdate',  'bank', 'branch', 'checkno', 'amount', 'rcchecks', 'ref', 'amount2',  'notes'];
        ...
        $obj[0][$this->gridname]['columns'][$amount2]['style'] = 'text-align: right;width:100px;whiteSpace: normal;min-width:100px;';
        $obj[0][$this->gridname]['columns'][$amount2]['align'] = 'text-right';
        $obj[0][$this->gridname]['columns'][$amount2]['label'] = 'Replacement Amount';
        $obj[0][$this->gridname]['columns'][$ref]['label'] = 'Reference Doc';
    ...
    public function loaddata($config)
    {
        ...
        where head.doc = 'RE'  and customer.clientid= '$clientid' and head.dateid>='$date' and cntnum.center = '$center' and p.line is not null
