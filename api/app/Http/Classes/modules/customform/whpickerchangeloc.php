...
class whpickerchangeloc
{
    ...
    public $modulename = 'AVAILABLE LOCATIONS (Change Loc.)';
    ...
    public function getheaddata($config)
    {
        ...
        $drqty = $config['params']['addedparams'][4];
        ...
        if ($sjtype == 'REPLACEMENT') {
            ...
            round(" . $replaceqty . "," . $this->companysetup->getdecimal('qty', $config['params']) . ") as isqty, rep.pickerstart,
            case when rep.pickerstart is null then 'FOR PICKING' else 'PICKED' end as stat, s.whid, 'changeloc' as type,
            ...
            case when s.pickerstart is null then 'FOR PICKING' else 'PICKED' end as stat, s.whid, 'changeloc' as type,
