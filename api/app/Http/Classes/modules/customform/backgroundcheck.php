...
class backgroundcheck
{
    ...
    public $modulename = 'Background Checking';
    ...
    public function createHeadField($config)
    {
        ...
        data_set($col1, 'remarks.label', 'Notation');
    ...
    public function loaddata($config)
    {
        ...
        if ($this->coreFunctions->sbcupdate($this->head, ['statid' => 99], ['empid' => $trno])) {
            $this->logger->sbcstatlog($trno, $config, 'HEAD', 'Tag for Background Checking.', $this->statlogs, $dateid2, '');
            return ['status' => true, 'msg' => 'Successfully updated.', 'backlisting' => true];
        } else {
            return ['status' => false, 'msg' => 'Failed to tag for the Background Checking.'];
        }
