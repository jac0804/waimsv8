...
class clientcompletetask
{
    private $fieldClass;
    private $tabClass;
    private $logger;
    public $modulename = 'LIST OF COMPLETED TASK';
    ...
    public function createTab($config)
    {
        ...
        $this->modulename = 'LIST OF COMPLETED TASK - ' . $clientname;

        $tab = [
            $this->gridname => ['action' => 'tableentry', 'lookupclass' => 'viewclientcompletetask', 'label' => 'LIST OF TASKS']
        ];
