...
class gpal
{
  ...
  private $fieldClass;
  private $tabClass;
  public $modulename = 'GATE PASS ASSET LOGS';
  ...
  private $fields = [
    ...
    'contact', 'rem', 'type',
    'iscustomer', 'issupplier', 'isagent', 'iswarehouse', 'isinactive', 'isemployee', 'isdepartment', 'picture',
    'isadmin', 'uv_ischecker', 'uv_ispicker', 'deptid', 'position', 'empid', 'salesgroupid', 'branchid',
    'wh', 'isdriver', 'ispassenger', 'tin'
  ];
  ...
  public function createdoclisting($config)
  {
    ...
    $listclientname = 2;
    $deptname = 3;
    $getcols = ['action', 'listclient', 'listclientname', 'deptname'];
    $stockbuttons = ['view'];
  ...
  public function loadheaddata($config)
  {
    ...
    $qry = $qryselect . ", dept.client as dept, dept.clientname as deptname,
      ...
      client.wh, wh.clientname as whname
      from client
