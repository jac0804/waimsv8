...
class sj
{
  ...
  public function CSI_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(400, 0, (isset($data[0]['transclient']) ? $data[0]['transclient'] : ''), '', 'L', false, 0, '90',  '80');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(120, 0, (isset($data[0]['tin']) ? $data[0]['tin'] : ''), '', 'L', false, 0, '400',  '');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(60, 0, (isset($data[0]['yourref']) ? $data[0]['yourref'] : ''), '', 'L', false, 0, '500',  '');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(100, 0, (isset($data[0]['dateid']) ? $data[0]['dateid'] : ''), '', 'L', false, 0, '630',  '');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(500, 0, (isset($data[0]['address']) ? $data[0]['address'] : ''), '', 'L', false, 0, '90',  '100');
  ...
  public function CSI_PDF($params, $data)
  {
    ...
    if ($data[0]['tax'] == 12) {
      ...
      PDF::MultiCell(100, 0, number_format($totalext, 2), '', 'R', false, 1, '590',  '410');
      PDF::MultiCell(100, 0, number_format($amtofnvat, 2), '', 'R', false, 1, '590',  '425');
      PDF::MultiCell(100, 0, number_format($lessvat, 2), '', 'R', false, 1, '590',  '440');

      // PDF::MultiCell(100, 0, number_format($addvat, 2), '', 'R', false, 1, '590',  '470');
      PDF::MultiCell(100, 0, number_format($lessvat, 2), '', 'R', false, 1, '590',  '470');
      PDF::MultiCell(100, 0, number_format($amtdue, 2), '', 'R', false, 1, '590',  '485');
      PDF::MultiCell(100, 0, number_format($totalext, 2), '', 'R', false, 1, '590',  '500');

      
      
      PDF::MultiCell(100, 0, number_format($nvat, 2), '', 'R', false, 0, '110',  '435');
      // PDF::MultiCell(100, 0, number_format($vatex, 2), '', 'R', false, 0, '110',  '450');
      PDF::MultiCell(100, 0, number_format($vatamt, 2), '', 'R', false, 0, '110',  '480');
