...
class cv
{
  ...
  {
    $fields = ['radioprint', 'radioreporttype', 'prepared', 'approved', 'received', 'audited', 'checked', 'payor', 'tin', 'position', 'print'];
  ...
  public function PDF_default_header($params, $data)
  {
    ...
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(140, 5, (isset($data[0]['dateid']) ? $data[0]['dateid'] : ''), 'B', 'R', false);
    ...
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(120, 5, (isset($data[0]['yourref']) ? $data[0]['yourref'] : ''), 'B', 'R', false);
    ...
    PDF::MultiCell(10, 5, '', '', '', false, 0);
    PDF::MultiCell(110, 5, 'REF NO', '', 'L', false, 0);
  ...
  public function PDF_DEFAULT_CCVOUCHER_LAYOUT1($data, $params)
  {
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        $arr_dyourref = $this->reporter->fixcolumn([$dyourref], '15', 0);
        $maxrow = $this->othersClass->getmaxcolumn([$arr_acno, $arr_acnonamedescs, $arr_checkno, $arr_pdate, $arr_debit, $arr_credit, $arr_dyourref]);
        //EDIT
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::MultiCell(110, 15, ' ' . (isset($arr_dyourref[$r]) ? $arr_dyourref[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
    ...
    PDF::MultiCell(180, 0, 'Audited By: ', '', 'L', false, 0);
    ...
    PDF::MultiCell(180, 0, $params['params']['dataparams']['audited'], '', 'L', false, 0);
