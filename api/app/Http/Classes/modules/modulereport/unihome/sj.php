...
class sj
{
  ...
  {
    $fields = ['radioprint', 'radioreporttype', 'prepared', 'approved', 'received', 'wh', 'print'];
    ...
    data_set($col1, 'radioreporttype.options', [
      ['label' => 'Delivery Receipt', 'value' => 'DR', 'color' => 'red'],
      ['label' => 'DR Preprinted', 'value' => 'DRP', 'color' => 'red'],
      ['label' => 'DR Preprinted With Price', 'value' => 'DRPWP', 'color' => 'red'],
      ['label' => 'SI', 'value' => 'SI', 'color' => 'red'],
      ['label' => 'SI New Format', 'value' => 'SINF', 'color' => 'red'],
      ['label' => 'CSI', 'value' => 'CSI', 'color' => 'red'],
      ['label' => 'Withdrawal Slip', 'value' => 'WS', 'color' => 'red'],
      ['label' => 'DR W/Out Price', 'value' => 'DRWOP', 'color' => 'red']
    ]);
  ...
  public function report_default_query($config)
  {
    ...
    whs.client as stockwh,head.clientname as transclient,head.VatType,head.tax
    from lahead as head
    ...
    if ($params['params']['dataparams']['print'] == "default") {
      ...
      switch ($params['params']['dataparams']['format']) {
        case 'DR':
          ...
          break;
        case 'DRP':
          return $this->DRP_PDF($params, $data);
          break;
        case 'DRPWP':
          return $this->DRPWP_PDF($params, $data);
          break;
        case 'SI':
          return $this->SI_PDF($params, $data);

          break;
        case 'SINF':
          return $this->SINF_PDF($params, $data);

          break;
        case 'CSI':
          return $this->CSI_PDF($params, $data);

          break;
        case 'WS':
          return $this->WS_PDF($params, $data);
          break;
        case 'DRWOP':
          return $this->DRWOP_PDF($params, $data);
          break;
      }
    }
  }
  ...
  public function SI_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(150, 0, (isset($data[0]['docno']) ? $data[0]['docno'] : ''), '', 'L', false, 0, '450',  '40');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(400, 0, (isset($data[0]['transclient']) ? $data[0]['transclient'] : ''), '', 'L', false, 0, '100',  '65');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(100, 0, (isset($data[0]['agname']) ? $data[0]['agname'] : ''), '', 'L', false, 0, '435',  '65');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(100, 0, (isset($data[0]['dateid']) ? $data[0]['dateid'] : ''), '', 'L', false, 0, '620',  '65');
    PDF::SetFont($fontbold, '', 11);
    // PDF::MultiCell(100, 0,  (isset($data[0]['dateid']) ? $data[0]['dateid'] : ''), '', 'L', false, 0, '600',  '');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(500, 0, (isset($data[0]['address']) ? $data[0]['address'] : ''), '', 'L', false, 0, '100',  '100');
    PDF::SetFont($fontbold, '', 11);
    //  PDF::MultiCell(100, 0,  (isset($data[0]['dateid']) ? $data[0]['dateid'] : ''), '', 'L', false, 0, '610',  '');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(100, 0, '', '', 'L', false, 0, '420',  '');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(100, 0, (isset($data[0]['tin']) ? $data[0]['tin'] : ''), '', 'L', false, 0, '620',  '100');
    PDF::SetFont($fontbold, '', 11);
  ...
  public function SI_PDF($params, $data)
  {
    ...
    $this->SI_header_PDF($params, $data);
    PDF::SetFont($font, '', 5);
    PDF::MultiCell(700, 0, '', '');
    $totalsales = 0;
    $lessvat = 0;
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        $ext = $this->reporter->fixcolumn([$data[$i]['ext']], '18', 0);
        $maxrow = 1;
        $countarr = max(count($ext), count($itemname));
        $maxrow = $countarr;
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::MultiCell(80, 15, $qty, '', 'R', false, 0, '2', '', true, 1);
          PDF::MultiCell(100, 15, $uom, '', 'C', false, 0, '65', '', false, 1);
          PDF::MultiCell(300, 15, isset($itemname[$r]) ? $itemname[$r] : '', '', 'L', false, 0, '160', '', false, 1);
          PDF::MultiCell(100, 15, $amt, '', 'R', false, 0, '560', '', false, 1);
          PDF::MultiCell(170, 15, $ext, '', 'R', false, 1, '600', '', false, 0);
        }
    ...
    $nvat = $totalext / $vat;
    $lessvat = $totalext / $vat;
    $amtofnvat = $totalext - $lessvat;
    $amtdue = $amtofnvat;
    //$addvat=0;
    $ttalamtdue = $totalext;
    $vatex = $nvat;
    $addvat = $totalext;
    $vatamt = $totalext / $vat * $vat2;
    ...
    if ($data[0]['tax'] == 12) {
      ...
      PDF::MultiCell(0, 0, "\n\n\n\n\n\n");
      PDF::MultiCell(350, 0, number_format($totalext, 2), '', 'R', false, 0, '110',  '');
      PDF::MultiCell(0, 0, "\n");
      PDF::MultiCell(350, 0, number_format($lessvat, 2), '', 'R', false, 0, '110',  '');
      PDF::MultiCell(0, 0, "\n");
      PDF::MultiCell(180, 0, number_format($nvat, 2), '', 'R', false, 0, '',  '');
      PDF::MultiCell(350, 0, number_format($amtofnvat, 2), '', 'R', false, 0, '110',  '');
      PDF::MultiCell(0, 0, "\n");
      PDF::MultiCell(180, 0, number_format($vatex, 2), '', 'R', false, 0, '',  '');
      PDF::MultiCell(350, 0, '', '', 'R', false, 0, '110',  '');
      PDF::MultiCell(0, 0, "\n");
      PDF::MultiCell(350, 0, number_format($amtdue, 2), '', 'R', false, 0, '110',  '');
      PDF::MultiCell(0, 0, "\n");
      PDF::MultiCell(180, 0, number_format($vatamt, 2), '', 'R', false, 0, '',  '');
      PDF::MultiCell(350, 0, number_format($addvat, 2), '', 'R', false, 0, '110',  '');
      PDF::MultiCell(0, 0, "\n\n\n\n\n\n");
      PDF::MultiCell(350, 0, number_format($totalext, 2), '', 'R', false, 0, '110',  '');
      PDF::MultiCell(0, 0, "\n");
      PDF::MultiCell(350, 0, number_format($totalext, 2), '', 'L', false, 1, '600',  '435');
    } else {
      ...
      PDF::MultiCell(350, 0, '', '', 'R', false, 0, '110',  '');
      PDF::MultiCell(0, 0, "\n\n");
      PDF::MultiCell(350, 0, number_format($totalext, 2), '', 'R', false, 0, '420',  '435');
      PDF::MultiCell(0, 0, "\n");
    }

    return PDF::Output($this->modulename . '.pdf', 'S');
  }
  public function SINF_Header($params, $data)
  {
    $center = $params['params']['center'];
    $username = $params['params']['user'];
    $decimal = $this->companysetup->getdecimal('currency', $params['params']);
    ...
    PDF::MultiCell(35, 0, '', '', 'R', false, 0, '',  '');
    PDF::MultiCell(85, 0, (isset($data[0]['dateid']) ? $data[0]['dateid'] : ''), '', 'L', false, 0, '',  '');
    PDF::MultiCell(150, 0, '', '', '', false, 1, '',  '');
    ...
    PDF::MultiCell(125, 0, '' . (isset($data[0]['transclient']) ? $data[0]['transclient'] : ''), '', 'L', false, 0, '',  '');
    PDF::MultiCell(65, 0, '', '', 'L', false, 0, '',  '');
    PDF::MultiCell(120, 0, '' . (isset($data[0]['address']) ? $data[0]['address'] : ''), '', 'L', false, 0, '',  '');
    PDF::MultiCell(65, 0, '', '', 'L', false, 0, '',  '');
    PDF::MultiCell(100, 0, '' . (isset($data[0]['agname']) ? $data[0]['agname'] : ''), '', 'L', false, 1, '',  '');
    ...
    PDF::MultiCell(150, 0, '' . (isset($data[0]['tin']) ? $data[0]['tin'] : ''), '', 'L', false, 1, '',  '');

    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(60, 0, '', '', 'L', false, 0, '',  '');
    PDF::MultiCell(115, 0, (isset($data[0]['bstyle']) ? $data[0]['bstyle'] : ''), '', 'L', false, 0, '',  '');
    PDF::MultiCell(60, 0, '', '', 'L', false, 0, '',  '');
    PDF::MultiCell(120, 0, (isset($data[0]['tel']) ? $data[0]['tel'] : ''), '', 'L', false, 0, '',  '');
    PDF::MultiCell(230, 0, '', '', 'L', false, 1, '',  '');

    PDF::MultiCell(0, 0, "\n\n\n");
    PDF::SetFont($font, '', 5);
  }
  public function SINF_PDF($params, $data)
  {
    $decimalcurr = $this->companysetup->getdecimal('currency', $params['params']);
    $decimalqty = $this->companysetup->getdecimal('qty', $params['params']);
    $decimalprice = $this->companysetup->getdecimal('price', $params['params']);
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        $itemname = $this->reporter->fixcolumn([$data[$i]['itemname']], '45', 0);
        $ext = $this->reporter->fixcolumn([$data[$i]['ext']], '18', 0);
        $maxrow = 1;
        $countarr = max(count($ext), count($itemname));
        $maxrow = $countarr;
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          #WITHOUT
          PDF::SetFont($font, '', $fontsize);
          PDF::MultiCell(325, 20, isset($itemname[$r]) ? $itemname[$r] : '', '', 'L', false, 0, '', '');
          PDF::MultiCell(30, 20, $qty, '', 'C', false, 0, '', '');
          PDF::MultiCell(50, 20, $uom, '', 'C', false, 0, '', '');
          PDF::MultiCell(60, 20, $amt, '', 'R', false, 0, '', '');
          PDF::MultiCell(75, 20, $ext, '', 'R', false, 1, '', '');
        }
    ...
    #NEW
    PDF::MultiCell(375, 0, '', '', 'L', false, 0, '',  '640');
    PDF::SetFont($fontbold, '', 20);
    PDF::MultiCell(130, 0, number_format($totalext, 2), '', 'L', false, 1, '',  '');
    ...
    PDF::MultiCell(250, 0, (isset($params['params']['dataparams']['approved']) ? $params['params']['dataparams']['approved'] : ''), '', 'L', false, 0, '',  '');
    PDF::MultiCell(360, 0, '', '', 'L', false, 1, '',  '');
  ...
  public function DRP_header_PDF($params, $data)
  {
    $center = $params['params']['center'];
    $username = $params['params']['user'];
    $decimal = $this->companysetup->getdecimal('currency', $params['params']);
    ...
    PDF::MultiCell(120, 0, (isset($data[0]['docno']) ? $data[0]['docno'] : ''), '', 'L', false, 0, '480',  '60');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(400, 0, (isset($data[0]['transclient']) ? $data[0]['transclient'] : ''), '', 'L', false, 0, '90',  '80');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(100, 0, (isset($data[0]['dateid']) ? $data[0]['dateid'] : ''), '', 'L', false, 0, '630',  '');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(500, 0, (isset($data[0]['address']) ? $data[0]['address'] : ''), '', 'L', false, 0, '90',  '100');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(100, 0, (isset($data[0]['terms']) ? $data[0]['terms'] : ''), '', 'L', false, 0, '480',  '130');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(50, 0, (isset($data[0]['tin']) ? $data[0]['tin'] : ''), '', 'L', false, 0, '630',  '');
    PDF::SetFont($fontbold, '', 11);
  ...
  public function DRPWP_PDF($params, $data)
  {
    $decimalcurr = $this->companysetup->getdecimal('currency', $params['params']);
    $decimalqty = $this->companysetup->getdecimal('qty', $params['params']);
    $decimalprice = $this->companysetup->getdecimal('price', $params['params']);
    ...
    $this->DRP_header_PDF($params, $data);
    PDF::SetFont($font, '', 5);
    PDF::MultiCell(700, 0, '', '');
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        $itemname = $this->reporter->fixcolumn([$data[$i]['itemname']], '150', 0);
        $maxrow = 1;
        $countarr = count($itemname);
        $maxrow = $countarr;
        if ($data[$i]['itemname'] == '') {
          PDF::SetFont($font, '', $fontsize);
          PDF::MultiCell(100, 0, number_format($data[$i]['qty'], $decimalqty), '', 'L', 0, 0, '', '', true, 0, true, false);
          PDF::MultiCell(100, 0, $data[$i]['uom'], '', 'C', 0, 0, '', '', true, 0, '50', false);
          PDF::MultiCell(200, 0, $data[$i]['itemname'], '', 'L', 0, 0, '', '', true, 0, true, false);
          PDF::MultiCell(100, 0, $data[$i]['amt'], '', 'L', 0, 0, '', '', true, 0, true, false);
          PDF::MultiCell(100, 0, $data[$i]['ext'], '', 'L', 0, 0, '', '', true, 0, true, false);
          ...
          for ($r = 0; $r < $maxrow; $r++) {
            ...
            PDF::SetFont($font, '', $fontsize);
            PDF::MultiCell(100, 0, $qty, '', 'R', false, 0, '-15', '', true, 1);

            PDF::MultiCell(100, 0, $uom, '', 'C', false, 0, '120', '', false, 1);
            PDF::MultiCell(200, 0, isset($itemname[$r]) ? $itemname[$r] : '', '', 'L', false, 0, '220', '', false, 1);
            PDF::MultiCell(100, 0, $amt, '', 'R', false, 0, '550', '', false, 1);
            PDF::MultiCell(100, 0, $ext, '', 'R', false, 0, '650', '', false, 1);

            PDF::MultiCell(100, 0, '', '', 'R', false, 1, '400', '', false, 1);
          }
        }
        $totalext += $data[$i]['ext'];

        if (intVal($i) + 1 == $page) {
          $this->CSI_header_PDF($params, $data);
          $page += $count;
        }
      }
    }
    PDF::MultiCell(0, 0, "");
    PDF::MultiCell(100, 0, 'Total: ', '', 'R', false, 0, '550', '');
    PDF::MultiCell(100, 0, number_format($totalext, 2), 'T', 'R', false, 1, '650', '');

    PDF::MultiCell(0, 0, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");

    PDF::MultiCell(120, 0, '', '', 'C', false, 0, '', '', true, 1);
    PDF::MultiCell(150, 0, (isset($data[0]['ourref']) ? $data[0]['ourref'] : ''), '', 'C', false, 50, '', '', true, 1);

    PDF::MultiCell(0, 0, "");
    PDF::MultiCell(100, 0, '', '', 'C', false, 0, '100', '', false, 1);
    PDF::MultiCell(230, 0, '', '', 'L', false, 0, '', '', false, 1);
    PDF::MultiCell(100, 0, '', '', 'R', false, 0, '400', '', false, 1);
    PDF::MultiCell(170, 0, '', '', 'R', false, 1, '420', '', false, 0);

    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(80, 0, $params['params']['dataparams']['prepared'], '', 'L', false, 0, '80',  '');
    PDF::MultiCell(80, 0, $params['params']['dataparams']['approved'], '', 'L', false, 0, '',  '');
    PDF::MultiCell(80, 0, $params['params']['dataparams']['received'], '', 'L', false, 0, '450',  '');
    //}

    return PDF::Output($this->modulename . '.pdf', 'S');
  }

  public function DRP_PDF($params, $data)
  {
    $decimalcurr = $this->companysetup->getdecimal('currency', $params['params']);
    $decimalqty = $this->companysetup->getdecimal('qty', $params['params']);
    $decimalprice = $this->companysetup->getdecimal('price', $params['params']);
  ...
  public function CSI_header_PDF($params, $data)
  {
    $center = $params['params']['center'];
    $username = $params['params']['user'];
    $decimal = $this->companysetup->getdecimal('currency', $params['params']);
    ...
    PDF::SetMargins(40, 40);
    PDF::MultiCell(0, 0, "\n\n\n");
    PDF::MultiCell(150, 0, (isset($data[0]['docno']) ? $data[0]['docno'] : ''), '', 'L', false, 0, '400',  '60');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(400, 0, (isset($data[0]['transclient']) ? $data[0]['transclient'] : ''), '', 'L', false, 0, '90',  '80');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(110, 0, (isset($data[0]['tin']) ? $data[0]['tin'] : ''), '', 'L', false, 0, '400',  '');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(60, 0, (isset($data[0]['yourref']) ? $data[0]['yourref'] : ''), '', 'L', false, 0, '520',  '');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(100, 0, (isset($data[0]['dateid']) ? $data[0]['dateid'] : ''), '', 'L', false, 0, '640',  '');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(500, 0, (isset($data[0]['address']) ? $data[0]['address'] : ''), '', 'L', false, 0, '90',  '100');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(100, 0, '', '', 'L', false, 0, '350',  '');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(100, 0, (isset($data[0]['agname']) ? $data[0]['agname'] : ''), '', 'L', false, 0, '630',  '100');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(0, 0, "\n\n\n");
    PDF::SetFont($font, '', 5);
  }

  public function CSI_PDF($params, $data)
  {
    $decimalcurr = $this->companysetup->getdecimal('currency', $params['params']);
    $decimalqty = $this->companysetup->getdecimal('qty', $params['params']);
    $decimalprice = $this->companysetup->getdecimal('price', $params['params']);
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::SetFont($font, '', $fontsize);
          PDF::MultiCell(80, 17, $qty, '', 'R', false, 0, '2', '', true, 1);
          PDF::MultiCell(100, 17, $uom, '', 'C', false, 0, '65', '', false, 1);
          PDF::MultiCell(300, 17, isset($itemname[$r]) ? $itemname[$r] : '', '', 'L', false, 0, '160', '', false, 1);
          PDF::MultiCell(100, 17, $amt, '', 'R', false, 0, '500', '', false, 1);
          PDF::MultiCell(170, 17, $ext, '', 'R', false, 1, '520', '', false, 0);
        }
        $totalext += $data[$i]['ext'];
        if (intVal($i) + 1 == $page) {
          $this->CSI_header_PDF($params, $data);
    ...
    if ($data[0]['tax'] == 12) {
      ...
      PDF::SetFont($font, '', '9');
      PDF::MultiCell(100, 0, number_format($totalext, 2), '', 'R', false, 1, '610',  '358');
      PDF::MultiCell(100, 0, number_format($amtofnvat, 2), '', 'R', false, 1, '610',  '369');
      PDF::MultiCell(100, 0, number_format($lessvat, 2), '', 'R', false, 1, '610',  '380');

      PDF::MultiCell(100, 0, number_format($lessvat, 2), '', 'R', false, 1, '610',  '403');
      PDF::MultiCell(100, 0, number_format($amtdue, 2), '', 'R', false, 1, '610',  '414');
      PDF::MultiCell(100, 0, number_format($totalext, 2), '', 'R', false, 1, '610',  '425');
      PDF::MultiCell(100, 0, number_format($totalext, 2), '', 'R', false, 1, '610',  '448');

      PDF::MultiCell(100, 0, number_format($nvat, 2), '', 'R', false, 0, '110',  '380');
      PDF::MultiCell(100, 0, number_format($vatamt, 2), '', 'R', false, 0, '110',  '414');
    } else {
      PDF::MultiCell(0, 0, "\n\n\n\n\n\n");
      PDF::MultiCell(0, 0, "\n");
      PDF::MultiCell(350, 0, '', '', 'R', false, 0, '110',  '');
      ...
      PDF::MultiCell(350, 0, '', '', 'R', false, 0, '110',  '');
      PDF::MultiCell(0, 0, "\n");
      PDF::MultiCell(350, 0, number_format($totalext, 2), '', 'R', false, 1, '340',  '415');

    }
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(80, 0, $params['params']['dataparams']['prepared'], '', 'L', false, 0, '80',  '559');
    PDF::MultiCell(80, 0, $params['params']['dataparams']['approved'], '', 'R', false, 0, '500',  '');
  ...
  public function DR_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(520, 0, 'Delivery Receipt', '', 'L', false, 0, '',  '100');
    PDF::SetFont($fontbold, '', $fontsize);
    ...
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(470, 0, (isset($data[0]['transclient']) ? $data[0]['transclient'] : ''), 'B', 'L', false, 0, '',  '');
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(50, 0, "Terms: ", '', 'L', false, 0, '',  '');
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(100, 0, (isset($data[0]['terms']) ? $data[0]['terms'] : ''), 'B', 'L', false);
    ...
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(100, 0, (isset($data[0]['due']) ? $data[0]['due'] : ''), 'B', 'L', false);
  ...
  public function DR_PDF($params, $data)
  {
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        $maxrow = $this->othersClass->getmaxcolumn([
          $arr_itemname, $arr_qty, $arr_uom, $arr_amt, $arr_disc, $arr_ext
        ]);
        for ($r = 0; $r < $maxrow; $r++) {
    ...
    PDF::MultiCell(210, 0, 'Prepared By: ', '', 'L', false, 0);
    PDF::MultiCell(20, 0, '', '', 'L', false, 0);
    PDF::MultiCell(210, 0, 'Approved By: ', '', 'L', false, 0);
    PDF::MultiCell(20, 0, '', '', 'L', false, 0);
    PDF::SetFont($font, 'B', $fontsize);
    PDF::MultiCell(180, 0, 'Received the above article/s in good order and condition: ', '', 'L');

    PDF::MultiCell(0, 0, "\n");
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(210, 0, $params['params']['dataparams']['prepared'], 'B', 'L', false, 0);
    PDF::MultiCell(20, 0, '', '', 'L', false, 0);
    PDF::MultiCell(210, 0, $params['params']['dataparams']['approved'], 'B', 'L', false, 0);
    PDF::MultiCell(20, 0, '', '', 'L', false, 0);
    PDF::MultiCell(180, 0, $params['params']['dataparams']['received'], 'B', 'L', false, 0);
    PDF::MultiCell(10, 0, '', '', 'L', false, 0);
    PDF::MultiCell(50, 0, '', 'B', 'L');

    // PDF::MultiCell(0, 0, "\n");
    PDF::SetFont($font, 'B', $fontsize);
    PDF::MultiCell(210, 0, '', '', 'L', false, 0);
    PDF::MultiCell(20, 0, '', '', 'L', false, 0);
    PDF::MultiCell(210, 0, '', '', 'L', false, 0);
    PDF::MultiCell(20, 0, '', '', 'L', false, 0);
    PDF::MultiCell(180, 0, 'Signature above printed name', '', 'L', false, 0);
    PDF::MultiCell(10, 0, '', '', 'L', false, 0);
    PDF::MultiCell(50, 0, 'Date', '', 'L');

    return PDF::Output($this->modulename . '.pdf', 'S');
  }

  public function WS_header_PDF($params, $data)
  {
    $center = $params['params']['center'];
    $username = $params['params']['user'];
    ...
    switch ($params['params']['dataparams']['format']) {
      case 'WS':
        if ($wh == "") {
          PDF::SetFont($fontbold, '', 14);
          PDF::MultiCell(530, 20, "WAREHOUSE IS REQUIRED", '', 'L', false, 0);
          return PDF::Output($this->modulename . '.pdf', 'S');
        }
        break;
    }
    ...
    // MultiCell($w, $h, $txt, $border=0, $align='J', $fill=0, $ln=1, $x='', $y='', $reseth=true, $stretch=0, $ishtml=false, $autopadding=true, $maxh=0)
    PDF::SetFont($fontbold, '', 18);
    PDF::MultiCell(520, 0, 'Withdrawal Slip', '', 'L', false, 0, '',  '100');
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(80, 0, "Docno #: ", '', 'L', false, 0, '',  '');
    PDF::SetFont($font, '', 10);
    ...
    PDF::MultiCell(100, 0, "QTY", '', 'C', false, 0);
    PDF::MultiCell(100, 0, "UNIT", '', 'C', false, 0);
    PDF::MultiCell(200, 0, "BARCODE", '', 'L', false, 0);
    PDF::MultiCell(300, 0, "DESCRIPTION", '', 'L', false);

    PDF::SetFont($font, '', 5);
    PDF::MultiCell(700, 0, '', 'B');
  }

  public function WS_PDF($params, $data)
  {
    $decimalcurr = $this->companysetup->getdecimal('currency', $params['params']);
    $decimalqty = $this->companysetup->getdecimal('qty', $params['params']);
    $decimalprice = $this->companysetup->getdecimal('price', $params['params']);
    ...
    $this->WS_header_PDF($params, $data);
    ...
    item.itemname, stock.isqty as qty, stock.uom, stock.isamt as amt, stock.disc, stock.ext, head.agent,
    item.sizeid, ag.clientname as agname, item.brand,item.barcode,
    wh.client as whcode, wh.clientname as whname, ifnull(head.due,'') as due,stock.whid,whs.client as stockwh
    from lahead as head
    left join lastock as stock on stock.trno=head.trno
    left join client on client.client=head.client
    left join item on item.itemid=stock.itemid
    ...
    left join client as wh on wh.client=head.wh
    left join client as whs on whs.clientid=stock.whid
    where head.doc='sj' and head.trno='$trno' $filter
    UNION ALL
    select stock.line,stock.rem as srem,head.rem,date_format(head.dateid,'%m/%d') as monthid,
    right(year(head.dateid),2) as year,left(head.dateid,10) as dateid, head.docno, client.client, client.clientname,
    head.address, head.terms, item.barcode, head.shipto, client.tin, head.yourref, head.ourref,
    ...
    left join client as wh on wh.clientid=head.whid
    left join client as whs on whs.clientid=stock.whid
    where head.doc='sj' and head.trno='$trno' $filter order by line";
    $wsresult = json_decode(json_encode($this->coreFunctions->opentable($query)), true);
    ...
    for ($i = 0; $i < count($wsresult); $i++) {
      ...
      $itemword = explode(' ', $wsresult[$i]['itemname']);
      $itemwordstring = '';
      ...
      if ($wsresult[$i]['itemname'] == '') {
        PDF::SetFont($font, '', $fontsize);
        PDF::MultiCell(100, 0, number_format($wsresult[$i]['qty'], $decimalqty), '', 'C', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(100, 0, $wsresult[$i]['uom'], '', 'C', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(200, 0, $wsresult[$i]['itemname'], '', 'L', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(300, 0, $wsresult[$i]['barcode'], '', 'L', 0, 1, '', '', true, 0, false, false);
      } else {
        for ($r = 0; $r < $maxrow; $r++) {
          if ($r == 0) {
            $qty = number_format($wsresult[$i]['qty'], 2);
            $uom = $wsresult[$i]['uom'];
            $amt = number_format($wsresult[$i]['amt'], 2);
            $disc = $wsresult[$i]['disc'];
            $ext = number_format($wsresult[$i]['ext'], 2);
            $bar = $wsresult[$i]['barcode'];
          } else {
            $qty = '';
            $uom = '';
            $amt = '';
          ...
          PDF::MultiCell(200, 0, isset($bar) ? $bar : '', '', 'L', false, 0, '', '', false, 1);
          PDF::MultiCell(300, 0, isset($itemname[$r]) ? $itemname[$r] : '', '', 'L', false, 1, '', '', false, 0);
        }
      }
    ...
    PDF::MultiCell(0, 0, "\n");
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(210, 0, $params['params']['dataparams']['prepared'], '', 'L', false, 0);
    PDF::MultiCell(20, 0, '', '', 'L', false, 0);
    PDF::MultiCell(210, 0, $params['params']['dataparams']['approved'], '', 'L', false, 0);
    PDF::MultiCell(20, 0, '', '', 'L', false, 0);
  ...
  public function DRWOP_header_PDF($params, $data)
  {
    $center = $params['params']['center'];
    $username = $params['params']['user'];
    //$width = 800; $height = 1000;
    ...
    PDF::MultiCell(300, 0, "", '', 'R', false);

    PDF::SetFont($font, '', 5);
    PDF::MultiCell(700, 0, '', 'B');
  }

  public function DRWOP_PDF($params, $data)
  {
    $decimalcurr = $this->companysetup->getdecimal('currency', $params['params']);
    $decimalqty = $this->companysetup->getdecimal('qty', $params['params']);
    $decimalprice = $this->companysetup->getdecimal('price', $params['params']);
    ...
    $this->DRWOP_header_PDF($params, $data);
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        if ($data[$i]['itemname'] == '') {
          ...
          PDF::MultiCell(200, 0, $data[$i]['itemname'], '', 'L', 0, 0, '', '', true, 0, true, false);
          PDF::MultiCell(400, 0, '', '', 'L', 0, 1, '', '', true, 0, false, false);
        } else {
          for ($r = 0; $r < $maxrow; $r++) {
            if ($r == 0) {
              $qty = number_format($data[$i]['qty'], 2);
            ...
            PDF::MultiCell(100, 0, $uom, '', 'C', false, 0, '', '', false, 1);
            PDF::MultiCell(200, 0, isset($itemname[$r]) ? $itemname[$r] : '', '', 'L', false, 0, '', '', false, 1);
            PDF::MultiCell(400, 0, '', '', 'R', false, 1, '', '', false, 0);
          }
        }
