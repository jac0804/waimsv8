  ...
  public function default_KR_PDF($params, $data)
  {
    ...
    if (!empty($data)) {
      ...
      for ($i = 0; $i < count($data); $i++) {
        ...
        $maxrow = $this->othersClass->getmaxcolumn([$arr_ref, $arr_rem2, $arr_yourref, $arr_due, $arr_postdate, $arr_debit, $arr_credit, $arr_client, $arr_agent, $arr_age]);
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          // PDF::MultiCell(65, 15, ' ' . (isset($arr_yourref[$r]) ? $arr_yourref[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          ...
          // PDF::MultiCell(30, 15, ' ' . '', '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          PDF::MultiCell(99, 15, ' ' . (isset($arr_client[$r]) ? $arr_client[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          PDF::MultiCell(5, 15, ' ' . '', '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
