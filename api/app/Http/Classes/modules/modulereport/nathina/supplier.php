...
class supplier
{
    ...
    {
        $fields = ['radioprint','start', 'end', 'radiocustreporttype', 'prepared', 'approved', 'received', 'print'];
        ...
        data_set(
            ...
            'radioprint.options',
            [
                ['label' => 'PDFM', 'value' => 'PDFM', 'color' => 'red'],
    ...
    public function reportdefaultAP_PDF($config, $data)
    {
        ...
        PDF::MultiCell(70, 10, "Date", '', 'C', false, 0);
        PDF::MultiCell(90, 10, "OurRef", '', 'C', false, 0);
        PDF::MultiCell(145, 10, "Notes", '', 'C', false, 0);
        PDF::MultiCell(70, 10, "Debit", '', 'R', false, 0);
        PDF::MultiCell(70, 10, "Credit", '', 'R', false, 0);
        PDF::MultiCell(90, 10, "Running Balance", '', 'R', false, 0);
        PDF::MultiCell(5, 10, "", '', 'R', false, 0);
        PDF::MultiCell(90, 10, "Yourref", '', 'C', false);
        ...
        if (empty($bdata)) {
            ...
            PDF::MultiCell(70, 15, '', '', 'C', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(90, 15, '', '', 'L', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(145, 15, '', '', 'L', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(70, 15, '', '', 'R', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(70, 15, '', '', 'R', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(90, 15, '0.00', '', 'R', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(5, 15, '', '', 'R', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(90, 15, '', '', 'L', 0, 1, '', '', true, 0, false, false);
        } else {
            PDF::SetFont($font, '', $fontsize);
            PDF::MultiCell(130, 15, 'Beginning Balance', '', 'L', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(70, 15, '', '', 'C', 0, 0, '', '', true, 0, true, false);
        ...
        foreach ($data as $key => $data1) {
            ...
            $arr_docno = $this->reporter->fixcolumn([$data1->docno], '20', 0);
            $arr_dateid = $this->reporter->fixcolumn([$data1->dateid], '10', 0);
            $arr_ref = $this->reporter->fixcolumn([$data1->reference], '14', 0);
            $arr_rem = $this->reporter->fixcolumn([$data1->rem], '25', 0);
            ...
            $arr_yourref = $this->reporter->fixcolumn([$data1->yourref], '15', 0);

            $maxrow = $this->othersClass->getmaxcolumn([$arr_docno, $arr_dateid, $arr_ref, $arr_rem, $arr_debit, $arr_credit,  $arr_balance, $arr_yourref]);
            for ($r = 0; $r < $maxrow; $r++) {
                PDF::MultiCell(130, 15, (isset($arr_docno[$r]) ? $arr_docno[$r] : ''), '', 'L', 0, 0, '', '', true, 0, true, false);
                PDF::MultiCell(70, 15, (isset($arr_dateid[$r]) ? $arr_dateid[$r] : ''), '', 'C', 0, 0, '', '', true, 0, true, false);
                PDF::MultiCell(90, 15, (isset($arr_ref[$r]) ? $arr_ref[$r] : ''), '', 'L', 0, 0, '', '', true, 0, true, false);
                PDF::MultiCell(145, 15, (isset($arr_rem[$r]) ? $arr_rem[$r] : ''), '', 'L', 0, 0, '', '', true, 0, true, false);
                PDF::MultiCell(70, 15, (isset($arr_debit[$r]) ? $arr_debit[$r] : ''), '', 'R', 0, 0, '', '', true, 0, true, false);
                PDF::MultiCell(70, 15, (isset($arr_credit[$r]) ? $arr_credit[$r] : ''), '', 'R', 0, 0, '', '', true, 0, true, false);
                PDF::MultiCell(90, 15, (isset($arr_balance[$r]) ? $arr_balance[$r] : ''), '', 'R', 0, 0, '', '', true, 0, true, false);
                PDF::MultiCell(5, 15, '', '', 'R', 0, 0, '', '', true, 0, true, false);
                PDF::MultiCell(90, 15, (isset($arr_yourref[$r]) ? $arr_yourref[$r] : ''), '', 'L', 0, 1, '', '', true, 0, false, false);
            }
        ...
        PDF::MultiCell(70, 15, '', '', 'C', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(140, 15, 'Grand Total : ', '', 'L', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(125, 15, '', '', 'L', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(70, 15, number_format($totaldb, 2), '', 'R', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(70, 15, number_format($totalcr, 2), '', 'R', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(100, 15, number_format($rbalance, 2), '', 'R', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(5, 15, '', '', 'R', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(100, 15, '', '', 'L', 0, 1, '', '', true, 0, false, false);
