...
class cr
{
  ...
  private $modulename = "Acknowledgment Receipt";
  private $fieldClass;
  ...
  public function default_CR_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(100, 0, "DETAILS", '', 'L', false, 0);
  ...
  public function default_CR_PDF($params, $data)
  {
    ...
    if (!empty($data)) {
      ...
      for ($i = 0; $i < count($data); $i++) {
        ...
        $maxrow = $this->othersClass->getmaxcolumn([$arr_acno, $arr_acnonamedescs, $arr_ref, $arr_postdate, $arr_debit, $arr_credit, $arr_checkno]);
