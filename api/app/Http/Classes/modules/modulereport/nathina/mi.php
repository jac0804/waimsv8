...
class mi
{
  ...
  public function createreportfilter()
  {
    ...
    data_set($col1, 'refresh.label', 'PRINT');
  ...
  public function report_default_query($config)
  {
    ...
    wh.client as whcode, wh.clientname as whname,stock.loc,stock.expiry from lahead as head
    ...
    item.sizeid, ag.clientname as agname, item.brand,
    wh.client as whcode, wh.clientname as whname,stock.loc,stock.expiry from glhead as head
  ...
  public function default_MI_header_PDF($params, $data)
  {
    ...
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(470, 0, (isset($data[0]['whcode']) ? $data[0]['whcode'] : ''), 'B', 'L', false, 0, '',  '');
    PDF::SetFont($fontbold, '', $fontsize);
    ...
    PDF::MultiCell(66, 0, "LOCATION", '', 'R', false, 0);
    PDF::MultiCell(66, 0, "EXPIRY", '', 'R', false, 0);
    PDF::MultiCell(66, 0, "COST", '', 'R', false, 0);
  ...
  public function default_MI_PDF($params, $data)
  {
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        $maxrow = $this->othersClass->getmaxcolumn([$arr_barcode, $arr_itemname, $arr_qty, $arr_uom, $arr_amt, $arr_disc, $arr_loc, $arr_expiry, $arr_ext]);
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::MultiCell(66, 15, ' ' . (isset($arr_loc[$r]) ? $arr_loc[$r] : ''), '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          PDF::MultiCell(66, 15, ' ' . (isset($arr_expiry[$r]) ? $arr_expiry[$r] : ''), '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          PDF::MultiCell(66, 15, ' ' . (isset($arr_amt[$r]) ? $arr_amt[$r] : ''), '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
