...
class pv
{
  ...
  public function PDF_CV_WTAXREPORT($data,$params)
  {
    ...
    //1st row
      ...
      PDF::MultiCell(300, 0, 'Certificate of Creditable Tax Withheld', '', 'C',false,0);
      PDF::SetFont($fontbold, '', 22);
      PDF::MultiCell(205, 0, '2307', '', 'R',false,0);
      ...
      PDF::SetFont($fontbold, '', 16);
      PDF::MultiCell(250, 0, '', 'L', 'R',false,0);
      PDF::MultiCell(300, 0, 'At Source', '', 'C',false,0);
      PDF::MultiCell(330, 0, '', 'R', 'C',false);
      PDF::SetFont($font, '', 9);
    ...
    //5th row -> part 1
      PDF::SetFont($fontbold, '', 11);
      PDF::MultiCell(50, 18, 'Part I', 'LTB', 'C',false,0,10,224);
      PDF::MultiCell(730, 18, 'Payee Information', 'TRB', 'C',false,1,60,224);
    ...
    //7th row -> 2 tax payer
      ...
      PDF::MultiCell(220, 30, (isset($data['head'][0]['tin'])? $data['head'][0]['tin']:''), 'TBLR', 'L',false,0,165,252);
    ...
    //9th row -> 2 Identification
      ...
      PDF::MultiCell(610, 30, (isset($data['head'][0]['payee'])? $data['head'][0]['payee']:''), 'LTRB', 'L',false,0,165,302);
    ...
    //13th row -> 4 foreign address
      ...
      PDF::MultiCell(410, 30, '', 'TBLR', 'L',false,0,165,385);
      PDF::SetFont($fontbold, '', 11);
    ...
    //17th row -> 6 tax payer
      ...
      PDF::SetFont($font, '', 11);
      PDF::MultiCell(125, 22, 'Tax Payer', '', 'L',false,0);
      PDF::MultiCell(220, 30, (isset($data['res'][0]['payortin'])? $data['res'][0]['payortin']:''), 'TBLR', 'L',false,0,165,455);
      PDF::MultiCell(405, 30, '', 'R', 'C',false);
    ...
    //19th row
      ...
      PDF::MultiCell(610, 30,  (isset($data['res'][0]['payorcompname'])? $data['res'][0]['payorcompname']:''), 'TBLR', 'L',false,0,165,495);
      PDF::MultiCell(15, 30, '', 'R', 'C',false);
    ...
    //21st row
      ...
      PDF::MultiCell(410, 30, (isset($data['res'][0]['payoraddress'])? $data['res'][0]['payoraddress']:''), 'TBLR', 'L',false,0,165,540);
      PDF::SetFont($fontbold, '', 11);
      PDF::MultiCell(30, 25, '8A', '', 'R',false,0,575,540);
      PDF::SetFont($font, '', 11);
      PDF::MultiCell(70, 25, 'Zip Code', '', 'L',false,0,605,540);
      PDF::MultiCell(100, 30, (isset($data['res'][0]['payorzipcode'])? $data['res'][0]['payorzipcode']:''), 'TBLR', 'C',false,0,675,540);
      PDF::MultiCell(15, 30, '', 'R', 'C',false);
