...
class ap
{
  ...
  public function default_AP_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(60, 0, "ACCT NO.", '', 'L', false, 0);
    PDF::MultiCell(180, 0, "ACCOUNT NAME", '', 'L', false, 0);
    PDF::MultiCell(100, 0, "REFERENCE #", '', 'L', false, 0);
    PDF::MultiCell(90, 0, "DATE", '', 'C', false, 0);
  ...
  public function default_AP_PDF($params, $data)
  {
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      $arr_acnoname = $this->reporter->fixcolumn([$acnoname], '30', 0);
      ...
      for ($r = 0; $r < $maxrow; $r++) {
        ...
        PDF::MultiCell(90, 15, ' ' . (isset($arr_postdate[$r]) ? $arr_postdate[$r] : ''), '', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
