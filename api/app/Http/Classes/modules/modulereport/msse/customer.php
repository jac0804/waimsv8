...
class customer
{
    ...
    public function reportdefaultAR_PDF($config, $data)
    {
        ...
        PDF::SetFont($font, '', 11);
        PDF::MultiCell(140, 20, "View Accounts from : ", '', 'L', false, 0);
        PDF::SetFont($fontbold, '', 11);
        PDF::MultiCell(190, 20, $start, '', 'L', false, 0);
        PDF::SetFont($font, '', 11);
        ...
        PDF::SetFont($font, '', 11);
        PDF::MultiCell(120, 20, "Email Address : ", '', 'L', false, 0);
        PDF::SetFont($fontbold, '', 11);
        PDF::MultiCell(260, 20, (isset($data[0]->email) ? $data[0]->email : ''), '', 'L', false, 0);
        PDF::SetFont($font, '', 11);
