...
class restday
{
    ...
    public function default_restday_header($params, $data)
    {
        ...
        PDF::MultiCell(720, 0, 'REST DAY AVAILMENT FORM', '', 'C', false, 0);
        ...
        PDF::SetFont($fontbold, '', $fontsize);
        PDF::MultiCell(88, 0, "DATE FILED: ", '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
        PDF::SetFont($fontbold, '', 10);
        PDF::MultiCell(132, 0, '' . $data[0]['createdate'], 'B', 'L', false, 1, '',  '', true, 0, false, true, 0, 'B', true);
        PDF::MultiCell(0, 0, "\n");
        ...
        PDF::SetFont($fontbold, '', $fontsize);
        PDF::MultiCell(100, 0, "DEPARTMENT: ", '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
        PDF::MultiCell(120, 0, '' . $data[0]['deptname'], 'B', 'L', false, 1, '',  '', true, 0, false, true, 0, 'B', true);
        PDF::MultiCell(0, 0, "\n");

        PDF::SetFont($font, 'B', $fontsize);
        PDF::MultiCell(240, 0, "DATE OF REST", 'TBL', 'C', false, 0);
        PDF::MultiCell(240, 0, "REASON OF AVAILMENT", 'TBL', 'C', false, 0);
        PDF::MultiCell(240, 0, "REMARKS", 'TBLR', 'C', false, 1);
    }
    ...
    public function default_restday_PDF($params, $data)
    {
        ...
        if (!empty($data)) {
            for ($i = 0; $i < count($data); $i++) {
                ...
                $maxrow = $this->othersClass->getmaxcolumn([$arr_reason, $arr_dateid]);
                for ($r = 0; $r < $maxrow; $r++) {

                    $printline++;
                    PDF::SetFont($font, '', $fontsize);
                    PDF::MultiCell(240, 15, '' . (isset($arr_dateid[$r]) ? $arr_dateid[$r] : ''), 'L', 'C', false, 0, '',  '', true, 0, false, true, 15, 'M', false);
                    PDF::MultiCell(240, 15, '' . (isset($arr_reason[$r]) ? $arr_reason[$r] : ''), 'L', 'L', false, 0, '',  '', true, 0, false, true, 15, 'M', false);
                    PDF::MultiCell(240, 15, '' . (isset($arr_rem[$r]) ? $arr_rem[$r] : ''), 'LR', 'L', false, 1, '',  '', true, 0, false, true, 15, 'M', false);
                }
        ...
        PDF::SetFont($fontbold, '', $fontsize);
        PDF::MultiCell(720, 0, 'APPROVED BY: ', '', 'L', false, 1);
        PDF::MultiCell(0, 0, "\n");
        ...
        PDF::MultiCell(195, 0, '', 'B', 'C', false, 0);
        ...
        PDF::SetFont($fontbold, '', $fontsize);
        PDF::MultiCell(240, 0, 'DEPARTMENT BY/MANAGING HEAD', '', 'C', false, 0);
        PDF::MultiCell(240, 0, '', '', 'C', false, 0);
        PDF::MultiCell(240, 0, 'HUMAN RESOURCES DEPARTMENT', '', 'L', false, 1);
    ...
    public function borderline($line)
    {
        ...
        for ($i = 0; $i < $line; $i++) {
            if ($i == ($line) - 1) {
                PDF::MultiCell(240, 15, '', 'LB', 'C', false, 0, '',  '', true, 0, false, true, 15, 'M', false);
                PDF::MultiCell(240, 15, '', 'LB', 'L', false, 0, '',  '', true, 0, false, true, 15, 'M', false);
                PDF::MultiCell(240, 15, '', 'LRB', 'L', false, 1, '',  '', true, 1, false, true, 15, 'M', false);
            } else {
                PDF::MultiCell(240, 15, '', 'L', 'C', false, 0, '',  '', true, 0, false, true, 15, 'M', false);
                PDF::MultiCell(240, 15, '', 'L', 'L', false, 0, '',  '', true, 0, false, true, 15, 'M', false);
                PDF::MultiCell(240, 15, '', 'LR', 'L', false, 1, '',  '', true, 1, false, true, 15, 'M', false);
            }
        }
    }
}
