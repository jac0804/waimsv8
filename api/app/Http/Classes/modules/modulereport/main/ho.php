...
class ho
{
  ...
  { 
    ...
    public function default_header_PDF($config, $data) {
      ...
      PDF::MultiCell(550, 18, "TURN OVER OF ITEMS", '', 'L', false,0);
      PDF::SetFont($fontbold, '', 11);
      ...
      PDF::SetFont($fontbold, '', 11);
      PDF::MultiCell(253, 0, "ITEM NAME", '', 'L', false,0);
      PDF::MultiCell(253, 0, "ESTIMATED VALUE", '', 'L', false,0);
    ...
    public function rpt_HO_PDF($config, $data)
    {
      ...
      for ($i = 0; $i < count($data); $i++) {
        ...
        $maxrow = $this->othersClass->getmaxcolumn([$arr_itemname, $arr_amt, $arr_notes]);

        for($r = 0; $r < $maxrow; $r++) {
          PDF::SetFont($font, '', $fontsize);
          PDF::MultiCell(253, 20, (isset($arr_itemname[$r]) ? $arr_itemname[$r] : ''), '', 'L', 0, 0, '', '', true, 0, true, false);
          PDF::MultiCell(253, 20, (isset($arr_amt[$r]) ? $arr_amt[$r] : ''), '', 'L', 0, 0, '', '', true, 0, true, false);
  ...
  public function cdohris_default_header_PDF($config, $data)
  {
    ...
    PDF::SetFont($fontbold, '', 14);
    PDF::MultiCell(550, 18, "TURN OVER OF ITEMS", '', 'L', false);
    ...
    public function rpt_HO_layout($config, $data)
    {
