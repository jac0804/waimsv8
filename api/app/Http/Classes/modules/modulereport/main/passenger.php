...
public function createreportfilter($config)
  ...
  public function rpt_employee_PDF($config)
  {
    ...
    foreach ($dataeduc as $key => $data1) {
      $maxrow = 1;
      $arr_school = $this->reporter->fixcolumn([$data1->school],'25',0);
      ...
      $arr_honor = $this->reporter->fixcolumn([$data->honor],'16',0);
    ...
    foreach ($dataemploy as $key => $data1) {
      $maxrow = 1;
      $arr_company = $this->reporter->fixcolumn([$data1->company],'16',0);
      ...
      $arr_reason = $this->reporter->fixcolumn([$data1->reason],'25',0);
