    ...
    if (!empty($data)) {
      ...
      for ($i = 0; $i < count($data); $i++) {
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::MultiCell(85, 15, ' ' . (isset($arr_debit[$r]) ? ($arr_debit[$r] == 0 ? '-' : $arr_debit[$r]) : ''), '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          PDF::MultiCell(85, 15, ' ' . (isset($arr_credit[$r]) ? ($arr_credit[$r] == 0 ? '-' : $arr_credit[$r]) : ''), '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
