...
class wm
{
    ...
    public function default_AR_header_PDF($params, $data)
    {
        ...
        PDF::MultiCell(100, 25, "Meter #", 'TB', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', true);
        PDF::MultiCell(170, 25, "Meter Address", 'TB', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', true);
        PDF::MultiCell(150, 25, "Name", 'TB', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', true);
        PDF::MultiCell(100, 25, "Present Reading", 'TB', 'R', false, 0, '',  '', true, 0, false, true, 0, 'M', true);
        PDF::MultiCell(100, 25, "Previous Reading", 'TB', 'R', false, 0, '',  '', true, 0, false, true, 0, 'M', true);
        PDF::MultiCell(100, 25, "Consumption", 'TB', 'R', false, 1, '',  '', true, 0, false, true, 0, 'M', true);
    }
    ...
    public function default_AR_PDF($params, $data)
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            for ($r = 0; $r < $maxrow; $r++) {
                ...
                PDF::MultiCell(150, 15, ' ' . (isset($arr_customer[$r]) ? $arr_customer[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
                PDF::MultiCell(100, 15, ' ' . (isset($arr_isqty3[$r]) ? $arr_isqty3[$r] : ''), '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
                PDF::MultiCell(100, 15, ' ' . (isset($arr_isqty2[$r]) ? $arr_isqty2[$r] : ''), '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
                PDF::MultiCell(100, 15, ' ' . (isset($arr_isqty[$r]) ? $arr_isqty[$r] : ''), '', 'R', false, 1, '',  '', true, 0, false, true, 0, 'M', false);
            }
