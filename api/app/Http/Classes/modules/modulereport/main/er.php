...
class er
{
  ...
  public function createreportfilter(){
    $fields = ['radioprint','prepared','approved','received','eiassessment','eischedule','print'];
...
public function reportparamsdata($config){
  ...
  public function report_default_query($config)
  {
    ...
    $query = "select head.trno,client.client,client.clientname,head.docno,head.dateid,head.yr,
            ...
            from en_sjhead as head
            left join en_sjsubject as stock on stock.trno=head.trno
            ...
            where head.doc='ER' and head.trno= ".$trno."
            union all
    ...
    $query = "select grp as feescode,feestype,round(sum(amt),2) as amt
              from (select grp,feestype,amt
                    ...
                    from (select '4' as grp,'Total Balance' as feestype,disc as amt
                          ...
                          from glhead as a where a.trno=".$trno.") as s
                    group by s.feestype,s.grp
              ) as x
  ...
  public function default_header($params, $data)
  {
    ...
    $str .= $this->reporter->col('REGISTRATION CARD', '580', null, false, $border, '', 'C', $font, '18', 'B', '', '');
    ...
    $str .= $this->reporter->col((isset($data[0]['code']) ? $data[0]['code'] : ''), '50', null, false, $border, '', 'L', $font, $fontsize, 'B', '', '');
    $str .= $this->reporter->col('Notes : ', '100', null, false, $border, '', 'L', $font, $fontsize, '', '', '');
    $str .= $this->reporter->col((isset($data[0]['rem']) ? $data[0]['rem'] : ''), '100', null, false, $border, '', 'L', $font, $fontsize, 'B', '', '');
    $str .= $this->reporter->endrow();

    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('Student # : ', '100', null, false, $border, '', 'L', $font, $fontsize, '', '30px', '4px');
    ...
    $str .= $this->reporter->col('School Year : ', '100', null, false, $border, '', 'L', $font, $fontsize, '', '30px', '4px');
    $str .= $this->reporter->col((isset($data[0]['sy']) ? $data[0]['sy'] : ''), '100', null, false, $border, '', 'L', $font, $fontsize, 'B', '30px', '4px');
    $str .= $this->reporter->endrow();

    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('Assessment : ', '100', null, false, $border, '', 'L', $font, $fontsize, '', '30px', '4px');
    $str .= $this->reporter->col((isset($data[0]['assessref']) ? $data[0]['assessref'] : ''), '100', null, false, $border, '', 'L', $font, $fontsize, 'B', '30px', '4px');
    $str .= $this->reporter->col('Department : ', '100', null, false, $border, '', 'L', $font, $fontsize, '', '', '');
    $str .= $this->reporter->col((isset($data[0]['department']) ? $data[0]['department'] : ''), '100', null, false, $border, '', 'L', $font, $fontsize, 'B', '', '');
    $str .= $this->reporter->col('Level : ', '100', null, false, $border, '', 'L', $font, $fontsize, '', '', '');
    $str .= $this->reporter->col((isset($data[0]['levels']) ? $data[0]['levels'] : ''), '100', null, false, $border, '', 'L', $font, $fontsize, 'B', '', '');
    $str .= $this->reporter->endrow();
    ...
    $str .= $this->reporter->col('MOP : ', '100', null, false, $border, '', 'L', $font, $fontsize, '', '', '');
    $str .= $this->reporter->col((isset($data[0]['modeofpayment']) ? $data[0]['modeofpayment'] : ''), '100', null, false, $border, '', 'L', $font, $fontsize, 'B', '', '');
    $str .= $this->reporter->endrow();

    
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('Grade/Year : ', '100', null, false, $border, '', 'L', $font, $fontsize, '', '30px', '4px');
    $str .= $this->reporter->col((isset($data[0]['yr']) ? $data[0]['yr'] : ''), '100', null, false, $border, '', 'L', $font, $fontsize, 'B', '30px', '4px');
    $str .= $this->reporter->col('Semester : ', '100', null, false, $border, '', 'L', $font, $fontsize, '', '', '');
    $str .= $this->reporter->col((isset($data[0]['term']) ? $data[0]['term'] : ''), '100', null, false, $border, '', 'L', $font, $fontsize, 'B', '', '');
    $str .= $this->reporter->col('Account : ', '100', null, false, $border, '', 'L', $font, $fontsize, '', '', '');
    $str .= $this->reporter->col((isset($data[0]['contra']) ? $data[0]['contra'] : ''), '100', null, false, $border, '', 'L', $font, $fontsize, 'B', '', '');
    ...
    $str .= $this->reporter->col('Discount : ', '100', null, false, $border, '', 'L', $font, '12', '', '', '');
    $str .= $this->reporter->col((isset($data[0]['disc']) ? $data[0]['disc'] : ''), '100', null, false, $border, '', 'L', $font, '12', 'B', '', '');
    $str .= $this->reporter->endrow();
  ...
  public function reportplotting($params, $data)
  {
    ...
    // $str .= $this->assessment_plotting($params, $data);
  ...
  public function withschedplotting($params, $data)
  {
    $companyid = $params['params']['companyid'];
    $decimal = $this->companysetup->getdecimal('currency', $params['params']);
  ...
  public function assessment_report_plotting($params, $data, $assess)
  {
    ...
    for ($i = 0; $i < count($assess); $i++) {
      $str .= $this->reporter->startrow();
      if ($assess[$i]['feestype'] == 'Total Balance:'){
        $str .= $this->reporter->col('&nbsp&nbsp'.$assess[$i]['feestype'], '150', null, false, $border, 'TLRB', 'L', $font, $fontsize, 'B', '', '');
        $str .= $this->reporter->col(number_format($assess[$i]['amt'],2).'&nbsp&nbsp', '150', null, false, $border, 'TRB', 'R', $font, $fontsize, 'B', '', '');
      }else{
        $str .= $this->reporter->col('&nbsp&nbsp'.$assess[$i]['feestype'], '150', null, false, $border, 'TLRB', 'L', $font, $fontsize, '', '', '');
        $str .= $this->reporter->col(number_format($assess[$i]['amt'],2).'&nbsp&nbsp', '150', null, false, $border, 'TRB', 'R', $font, $fontsize, '', '', '');
      }
  ...
  public function assessment2_report_plotting($params, $data, $assess)
  {
