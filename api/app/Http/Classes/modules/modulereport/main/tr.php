...
class tr
{
  ...
  public function default_TR_PDF($params, $data)
  {
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      //     PDF::SetFont($font, '', $fontsize);
      //     PDF::MultiCell(100, 0, $barcode, '', 'C', false,0);
      //     PDF::MultiCell(200, 0, isset($itemname[$r]) ? $itemname[$r] : '', '', 'L', false,0);
      //     PDF::MultiCell(50, 0, $uom, '', 'C', false,0);
      //     PDF::MultiCell(100, 0, $reqqty, '', 'R', false,0);
      //     PDF::MultiCell(120, 0, $rrqty, '', 'R', false,0);
      //     PDF::MultiCell(120, 0, $stockwh, '', 'C', false);
      //     }
      // }
