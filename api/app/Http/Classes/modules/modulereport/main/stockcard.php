...
class stockcard
{
  ...
  public function reportparamsdata($config)
  {
    ...
    switch ($config['params']['companyid']) {
      case 36:
        ...
        date_sub(curdate(), interval 1 month) as start,
        date(now()) as end,
        '" . $warehouse . "' as wh,
        '" . $whname . "' as whname,
        '" . $whid . "' as whid,
  ...
  public function default_ledger_tablecols($layoutsize, $border, $font, $fontsize, $companyid, $config)
  {
    ...
    switch ($companyid) {
      case '3':
        ...
        $str .= $this->reporter->col('CLIENT NAME', '150', null, false, $border, 'LRTB', 'C', $font, $fontsize, 'B', '', '1px');
        $str .= $this->reporter->col('LOCATION', '75', null, false, $border, 'LRTB', 'C', $font, $fontsize, 'B', '', '1px');
        $str .= $this->reporter->col('EXPIRY', '75', null, false, $border, 'LRTB', 'C', $font, $fontsize, 'B', '', '1px');
        ...
        $str .= $this->reporter->col('BALANCE', '75', null, false, $border, 'LRTB', 'C', $font, $fontsize, 'B', '', '1px');
        $str .= $this->reporter->col('PARTICULAR', '100', null, false, $border, 'LRTB', 'C', $font, $fontsize, 'B', '', '1px');
        break;
      case '15':
        $str .= $this->reporter->col('DATE', '75', null, false, $border, 'LRTB', 'C', $font, $fontsize, 'B', '', '1px');
        $str .= $this->reporter->col('DOCUMENT #', '100', null, false, $border, 'LRTB', 'C', $font, $fontsize, 'B', '', '1px');
        ...
        $str .= $this->reporter->col('QTY IN ', '70', null, false, $border, 'LRTB', 'C', $font, $fontsize, 'B', '', '1px');
        $str .= $this->reporter->col('QTY OUT ', '70', null, false, $border, 'LRTB', 'C', $font, $fontsize, 'B', '', '1px');
        $str .= $this->reporter->col('BALANCE', '70', null, false, $border, 'LRTB', 'C', $font, $fontsize, 'B', '', '1px');
        $str .= $this->reporter->col('PARTICULAR', '70', null, false, $border, 'LRTB', 'C', $font, $fontsize, 'B', '', '1px');
        break;
      default:
        $str .= $this->reporter->col('DATE', '75', null, false, $border, 'LRTB', 'C', $font, $fontsize, 'B', '', '1px');
  ...
  public function report_default_LEDGER($config, $result)
  {
      ...
      if ($data->docno == 'beginning bal.') {
        switch ($companyid) {
          case '3':
            ...
            $str .= $this->reporter->col('', '75', null, false, $border, '', 'R', $font, $fontsize, '', '', '');
            $str .= $this->reporter->col(number_format($data->bal, 2), '75', null, false, $border, '', 'R', $font, $fontsize, '', '', '');
        ...
        switch ($companyid) {
          case '3':
            ...
            $str .= $this->reporter->col(number_format($tobal, $qtydec), '75', null, false, $border, '', 'R', $font, $fontsize, '', '', '');
            $str .= $this->reporter->col($data->rem, '100', null, false, '1psx solid ', '', 'R', $font, $fontsize, '', '', '');
            break;
          case '15':
            $str .= $this->reporter->col($data->dateid, '75', null, false, $border, '', 'C', $font, $fontsize, '', '', '');
            $str .= $this->reporter->col($data->docno, '100', null, false, $border, '', 'L', $font, $fontsize, '', '', '');
            ...
            $str .= $this->reporter->col($qty == 0 ? '-' : number_format($qty, $qtydec), '70', null, false, $border, '', 'R', $font, $fontsize, '', '', '');
            $str .= $this->reporter->col($iss == 0 ? '-' : number_format($iss, $qtydec), '70', null, false, $border, '', 'R', $font, $fontsize, '', '', '');
            $str .= $this->reporter->col(number_format($tobal, $qtydec), '70', null, false, $border, '', 'R', $font, $fontsize, '', '', '');
            $str .= $this->reporter->col($data->rem, '70', null, false, '1psx solid ', '', 'R', $font, $fontsize, '', '', '');
            break;
          default:
            $str .= $this->reporter->col($data->dateid, '75', null, false, $border, '', 'C', $font, $fontsize, '', '', '');
    ...
    switch ($companyid) {
      case '3':
        ...
        $str .= $this->reporter->col('TOTAL QTY : ', '75', null, false, $border, 'T', 'L', $font, $fontsize, '', '', '');
        ...
        $str .= $this->reporter->col(number_format($tobal, $qtydec), '75', null, false, $border, 'T', 'R', $font, $fontsize, '', '', '');
      ...
      case '15':
        ...
        $str .= $this->reporter->col('&nbsp;', '150', null, false, $border, 'T', 'L', $font, $fontsize, '', '', '');
        $str .= $this->reporter->col('&nbsp;', '75', null, false, $border, 'T', 'L', $font, $fontsize, '', '', '');
        $str .= $this->reporter->col('TOTAL QTY : ', '70', null, false, $border, 'T', 'L', $font, $fontsize, '', '', '');
        $str .= $this->reporter->col(number_format($totalqty, $qtydec), '70', null, false, $border, 'T', 'R', $font, $fontsize, '', '', '');
        $str .= $this->reporter->col(number_format($totaliss, $qtydec), '70', null, false, $border, 'T', 'R', $font, $fontsize, '', '', '');
        $str .= $this->reporter->col(number_format($tobal, $qtydec), '70', null, false, $border, 'T', 'R', $font, $fontsize, '', '', '');
        $str .= $this->reporter->col('&nbsp;', '70', null, false, $border, 'T', 'R', $font, $fontsize, '', '', '');
        break;
      default:
        $str .= $this->reporter->col('&nbsp;', '75', null, false, $border, 'T', 'C', $font, $fontsize, '', '', '');
  ...
  public function report_default_PO($config, $result)
  {
    ...
    foreach ($result as $key => $data) {
      ...
      if ($companyid == 23 || $companyid == 41 || $companyid == 52) { //labsol
        $str .= $this->reporter->col(number_format($data->rrcost, 2), '60', null, false, $border, '', 'R', $font, $fontsize, '', '', '');
      }
      $str .= $this->reporter->endrow();
    }
    $str .= $this->reporter->endtable();
  ...
  public function PDF_LEDGER_HEADER($config, $data)
  {
    ...
    switch ($companyid) {
      ...
      case '15':
        ...
        PDF::MultiCell(75, 0, "DATE", 'TLB', 'C', false, 0);
        PDF::MultiCell(100, 0, "DOCUMENT#", 'TLB', 'C', false, 0);
        PDF::MultiCell(145, 0, "CLIENTNAME", 'TLB', 'C', false, 0);
        PDF::MultiCell(70, 0, "LOCATION", 'TLB', 'C', false, 0);
      ...
      case '24': //GFC
        ...
        PDF::MultiCell(55, 0, "EXPIRY", 'TLB', 'C', false, 0);
        PDF::MultiCell(120, 0, "DOCUMENT#", 'TLB', 'C', false, 0);
  ...
  public function report_PDF_LEDGER($config, $data)
  {
      ...
      if ($value->docno == 'beginning bal.') {
        switch ($companyid) {
          case '3':
            ...
            PDF::MultiCell(100, 0, $value->docno, '', 'L', false, 0);
          ...
          case '24': //GFC
            ...
            PDF::MultiCell(200, 0, $value->docno, '', 'L', false, 0);
            PDF::MultiCell(55, 0, "", '', 'L', false, 0);
            PDF::MultiCell(120, 0, "", '', 'L', false, 0);
            PDF::MultiCell(70, 0, "", '', 'R', false, 0);
            PDF::MultiCell(70, 0, "", '', 'R', false, 0);
            PDF::MultiCell(70, 0, number_format($value->bal, 2), '', 'R', false, 0);
            PDF::MultiCell(70, 0, "", '', 'R', false);
            break;
          case '36':
            PDF::SetFont($font, '', 11);
            ...
            PDF::MultiCell(70, 0, "", '', 'R', false, 0);
            PDF::MultiCell(70, 0, "", '', 'R', false, 0);
            PDF::MultiCell(70, 0, ltrim(number_format($value->bal, 4), '0'), '', 'R', false, 0);
            PDF::MultiCell(70, 0, "", '', 'R', false);
            break;
          default:
            PDF::SetFont($font, '', 11);
        ...
        switch ($companyid) {
          case '3':
            PDF::SetFont($font, '', 11);
            PDF::MultiCell(75, 0, $value->dateid, '', 'C', false, 0);
            PDF::MultiCell(100, 0, $value->docno, '', 'L', false, 0);
            PDF::MultiCell(100, 0, $value->clientname, '', 'L', false, 0);
            PDF::MultiCell(75, 0, $value->loc, '', 'C', false, 0);
            PDF::MultiCell(75, 0, $value->expiry, '', 'C', false, 0);
            PDF::MultiCell(65, 0, $qty == 0 ? '-' : number_format($qty, $qtydec), '', 'R', false, 0);
            PDF::MultiCell(65, 0, $iss == 0 ? '-' : number_format($iss, $qtydec), '', 'R', false, 0);
            PDF::MultiCell(65, 0, number_format($tobal, $qtydec), '', 'R', false, 0);
            PDF::MultiCell(100, 0, $data->rem, '', 'R', false);
            break;
          case '15':
            PDF::SetFont($font, '', 11);
            PDF::MultiCell(75, 0, $value->dateid, '', 'C', false, 0);
            PDF::MultiCell(100, 0, $value->docno, '', 'L', false, 0);
            PDF::MultiCell(150, 0, $value->clientname, '', 'L', false, 0);
            PDF::MultiCell(70, 0, $value->loc, '', 'C', false, 0);
            PDF::MultiCell(65, 0, $value->expiry, '', 'C', false, 0);
            PDF::MultiCell(65, 0, $qty == 0 ? '-' : number_format($qty, $qtydec), '', 'R', false, 0);
            PDF::MultiCell(65, 0, $iss == 0 ? '-' : number_format($iss, $qtydec), '', 'R', false, 0);
            PDF::MultiCell(65, 0, number_format($tobal, $qtydec), '', 'R', false, 0);
          ...
          case '24': //GFC
            ...
            PDF::MultiCell(200, 0, $value->clientname, '', 'L', false, 0);
            PDF::MultiCell(55, 0, $value->expiry, '', 'C', false, 0);
            PDF::MultiCell(120, 0, $value->docno, '', 'L', false, 0);
            ...
            PDF::MultiCell(70, 0, $value->headrem . ' ' . $value->rem, '', 'R', false);
            break;
          case '36':
            PDF::SetFont($font, '', 11);
            PDF::MultiCell(75, 0, $value->dateid, '', 'C', false, 0);
            PDF::MultiCell(200, 0, $value->clientname, '', 'L', false, 0);
            PDF::MultiCell(65, 0, $value->expiry, '', 'C', false, 0);
            PDF::MultiCell(100, 0, $value->docno, '', 'C', false, 0);
            PDF::MultiCell(70, 0, $qty == 0 ? '-' : ltrim(number_format($qty, $qtydec), '0'), '', 'R', false, 0);
    ...
    switch ($companyid) {
      case '3':
        ...
        PDF::MultiCell(100, 0, "", '', 'L', false, 0);
        PDF::MultiCell(75, 0, "", '', 'L', false, 0);
        PDF::MultiCell(75, 0, 'TOTAL QTY : ', 'T', 'L', false, 0);
        PDF::MultiCell(65, 0, number_format($totalqty, $qtydec), 'T', 'R', false, 0);
        PDF::MultiCell(65, 0, number_format($totaliss, $qtydec), 'T', 'R', false, 0);
      ...
      case '15':
        ...
        PDF::MultiCell(70, 0, "", '', 'L', false, 0);
        PDF::MultiCell(65, 0, 'TOTAL QTY : ', 'T', 'L', false, 0);
        PDF::MultiCell(65, 0, number_format($totalqty, $qtydec), 'T', 'R', false, 0);
        PDF::MultiCell(65, 0, number_format($totaliss, $qtydec), 'T', 'R', false, 0);
        PDF::MultiCell(65, 0, number_format($tobal, $qtydec), 'T', 'R', false, 0);
      ...
      case '24': //GFC
        ...
        PDF::MultiCell(120, 0, 'TOTAL QTY : ', 'T', 'R', false, 0);
  ...
  public function report_PDF_PO($config, $data)
  {
    ...
    if ($companyid == 23 || $companyid == 41 || $companyid == 52) { //labsol
      PDF::MultiCell(100, 0, "Price", 'B', 'C', false);
    }
