...
public function reportparamsdata($config){
  ...
  public function report_default_query($config)
  {
    ...
    $query = "select head.trno,client.client,client.clientname,head.docno,head.dateid,head.yr,
            ...
            where head.doc='EA' and head.trno= ". $trno ."
            union all
  ...
  public function default_header($params, $data)
  {
    ...
    $str .= $this->reporter->col('COLLEGE ASSESSMENT', '580', null, false, $border, '', 'C', $font, '18', 'B', '', '');
    ...
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('Curriculum Document : ', '100', null, false, $border, '', 'L', $font, $fontsize, '', '30px', '4px');
    $str .= $this->reporter->col((isset($data[0]['curriculum']) ? $data[0]['curriculum'] : ''), '100', null, false, $border, '', 'L', $font, $fontsize, 'B', '30px', '4px');
    ...
    $str .= $this->reporter->col('Curriculum Name : ', '100', null, false, $border, '', 'L', $font, $fontsize, '', '', '');
    $str .= $this->reporter->col((isset($data[0]['curriculumname']) ? $data[0]['curriculumname'] : ''), '100', null, false, $border, '', 'L', $font, $fontsize, 'B', '', '');
    $str .= $this->reporter->endrow();
