...
class earningdeductionsetup
{
  ...
  private $modulename = "Earning and Deduction Setup";
  private $fieldClass;
  ...
  public function reportplotting($params, $data)
  {
    if ($params['params']['dataparams']['print'] == "default") {
      return $this->rpt_earningdeductionsetup_layout($params, $data);
    } else if ($params['params']['dataparams']['print'] == "PDFM") {
      return $this->default_earningdeductionsetup_PDF($params, $data);
    }
  }
  ...
  public function rpt_earningdeductionsetup_layout($filters, $data)
  {
    $companyid = $filters['params']['companyid'];
    $decimal = $this->companysetup->getdecimal('currency', $filters['params']);
  ...
  public function default_earningdeductionsetup_header_PDF($params, $data)
  {
    ...
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(75, 0, (isset($data[0]['amt']) ? $data[0]['amt'] : ''), '', 'L', false, 0, '',  '');
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(75, 0, "Amortization: ", '', 'L', false, 0, '',  '');
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(75, 0, (isset($data[0]['amortization']) ? $data[0]['amortization'] : ''), '', 'L', false, 0, '',  '');
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(55, 0, "Balance: ", '', 'L', false, 0, '',  '');
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(75, 0, (isset($data[0]['balance']) ? $data[0]['balance'] : ''), '', 'L', false, 0, '',  '');
  ...
  public function default_earningdeductionsetup_PDF($params, $data)
  {
    ...
    $this->default_earningdeductionsetup_header_PDF($params, $data);
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      for ($r = 0; $r < $maxrow; $r++) {
        PDF::SetFont($font, '', $fontsize);
        PDF::MultiCell(150, 0, (isset($arr_transdoc[$r]) ? $arr_transdoc[$r] : ''), '', 'L', 0, 0, '', '');
        PDF::MultiCell(150, 0, (isset($arr_stdate[$r]) ? $arr_stdate[$r] : ''), '', 'L', 0, 0, '', '');
