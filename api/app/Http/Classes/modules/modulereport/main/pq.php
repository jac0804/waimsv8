...
class pq
{
  ...
  public function default_PQ_PDF($params, $data)
  {
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      $maxrow = $this->othersClass->getmaxcolumn([$arr_acno, $arr_acnoname, $arr_detailproj, $arr_postdate, $arr_amt, $arr_remarks]);
      ...
      for ($r = 0; $r < $maxrow; $r++) {
        ...
        if ($companyid == 39) {
          PDF::MultiCell(100, 0, (isset($arr_detailproj[$r]) ? $arr_detailproj[$r] : ''), '', 'C', false, 0, '', '', false, 1);
        }

        PDF::MultiCell(100, 0, (isset($arr_postdate[$r]) ? $arr_postdate[$r] : ''), '', 'C', false, 0, '', '', false, 1);
        PDF::MultiCell(100, 0, (isset($arr_amt[$r]) ? $arr_amt[$r] : ''), '', 'C', false, 0, '', '', false, 1);
        PDF::MultiCell(150, 0, (isset($arr_remarks[$r]) ? $arr_remarks[$r] : ''), '', 'L', false, 1, '', '', false, 1);
      }
    ...
    PDF::MultiCell(63, 0, number_format($totaldb, $decimalprice), '', 'R');
