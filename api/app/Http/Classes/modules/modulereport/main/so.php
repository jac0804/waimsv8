  ...
  public function reportparamsdata($config)
  {
    ...
    switch ($companyid) {
      case 40: //cdo
        ...
        break;
      default:
        $amtformat =     "'' as amountformat,";
        if ($companyid == 50) $amtformat = "'0' as amountformat,"; //unitech
    ...
    switch ($companyid) {
      case 50:
        if ($amtformat == '0') {
          ...
          PDF::MultiCell(390, 0, "DESCRIPTION", '', 'L', false);
        }
        break;
      default:
        PDF::MultiCell(100, 0, "BARCODE", '', 'C', false, 0);
          ...
          switch ($companyid) {
            case 50:
              if ($amtformat == '0') {
                ...
                PDF::MultiCell(390, 15, ' ' . (isset($arr_itemname[$r]) ? $arr_itemname[$r] : ''), '', 'L', false, 1, '',  '', true, 0, false, true, 0, 'M', false);
              }
              break;
            default:
              PDF::MultiCell(100, 15, ' ' . (isset($arr_barcode[$r]) ? $arr_barcode[$r] : ''), '', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
