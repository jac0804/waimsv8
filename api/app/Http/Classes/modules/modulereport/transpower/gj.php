...
class gj
{
  ...
  public function default_GJ_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(175, 0, "ACCOUNT NAME", '', 'C', false, 0);
  ...
  public function default_GJ_PDF($params, $data)
  {
    ...
    if (!empty($data)) {
      ...
      for ($i = 0; $i < count($data); $i++) {
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          PDF::SetFont($font, '', $fontsize);
          PDF::MultiCell(70, 0, (isset($arr_acno[$r]) ? $arr_acno[$r] : ''), '', 'L', false, 0, '', '', true, 1);
          // PDF::SetFont($font, '', 10.5);
          PDF::MultiCell(175, 0, (isset($arr_acnoname[$r]) ? $arr_acnoname[$r] : ''), '', 'L', false, 0, '', '', false, 1);
          PDF::SetFont($font, '', $fontsize);
