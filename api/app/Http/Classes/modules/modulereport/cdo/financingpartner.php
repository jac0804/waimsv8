...
class financingpartner
{
    ...
    public function generateResult($config)
    {
        ...
        switch ($reporttype) {
            case 'ar':
                $query = $this->CDO_AR_QUERY($config);
                break;
            case 'ap':
                $query = $this->CDO_AP_QUERY($config);
                break;
            case 'pdc':
                $query = $this->CDO_PDC_QUERY($config);
                break;
            case 'rc':
                $query = $this->CDO_RC_QUERY($config);
                break;
            case 'stock':
                $query = $this->CDO_STOCK_QUERY($config);
                break;
        }
    ...
    public function reportplotting($config, $data)
    {
        ...
        if ($config['params']['dataparams']['print'] == "default") {
            switch ($reporttype) {
                case 'ar':
                    $str = $this->CDO_AR($config, $data);
                    break;
                case 'ap':
                    $str = $this->CDO_AP($config, $data);
                    break;
                case 'pdc':
                    $str = $this->CDO_PDC($config, $data);
                    break;
                case 'rc':
                    $str = $this->CDO_RC($config, $data);
                    break;
                case 'stock':
                    $str = $this->CDO_STOCK($config, $data);
                    break;
            }
        } else {
            switch ($reporttype) {
                case 'ar':
                    $str = $this->CDO_AR_PDF($config, $data);
                    break;
                case 'ap':
                    $str = $this->CDO_AP_PDF($config, $data);
                    break;
                case 'pdc':
                    $str = $this->CDO_PDC_PDF($config, $data);
                    break;
                case 'rc':
                    $str = $this->CDO_RC_PDF($config, $data);
                    break;
                case 'stock':
                    $str = $this->CDO_STOCK_PDF($config, $data);
                    break;
            }
        }
        return $str;
    ...
    public function CDO_AR_QUERY($config)
    {
        $center   = $config['params']['center'];
        $username = $config['params']['user'];
    ...
    public function CDO_AP_QUERY($config)
    {
        $center   = $config['params']['center'];
        $username = $config['params']['user'];
        $clientid = md5($config['params']['dataid']);
    ...
    public function CDO_PDC_QUERY($config)
    {
    ...
    public function CDO_RC_QUERY($config)
    {
        $center   = $config['params']['center'];
        $username = $config['params']['user'];
        $clientid = md5($config['params']['dataid']);
    ...
    public function CDO_STOCK_QUERY($config)
    {
        $center   = $config['params']['center'];
        $username = $config['params']['user'];
        $clientid = md5($config['params']['dataid']);
    ...
    //DEFAULT LAYOUT
    public function CDO_AR($config, $data)
    {
        ...
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col('FINANCING PARTNER - ACCOUNTS RECEIVABLE ', null, null, false, $border, '', '', $font, '18', 'B', '', '') . '<br />';
        $str .= $this->reporter->endrow();
        ...
        $str .= $this->reporter->begintable($layoutsize);
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col('Financing Partner:', '50', null, false, $border, '', 'L', $font, $fontsize, '', '', '1px');
    ...
    public function CDO_AP($config, $data)
    {
        ...
        $str .= $this->reporter->begintable($layoutsize);
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col('FINANCING PARTNER - ACCOUNTS PAYABLE', null, null, false, $border, '', '', $font, '18', 'B', '', '') . '<br />';
        $str .= $this->reporter->endrow();
    ...
    public function CDO_PDC($config, $data)
    {
        ...
        $str .= $this->reporter->begintable($layoutsize);
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col('FINANCING PARTNER - POSTDATED CHECKS ', null, null, false, $border, '', '', $font, '18', 'B', '', '') . '<br />';
        $str .= $this->reporter->endrow();
    ...
    public function CDO_RC($config, $data)
    {
        ...
        $str .= $this->reporter->begintable($layoutsize);
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col('FINANCING PARTNER - RETURN CHECKS ', null, null, false, $border, '', '', $font, '18', 'B', '', '') . '<br />';
        $str .= $this->reporter->endrow();
    ...
    public function CDO_STOCK($config, $data)
    {
        ...
        $str .= $this->reporter->begintable($layoutsize);
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col('FINANCING PARTNER - INVENTORY ', null, null, false, $border, '', '', $font, '18', 'B', '', '') . '<br />';
        $str .= $this->reporter->endrow();
    ...
    public function CDO_AR_PDF($config, $data)
    {
        $center   = $config['params']['center'];
        $username = $config['params']['user'];
        $clientid = $config['params']['dataid'];
        ...
        PDF::MultiCell(760, 30, "FINANCING PARTNER - ACCOUNTS RECEIVABLE", '', 'L', false);
        ...
        PDF::SetFont($font, '', 11);
        PDF::MultiCell(100, 20, "Financing Partner : ", '', 'L', false, 0);
        PDF::SetFont($fontbold, '', 11);
    ...
    public function CDO_AP_PDF($config, $data)
    {
        $center   = $config['params']['center'];
        $username = $config['params']['user'];
        $clientid = $config['params']['dataid'];
        ...
        PDF::SetFont($fontbold, '', 15);
        PDF::MultiCell(760, 30, "FINANCING PARTNER - ACCOUNTS PAYABLE", '', 'L', false);
    ...
    public function CDO_PDC_PDF($config, $data)
    {
        ...
        PDF::SetFont($fontbold, '', 15);
        PDF::MultiCell(760, 30, "FINANCING PARTNER - POSTDATED CHECKS", '', 'L', false);
    ...
    public function CDO_RC_PDF($config, $data)
    {
        $center   = $config['params']['center'];
        $username = $config['params']['user'];
        $clientid = $config['params']['dataid'];
        ...
        PDF::SetFont($fontbold, '', 15);
        PDF::MultiCell(760, 30, "FINANCING PARTNER - RETURN CHECKS", '', 'L', false);
    ...
    public function CDO_STOCK_PDF($config, $data)
    {
        $center   = $config['params']['center'];
        $username = $config['params']['user'];
        $clientid = $config['params']['dataid'];
        ...
        PDF::SetFont($fontbold, '', 15);
        PDF::MultiCell(760, 30, "FINANCING PARTNER - INVENTORY", '', 'L', false);
