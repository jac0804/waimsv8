...
class pv
{
  ...
  public function reportparamsdata($config)
  {
    ...
    $payor = $this->coreFunctions->datareader("select fieldvalue as value from signatories where fieldname = 'payor' and doc =? ", [$config['params']['doc']]);
    $tin = $this->coreFunctions->datareader("select fieldvalue as value from signatories where fieldname = 'tin' and doc =? ", [$config['params']['doc']]);
    $position = $this->coreFunctions->datareader("select fieldvalue as value from signatories where fieldname = 'position' and doc =? ", [$config['params']['doc']]);
  ...
  public function reportplotting($config, $data)
  {
    if ($config['params']['dataparams']['print'] == "default") {
      ...
      switch ($config['params']['dataparams']['reporttype']) {
        case 0: // VOUCHER
          $str = $this->PDF_CDO_CCVOUCHER_LAYOUT($data, $config);
          break;
        case 2:
  ...
  public function PDF_CDO_header_ccvoucher($params, $data)
  {
    ...
    PDF::MultiCell(720, 25, $this->modulename, '', 'C', false);


    PDF::SetFont($fontbold, '', 14);
    PDF::MultiCell(300, 5, '', '', 'L', false, 0);
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(300, 5, "APV #: ", '', 'R', false, 0, '',  '');
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(120, 5, (isset($data[0]['yourref']) ? $data[0]['yourref'] : ''), '', 'R', false, 1);
    ...
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(120, 5, (isset($data[0]['docno']) ? $data[0]['docno'] : ''), '', 'R', false, 1);

    PDF::SetFont($fontbold, '',  $fontsize);
    PDF::MultiCell(50, 25, 'Date:', '', 'L', false, 0);
    PDF::SetFont($font, '',  $fontsize);
    PDF::MultiCell(670, 25, (isset($data[0]['dateid']) ? $data[0]['dateid'] : ''), '', 'L', false);


    PDF::SetFont($fontbold, '',  $fontsize);
    PDF::MultiCell(50, 25, 'Name:', '', 'L', false, 0);
    PDF::SetFont($font, '',  $fontsize);
    PDF::MultiCell(670, 25, (isset($data[0]['clientname']) ? $data[0]['clientname'] : ''), '', 'L', false);

    PDF::SetFont($fontbold, '',  $fontsize);
    PDF::MultiCell(50, 25, 'Address:', '', 'L', false, 0);
    PDF::SetFont($font, '',  $fontsize);
    PDF::MultiCell(670, 25, (isset($data[0]['address']) ? $data[0]['address'] : ''), '', 'L', false);
  }


  public function PDF_CDO_CCVOUCHER_LAYOUT($data, $params)
  {
    ...
    $this->PDF_CDO_header_ccvoucher($params, $data);

    $totaldb = 0;
    $totalcr = 0;
    $remarks = "";

    // $style = ['width' => 1, 'cap' => 'butt', 'join' => 'miter', 'dash' => 1, 'color' => [155, 155, 155]];
    $style = ['dash' => 3];
    ...
    PDF::SetFont($fontbold, '', 14);
    PDF::MultiCell(100, 25, '', 'B', 'L', false, 0);
    PDF::MultiCell(400, 25, 'PARTICULARS', 'B', 'L', false, 0);
    PDF::MultiCell(110, 25, 'DEBIT', 'B', 'R', false, 0);
    PDF::MultiCell(110, 25, 'CREDIT', 'B', 'R', false);
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      PDF::SetFont($font, '', 11);
      PDF::MultiCell(500, 25, $acname . ' ' . $data[$i]['project'], '', 'L', false, 0);

      PDF::MultiCell(110, 25, $debit, '', 'R', false, 0);
      PDF::MultiCell(110, 25, $credit, '', 'R', false);
    }
    ...
    PDF::SetFont($font, '',  $fontsize);
    PDF::MultiCell(640, 25, (isset($data[0]['rem']) ? $data[0]['rem'] : ''), '', 'L', false);


    PDF::MultiCell(720, 20, '', 'B', '', false);
    ...
    PDF::MultiCell(70, 15, 'AMOUNT : ', '', 'L', false, 0);
    PDF::MultiCell(150, 15, '', 'B', 'L', false, 0);
    PDF::MultiCell(10, 15, '', '', 'L', false, 0);
    PDF::MultiCell(150, 15, '', 'B', 'L', false, 0);
    PDF::MultiCell(10, 15, '', '', 'L', false, 0);
    ...
    PDF::MultiCell(180, 0, 'Received By: ', '', 'C');


    PDF::MultiCell(0, 0, "\n");


    PDF::MultiCell(170, 20, $params['params']['dataparams']['prepared'], 'B', 'L', false, 0);
    PDF::MultiCell(10, 0, '', '', '', false, 0);
    PDF::MultiCell(170, 20, $params['params']['dataparams']['checked'], 'B', 'L', false, 0);
    PDF::MultiCell(10, 0, '', '', '', false, 0);
    PDF::MultiCell(170, 20, $params['params']['dataparams']['approved'], 'B', 'L', false, 0);
    PDF::MultiCell(10, 0, '', '', '', false, 0);
    PDF::MultiCell(180, 20, $params['params']['dataparams']['received'], 'B', 'C');
