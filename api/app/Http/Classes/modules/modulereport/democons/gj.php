...
class gj
{
  ...
  public function Maxipro_GJ_header_PDF($params, $data)
  {
    ...
    PDF::Image('public/images/reports/mdc.jpg', '45', '20', 120, 65);
    PDF::Image('public/images/reports/tuv.jpg', '640', '20', 120, 65);

    // MultiCell($w, $h, $txt, $border=0, $align='J', $fill=0, $ln=1, $x='', $y='', $reseth=true, $stretch=0, $ishtml=false, $autopadding=true, $maxh=0)
    PDF::SetFont($fontbold, '', 15);
    PDF::MultiCell(450, 0, strtoupper($this->modulename), '', 'L', false, 0, '',  '100');
    PDF::SetFont($fontbold, '', 14);
    ...
    PDF::MultiCell(180, 0, "ACCOUNT NAME", 'B', 'C', false, 0);
    PDF::MultiCell(140, 0, "PROJECT", 'B', 'C', false, 0);
    PDF::MultiCell(105, 0, "SUBPROJECT", 'B', 'C', false, 0);
  ...
  public function Maxipro_GJ_PDF($params, $data)
  {
    ...
    if (!empty($data)) {
      ...
      for ($i = 0; $i < count($data); $i++) {
        ...
        $project = $this->reporter->fixcolumn([$data[$i]['projcode']], 25, 0);
        ...
        if ($data[$i]['acnoname'] == '') {
          ...
          for ($r = 0; $r < $maxrow; $r++) {
            ...
            PDF::MultiCell(180, 0, isset($acnonamedescs[$r]) ? $acnonamedescs[$r] : '', '', 'L', false, 0);
            PDF::MultiCell(130, 0, isset($project[$r]) ? $project[$r] : '', '', 'L', false, 0);
            PDF::MultiCell(115, 0, isset($subproject[$r]) ? $subproject[$r] : '', '', 'L', false, 0);
