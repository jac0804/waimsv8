...
class rq
{
  ...
  public function maxipro_layout_PDF($params, $data)
  {
    ...
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(350, 20, 'PURCHASE REQUISITION NO. ', '', 'R', 0, 0, '', '', true, 0, true, false);
    ...
    PDF::MultiCell(65, 15, 'ITEM NO.', 'LRTB', 'C', false, 0);
    PDF::MultiCell(155, 15, 'DESCRIPTION', 'LRTB', 'C', false, 0);
    PDF::MultiCell(110, 15, 'NOTES', 'LRTB', 'C', false, 0);
    PDF::MultiCell(70, 15, 'QTY', 'LRTB', 'C', false, 0);
    PDF::MultiCell(60, 15, 'UOM', 'LRTB', 'C', false, 0);
    PDF::MultiCell(100, 15, 'UNIT PRICE', 'LRTB', 'C', false, 0);
    PDF::MultiCell(140, 15, 'AMOUNT', 'LRTB', 'C', false);
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      $arr_stockrem = $this->reporter->fixcolumn([$stockrem], '30', 0);
      ...
      for ($r = 0; $r < $maxrow; $r++) {
        ...
        PDF::SetFont($font, '', $fontsize);
        PDF::MultiCell(65, 15, (isset($arr_counter[$r]) ? $arr_counter[$r] : ''), 'L', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
        PDF::MultiCell(155, 15, (isset($arr_itemname[$r]) ? $arr_itemname[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
        PDF::MultiCell(110, 15, (isset($arr_stockrem[$r]) ? $arr_stockrem[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
        PDF::MultiCell(70, 15, (isset($arr_rqty[$r]) ? $arr_rqty[$r] : ''), '', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
        ...
        PDF::MultiCell(140, 15, (isset($arr_tamt[$r]) ? $arr_tamt[$r] : ''), 'R', 'R', false, 1, '',  '', true, 0, true, true, 0, 'M', false);
      }
    ...
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(550, 15, '', 'BL', 'R', false, 0);
    PDF::MultiCell(150, 15, 'Php ' . number_format($totalext, 2), 'BR', 'R', false, 1, '',  '', true, 0, true, true, 0, 'M', false);
    ...
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(650, 20, $data[0]['rem'], '', 'L', 0, 0, '', '', true, 0, true, false);
