...
class cr
{
  ...
  public function report_default_query($filters)
  {
    ...
    $query = "select trno,dateid,docno,clientname,address,acno,acnoname,client,ref,sum(cr) as cr,postdate,sum(db) as db,alias,checkno from (
      ...
      where head.doc='cr' and head.trno='$trno') as a
  ...
  public function Max_CR_header_PDF($params, $data)
  {
    ...
    PDF::SetFont($fontbold, '', 14);
    PDF::MultiCell(550, 0, strtoupper($this->modulename), '', 'L', false, 0, '',  '100');
  ...
  public function Max_CR_PDF($params, $data)
  {
    ...
    PDF::MultiCell(263, 0, 'Approved By: ', '', 'L', false, 0);
    PDF::MultiCell(263, 0, 'Received By: ', '', 'L');

    PDF::MultiCell(0, 0, "");
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(210, 18, $params['params']['dataparams']['prepared'], 'B', 'C', false, 0);
    PDF::MultiCell(53, 0, '', '', 'C', false, 0);
    PDF::MultiCell(210, 18, $params['params']['dataparams']['approved'], 'B', 'C', false, 0);
    PDF::MultiCell(53, 0, '', '', 'C', false, 0);
    PDF::MultiCell(210, 18, $params['params']['dataparams']['received'], 'B', 'C');
    PDF::MultiCell(53, 0, '', '', 'C', false, 0);
