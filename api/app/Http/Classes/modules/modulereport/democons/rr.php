...
class rr
{
  ...
  public function Inventory_RR_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(460, 0, 'RECEIVING ITEMS', '', 'L', false, 0, '',  '100');
    ...
    PDF::MultiCell(65, 25, "QTY", 'B', 'C', false, 0);
    PDF::MultiCell(10, 25, "", '', 'C', false, 0);
    PDF::MultiCell(50, 25, "UNIT", 'B', 'C', false, 0);
    PDF::MultiCell(10, 25, "", '', 'C', false, 0);
    PDF::MultiCell(170, 25, "DESCRIPTION", 'B', 'C', false, 0);
    PDF::MultiCell(10, 25, "", '', 'C', false, 0);
    PDF::MultiCell(105, 25, "PO REFERENCE", 'B', 'C', false, 0);
    PDF::MultiCell(10, 25, "", '', 'C', false, 0);

    PDF::MultiCell(100, 25, "UNIT PRICE", 'B', 'R', false, 0);
    PDF::MultiCell(10, 25, "", '', 'C', false, 0);
    PDF::MultiCell(50, 25, "(+/-) %", 'B', 'R', false, 0);
    PDF::MultiCell(10, 25, "", '', 'C', false, 0);
  ...
  public function Inventory_RR_PDF($params, $data)
  {
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        $itemname = $this->reporter->fixcolumn([$data[$i]['itemname']], '28', 0);
        ...
        if ($data[$i]['itemname'] == '') {
          PDF::SetFont($font, '', $fontsize);
          PDF::MultiCell(65, 0, number_format($data[$i]['qty'], 2), 'B', 'C', false, 0);
          PDF::MultiCell(10, 0, "", '', 'C', false, 0);
          PDF::MultiCell(50, 0, $data[$i]['uom'], 'B', 'C', false, 0);
          PDF::MultiCell(10, 0, "", '', 'C', false, 0);
          PDF::MultiCell(170, 0, $data[$i]['itemname'], 'B', 'C', false, 0);
          PDF::MultiCell(10, 0, "", '', 'C', false, 0);
          PDF::MultiCell(105, 0, $data[$i]['ref'], 'B', 'C', false, 0);
          PDF::MultiCell(10, 0, "", '', 'C', false, 0);
          PDF::MultiCell(100, 0, number_format($data[$i]['netamt'], $decimalcurr), 'B', 'C', false, 0);
          PDF::MultiCell(10, 0, "", '', 'C', false, 0);
          PDF::MultiCell(50, 0, $data[$i]['disc'], 'B', 'C', false, 0);
          PDF::MultiCell(10, 0, "", '', 'C', false, 0);
          ...
          for ($r = 0; $r < $maxrow; $r++) {
            if ($r == 0) {
              ...
              $uom = $data[$i]['uom'];
              $amt = number_format($data[$i]['netamt'], $decimalcurr);
              $disc = $data[$i]['disc'];
            ...
            PDF::SetFont($font, '', $fontsize);
            PDF::MultiCell(65, 0, $qty, '', 'C', false, 0, '', '', false, 1);
            PDF::MultiCell(10, 0, '', '', 'C', false, 0, '', '', false, 1);
            PDF::MultiCell(50, 0, $uom, '', 'C', false, 0, '', '', false, 1);
            PDF::MultiCell(10, 0, '', '', 'C', false, 0, '', '', false, 1);
            PDF::MultiCell(170, 0, (isset($itemname[$r]) ? $itemname[$r] : ''), '', 'L', false, 0, '', '', false, 1);
            PDF::MultiCell(10, 0, '', '', 'C', false, 0, '', '', false, 1);
            PDF::MultiCell(105, 0, $ref, '', 'L', false, 0, '', '', false, 1);
            PDF::MultiCell(10, 0, '', '', 'C', false, 0, '', '', false, 1);
