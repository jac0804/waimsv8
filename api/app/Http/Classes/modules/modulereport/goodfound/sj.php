...
class sj
{
  ...
  public function report_default_query($config)
  {
    ...
    ifnull(date(hinfo.releasedate),'') as releasedate,ifnull(hinfo.weightintime,'') as weightintime,ifnull(hinfo.weightouttime,'') as weightouttime,substring(stock.ref,1,2) as bref
    from lahead as head
  ...
  public function reportplotting($params, $data)
  {
    ...
    switch ($reporttype) {
      case 2: // CWOR shooting
        return $this->shooting_cwor_PDF($params, $data);
        break;
      case 1: // CWOR
  ...
  public function shooting_cwor_PDF($params, $data)
  {
    ...
    PDF::MultiCell(120, 0, $data[0]['batchno'], '', 'C', false, 1, '475',  '22');
    PDF::SetFont($font, 'B', 11);
    PDF::MultiCell(120, 0, $data[0]['docno'], '', 'C', false, 1, '435',  '75');

    $bir = 0;
    PDF::SetFont($fontbold, '', $fontsize);

    // if ($bir == 0) {
      PDF::MultiCell(50, 0, '', '', 'L', 0, 0, '-5', '132'); 

      
      if (isset($data[0]['bref'])) {
        if($data[0]['bref']=='ND'){
          PDF::MultiCell(15, 0, $data[0]['area1'], '', 'C', 0, 0, '', '');
          PDF::MultiCell(15, 0, $data[0]['area2'], '', 'C', 0, 0, '', '');
          PDF::MultiCell(15, 0, $data[0]['area3'], '', 'C', 0, 0, '', '');
          PDF::MultiCell(10, 0, '', '', 'C', 0, 0, '', ''); 

          PDF::MultiCell(15, 0, $data[0]['not4'], '', 'C', 0, 0, '', '');
          PDF::MultiCell(15, 0, $data[0]['not5'], '', 'C', 0, 0, '', '');
          PDF::MultiCell(15, 0, '', '', 'C', 0, 0, '', ''); 

          PDF::MultiCell(15, 0, $data[0]['not6'], '', 'C', 0, 0, '', '');
          PDF::MultiCell(15, 0, $data[0]['not7'], '', 'C', 0, 0, '', '');
          PDF::MultiCell(15, 0, '', '', 'C', 0, 0, '', ''); 

          PDF::MultiCell(15, 0, $data[0]['not8'], '', 'C', 0, 0, '', '');
          PDF::MultiCell(15, 0, $data[0]['not9'], '', 'C', 0, 0, '', '');
          PDF::MultiCell(15, 0, $data[0]['not10'], '', 'C', 0, 0, '', ''); 
        }else{
          PDF::MultiCell(15, 0, '', '', 'C', 0, 0, '', '');
          PDF::MultiCell(15, 0, '', '', 'C', 0, 0, '', '');
          PDF::MultiCell(15, 0, '', '', 'C', 0, 0, '', '');
          ...
          PDF::MultiCell(42, 0, $data[0]['bir4'] . $data[0]['bir5'] . $data[0]['bir6'], '', 'C', 0, 0, '58', '');


          PDF::MultiCell(30, 0, $data[0]['bir7'] . $data[0]['bir8'], '', 'C', 0, 0, '', '');

          PDF::MultiCell(30, 0, $data[0]['bir9'] . $data[0]['bir10'], '', 'C', 0, 0, '', '');

          PDF::MultiCell(42, 0, $data[0]['bir11'] . $data[0]['bir12'] . $data[0]['bir13'], '', 'C', 0, 0, '', '');
    ...
    // } 
    // else {
    //   PDF::MultiCell(50, 0, '', '', 'L', 0, 0, '-5', '130'); 

    //   PDF::MultiCell(45, 0, $data[0]['area1'] . $data[0]['area2'] . $data[0]['area3'], '', 'C', 0, 0, '35', '');
    //   PDF::MultiCell(10, 0, '', '', 'C', 0, 0, '', ''); 
    ...
    PDF::setFontSpacing(7);
    PDF::MultiCell(160, 0, $data[0]['cwano'], '', 'C', 0, 0, '200', '');
    PDF::MultiCell(20, 0, '', '', 'L', 0, 0, '', '');
    PDF::setFontSpacing(0);



    switch ($data[0]['assignedlane']) {
      case '1':
        PDF::Circle(410, 135, 13);
        break;
      case '2':
        PDF::Circle(445, 135, 13);
        break;
      case '3':
        PDF::Circle(480, 135, 13);
        break;
      case '4':
        PDF::Circle(515, 135, 13);
        break;
      default:
        PDF::MultiCell(260, 0, $data[0]['assignedlane'], '', 'C', 0, 1, '410', '');
        break;
    }
    ...
    PDF::MultiCell(260, 0, (isset($data[0]['clientname']) ? $data[0]['clientname'] : ''), '', 'C', 0, 0, '10', '155');
    PDF::MultiCell(200, 0, number_format($totalqty, 2), '', 'C', 0, 0, '200', '');


    PDF::MultiCell(25, 0, $data[0]['dateyear'], '', 'C', 0, 0, '370', '');
    PDF::MultiCell(25, 0, $data[0]['datemonth'], '', 'C', 0, 0, '415', '');
    PDF::MultiCell(25, 0, $data[0]['dateday'], '', 'C', 0, 0, '440', '');

    PDF::MultiCell(50, 0, $data[0]['weightintime'], '', 'C', 0, 0, '505', '');
    ...
    PDF::MultiCell(260, 0, '', '', 'L', 0, 0, '', '160');
    PDF::MultiCell(200, 0, '', '', 'L', 0, 0, '', '');
    PDF::MultiCell(260, 0, '', '', 'L', 0, 1, '', '');

    PDF::MultiCell(260, 0, $data[0]['area'], '', 'L', 0, 0, '75', '');
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        PDF::SetFont($fontbold, '', $fontsize);
        PDF::MultiCell(100, $height, ' ' . $itemname, '', 'L', false, 0, '240',  '');
        PDF::MultiCell(260, $height, ' ' . $prepared, '', 'L', false, 1, '',  '');
      }
    }

    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(200, 0, $data[0]['hauler'], '', 'L', 0, 0, '75', '235');
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(120, 0, $data[0]['plateno'], '', 'L', 0, 1, '280', '');

    PDF::SetFont($fontbold, '', $fontsize);

    PDF::MultiCell(200, 0, $data[0]['driver'], '', 'L', 0, 0, '75', '265');

    PDF::MultiCell(120, 0, $data[0]['licenseno'], '', 'L', 0, 1, '250', '');

    PDF::MultiCell(200, 0, $data[0]['releasedate'] . '   ' . $data[0]['weightouttime'], '', 'L', 0, 1, '450', '330');
  ...
  public function default_cwor_PDF($params, $data)
  {
    ...
    PDF::MultiCell(240, 0, strtoupper($headerdata[0]->name), '', 'C', false, 0);
    ...
    PDF::SetCellPaddings(4, 4, 4, 4);
    PDF::SetFont($font, 'B', 11);
    PDF::MultiCell(100, 0, "BATCH #. ", '', 'L', false, 0, '580',  '40');
    PDF::MultiCell(120, 0, $data[0]['batchno'], 'B', 'C', false, 1, '640',  '40');
