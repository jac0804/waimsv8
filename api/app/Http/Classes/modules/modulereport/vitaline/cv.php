  ...
  public function PDF_DEFAULT_CCVOUCHER_LAYOUT1($data,$params){
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        $maxrow = $this->othersClass->getmaxcolumn([$arr_acno, $arr_acnoname, $arr_checkno, $arr_postdate, $arr_debit, $arr_credit, $arr_drem]);
      ...
      foreach($data['detail'] as $key => $value)
      {
        ...
        switch($data['head'][0]['month'])
        {
          ...
          default:
            PDF::MultiCell(95, 20, '', 'LRB', '',false,0);
            PDF::MultiCell(95, 20, '', 'LRB', '',false,0);
            PDF::MultiCell(120, 20, number_format($data['detail'][$key]['oamt']), 'LRB', 'R',false,0);
        ...
        PDF::MultiCell(120, 20, number_format($data['detail'][$key]['xamt']), 'LRB', 'R',false,0);
