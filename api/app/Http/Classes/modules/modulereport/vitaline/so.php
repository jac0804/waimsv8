...
class so
{
  ...
  public function report_default_query($trno)
  {
    ...
    $query = "select head.rtype,head.rdate,cust.tel2,cust.email,head.docno,head.trno, head.clientname, head.address, 
      ...
      item.sizeid,m.model_name as model, head.ourref
  ...
  public function reportplotting($params, $data) {
    return $this->vitaline_SO_PDF($params, $data);
  }

  public function vitaline_SO_LAYOUT($params, $data)
  {
  ...
  public function vitaline_SO_header_PDF($params, $data)
  {
    $center = $params['params']['center'];
    $username = $params['params']['user'];
  ...
  public function vitaline_SO_PDF($params, $data)
  {
    ...
    $this->vitaline_SO_header_PDF($params, $data);
    PDF::SetFont($font, '', 5);
    PDF::MultiCell(700, 0, '', '');
    $countarr = 0;
    for ($i = 0; $i < count($data); $i++) {
      ...
      $maxrow = $this->othersClass->getmaxcolumn([$arr_qty, $arr_uom, $arr_itemname, $arr_gross, $arr_disc, $arr_ext]);
      ...
      for($r = 0; $r < $maxrow; $r++) {
        ...
        PDF::MultiCell(100, 0, (isset($arr_gross[$r]) ? $arr_gross[$r] : ''), '', 'R', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(100, 0, (isset($arr_disc[$r]) ? $arr_disc[$r] : ''), '', 'C', 0, 0, '', '', true, 0, true, false);
