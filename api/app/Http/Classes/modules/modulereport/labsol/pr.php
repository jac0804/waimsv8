...
class pr
{
  ...
  public function reportplotting($params, $data) {
     ...
     return $this->vitaline_PR_PDF($params, $data);
  }
  ...
  public function vitaline_PR_header_PDF($params, $data)
  {
    $center = $params['params']['center'];
    $username = $params['params']['user'];
    ...
    PDF::MultiCell(400, 0, "DESCRIPTION", '', 'L', false, 0);
  ...
  public function vitaline_PR_PDF($params, $data)
  {
    ...
    $this->vitaline_PR_header_PDF($params, $data);
    PDF::SetFont($font, '', 5);
    PDF::MultiCell(700, 0, '', '');
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        $maxrow = $this->othersClass->getmaxcolumn([$arr_barcode, $arr_qty, $arr_uom, $arr_ext, $arr_itemname]);
        ...
        for($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::MultiCell(400, 0, (isset($arr_itemname[$r]) ? $arr_itemname[$r] : ''), '', 'L', false, 0, '', '', false, 1);
          PDF::MultiCell(100, 0, (isset($arr_ext[$r]) ? $arr_ext[$r] : ''), '', 'R', false, 1, '', '', false, 0);
        }
