  ...
  public function vitaline_RR_PDF($params, $data)
  {
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        $maxrow = $this->othersClass->getmaxcolumn([$arr_itemname, $arr_qty, $arr_uom, $arr_expiry, $arr_gross, $arr_disc, $arr_ext]);
        ...
        for($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::MultiCell(100, 0, (isset($arr_expiry[$r]) ? $arr_expiry[$r] : ''), '', 'C', 0, 0, '', '', true, 0, true, false);
