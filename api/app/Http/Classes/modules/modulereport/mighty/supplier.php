...
class supplier
{
    ...
    public function default_AP_QUERY($config)
    {
        ...
        $query = "select t.yourref, t.trno, t.line, t.doc, t.docno, date_format(t.dateid,'%m/%d/%y') as transdate, t.db, t.cr, t.bal, t.ref, t.rem, t.status,client.client,client.agent,client.clientname,client.addr,
        client.tel,client.tel2,client.tin,client.mobile,client.email,client.contact,client.fax, t.reference, t.dateid  from(
    ...
    public function default_PDC_QUERY($config)
    {
        ...
        $query = "select customerpdc.trno, customerpdc.doc, customerpdc.docno, customerpdc.checkno, customerpdc.checkdate, customerpdc.db, customerpdc.cr,ifnull(customerpdc.rem,'') as rem,client.client,client.clientname,client.addr,client.tel,client.tel2,client.tin,client.mobile,client.email,client.contact,client.fax from (select glhead.doc,coa.alias,glhead.trno, glhead.docno, gldetail.checkno, gldetail.postdate as checkdate, gldetail.db,
    ...
    public function default_STOCK_QUERY($config)
    {
        ...
        $query = "
        select * from (select `glhead`.`trno` as `trno`,`glhead`.`doc` as `doc`,`glhead`.`clientid` as `clientid`,
        ...
        group by trno, doc, clientid, docno, dateid, barcode, itemname, uom, disc, cost, isamt, isqty, rrqty, client, clientname,addr, tel, 
        tel2, email, tin, mobile, contact, rem, fax";
    ...
    public function reportdefaultAP_PDF($config, $data)
    {
        ...
        foreach ($data as $key => $data1) {
            ...
            PDF::MultiCell(70, 15, $data1->transdate, '', 'C', 0, 0, '', '', true, 0, true, false);
    ...
    public function reportdefaultSTOCK_PDF($config, $data)
    {
        ...
        foreach ($data as $key => $data1) {
            ...
            PDF::MultiCell(80, 15, $data1->barcode, '', 'L', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(190, 15, $data1->itemname, '', 'L', 0, 0, '', '', true, 0, true, false);
