...
class vs
{
  private $modulename = "Void Service Sales Order";
  private $fieldClass;
  ...
  public function report_default_query($trno)
  {
    $query = "
      ...
      FROM vshead as head
      left join vsstock as stock on stock.trno = head.trno
      ...
      left join hvsstock as stock on stock.trno = head.trno
      left join item as item on item.itemid = stock.itemid
      left join projectmasterfile as project on project.line=head.projectid
      left join transnum as num on num.trno = head.trno
      where head.trno='$trno'";
  ...
  public function reportplotting($params, $data)
  {
    if ($params['params']['dataparams']['print'] == "default") {
      return $this->default_vs_layout($params, $data);
    } else if ($params['params']['dataparams']['print'] == "PDFM") {
      return $this->default_vs_PDF($params, $data);
    }
  }
  ...
  public function default_header($params, $data)
  {
    ...
    $str .= $this->reporter->col('VOID SERVICE SALES ORDER', '600', null, false, $border, '', 'L', $font, '18', 'B', '', '');
  ...
  public function default_vs_layout($params, $data)
  {
  ...
  public function default_vs_header_PDF($params, $data)
  {
    $center = $params['params']['center'];
    $username = $params['params']['user'];
  ...
  public function default_vs_PDF($params, $data)
  {
    ...
    $this->default_vs_header_PDF($params, $data);
