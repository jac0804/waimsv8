...
class ap
{
  ...
  public function default_AP_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(390, 0, $this->modulename, '', 'L', false, 0, '',  '100');
    ...
    PDF::MultiCell(55, 0, "ACCOUNT#", '', 'L', false, 0);
    PDF::MultiCell(150, 0, "ACCOUNT NAME", '', 'L', false, 0);
    PDF::MultiCell(55, 0, "REFERENCE#", '', 'L', false, 0);
    PDF::MultiCell(50, 0, "DATE", '', 'C', false, 0);
    PDF::MultiCell(50, 0, "DEBIT", '', 'R', false, 0);
  ...
  public function default_AP_PDF($params, $data)
  {
      ...
      for ($i = 0; $i < count($data); $i++) {
        ...
        if ($data[$i]['acnoname'] == '') {
          ...
          for ($r = 0; $r < $maxrow; $r++) {
            ...
            PDF::SetFont($font, '', $fontsize9);
            PDF::MultiCell(55, 0, $acno, '', 'L', false, 0, '', '', true, 1);
            PDF::MultiCell(150, 0, isset($acnonamedescs[$r]) ? $acnonamedescs[$r] : '', '', 'L', false, 0, '', '', false, 1);
            PDF::MultiCell(55, 0, $ref, '', 'L', false, 0, '', '', false, 1);
            PDF::MultiCell(50, 0, $postdate, '', 'C', false, 0, '', '', false, 1);
            PDF::MultiCell(50, 0, $debit, '', 'R', false, 0, '', '', false, 1);
            PDF::MultiCell(60, 0, $credit, '', 'R', false, 0, '', '', false, 1);
            PDF::MultiCell(80, 0, $client, '', 'C', false, 1, '', '', false, 1);
          }
        }
        $totaldb += $data[$i]['db'];
        $totalcr += $data[$i]['cr'];
    ...
    PDF::SetFont($fontbold, '', $fontsize9);
    PDF::MultiCell(320, 0, 'GRAND TOTAL: ', '', 'R', false, 0);
    PDF::MultiCell(50, 0, number_format($totaldb, $decimalprice), '', 'R', false, 0);
    PDF::MultiCell(50, 0, number_format($totalcr, $decimalprice), '', 'R', false, 0);
