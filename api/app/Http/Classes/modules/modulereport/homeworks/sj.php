...
class sj
{
    ...
    private function report_default_header($params, $data)
    {
        ...
        $str .= $this->reporter->col('D E S C R P T I O N', '400', null, false, $border, 'B', 'C', $font, '12', 'B', '30px', '8px');
        $str .= $this->reporter->col('UNIT PRICE', '125', null, false, $border, 'B', 'C', $font, '12', 'B', '30px', '8px');
        $str .= $this->reporter->col('(+/-) %', '50', null, false, $border, 'B', 'C', $font, '12', 'B', '30px', '8px');
        $str .= $this->reporter->col('TOTAL', '125', null, false, $border, 'B', 'C', $font, '12', 'B', '30px', '8px');
        return $str;
    }
    ...
    public function default_sj_layout($params, $data)
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            $str .= $this->reporter->col(number_format($data[$i]['amt'], $decimal), '125', null, false, $border, '', 'R', $font, $fontsize, '', '', '2px');
        ...
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col('', '50', null, false, '1px dotted ', 'T', 'C', $font, '12', 'B', '', '');
        $str .= $this->reporter->col('', '50', null, false, '1px dotted ', 'T', 'C', $font, '12', 'B', '', '');
        $str .= $this->reporter->col('', '400', null, false, '1px dotted ', 'T', 'C', $font, '12', 'B', '', '');
        $str .= $this->reporter->col('', '125', null, false, '1px dotted ', 'T', 'C', $font, '12', 'B', '', '');
        $str .= $this->reporter->col('GRAND TOTAL :', '50', null, false, '1px dotted ', 'T', 'R', $font, '12', 'B', '', '');
        $str .= $this->reporter->col(number_format($totalext, $decimal), '125', null, false, '1px dotted ', 'T', 'R', $font, '12', 'B', '', '');
        $str .= $this->reporter->endrow();
        $str .= $this->reporter->endtable();
        ...
        $str .= $this->reporter->col('Received By :', '265', null, false, $border, '', 'R', $font, '12', '', '', '');
        $str .= $this->reporter->endrow();
        $str .= $this->reporter->endtable();
        ...
        $str .= $this->reporter->col($params['params']['dataparams']['received'], '265', null, false, $border, '', 'R', $font, '12', 'B', '', '');
        $str .= $this->reporter->endrow();
        $str .= $this->reporter->endtable();
