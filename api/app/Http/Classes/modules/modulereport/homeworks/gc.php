...
class gc
{
    ...
    public function default_GC_header_PDF($params, $data)
    {
        ...
        PDF::MultiCell(460, 0, $this->modulename, '', 'L', false, 0, '',  '100');
        PDF::SetFont($font, '', $fontsize);
        PDF::MultiCell(70, 0, "Docno #: ", '', 'L', false, 0, '',  '');
        PDF::SetFont($fontbold, '', 12);
        PDF::MultiCell(190, 0, (isset($data[0]['docno']) ? $data[0]['docno'] : ''), 'B', 'L', false, 1, '',  '');
        ...
        if ($adds > $maxChars) {
            ...
            foreach ($remainingLines as $line) {
                ...
                // PDF::SetFont($fontbold, '', 4);
                // PDF::MultiCell(700, 5, '', '', 'L', false); //space muna bago mag next line
            }
        } else {
            PDF::SetFont($font, '', $fontsize);
            PDF::MultiCell(135, 0, "CUSTOMER/SUPPLIER:  ", '', 'L', false, 0, '',  '');
