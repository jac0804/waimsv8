...
class gj
{
    ...
    public function rpt_gj_header_default($config, $result)
    {
        ...
        $str .= $this->reporter->col('GENERAL JOURNAL', '800', null, false, $border, '', 'L', $font, '18', 'B', '', '') . '<br />';
    ...
    public function default_GJ_header_PDF($params, $data)
    {
        ...
        PDF::MultiCell(75, 0, "Docno #: ", '', 'L', false, 0, '',  '');
        PDF::SetFont($fontbold, '', 12);
        PDF::MultiCell(180, 0, (isset($data[0]['docno']) ? $data[0]['docno'] : ''), 'B', 'L', false, 1, '',  '');
