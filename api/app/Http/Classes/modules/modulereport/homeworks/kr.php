...
class kr
{
    ...
    public function rpt_default_header($data, $filters)
    {
        ...
        $str .= $this->reporter->col('COUNTER RECEIPT', '800', null, false, '1px solid ', '', 'L', 'Century Gothic', '18', 'B', '', '');
        ...
        $str .= $this->reporter->col('', '350', null, false, '1px solid ', '', 'L', 'Century Gothic', '13', 'B', '', '');
        $str .= $this->reporter->col('', '75', null, false, '1px solid ', '', 'L', 'Century Gothic', '13', 'B', '', '');
        $str .= $this->reporter->col('', '75', null, false, '1px solid ', '', 'L', 'Century Gothic', '13', 'B', '', '');
        $str .= $this->reporter->col('', '75', null, false, '1px solid ', '', 'L', 'Century Gothic', '13', 'B', '', '');
        $str .= $this->reporter->col('DOCUMENT # :', '75', null, false, '1px solid ', '', 'L', 'Century Gothic', '13', 'B', '', '');
        ...
        $str .= $this->reporter->begintable('800');
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col('CUSTOMER: ', '75', null, false, '1px solid ', '', 'L', 'Century Gothic', '13', 'B', '', '');
        $str .= $this->reporter->col((isset($data[0]['clientname']) ? $data[0]['clientname'] : ''), '350', null, false, '1px solid ', '', 'L', 'Century Gothic', '13', '', '', '');
        $str .= $this->reporter->col('', '75', null, false, '1px solid ', '', 'L', 'Century Gothic', '13', '', '', '');
        $str .= $this->reporter->col('', '75', null, false, '1px solid ', '', 'L', 'Century Gothic', '13', '', '', '');
        $str .= $this->reporter->col('', '75', null, false, '1px solid ', '', 'L', 'Century Gothic', '13', '', '', '');
        $str .= $this->reporter->col('DATE : ', '75', null, false, '1px solid ', '', 'L', 'Century Gothic', '13', 'B', '', '');
        ...
        $str .= $this->reporter->col((isset($data[0]['address']) ? $data[0]['address'] : ''), '350', null, false, '1px solid ', '', 'L', 'Century Gothic', '13', '', '', '');
        $str .= $this->reporter->col('', '75', null, false, '1px solid ', '', 'L', 'Century Gothic', '13', '', '', '');
        $str .= $this->reporter->col('', '75', null, false, '1px solid ', '', 'L', 'Century Gothic', '13', '', '', '');
        $str .= $this->reporter->col('', '75', null, false, '1px solid ', '', 'L', 'Century Gothic', '13', '', '', '');
        $str .= $this->reporter->col('DATE : ', '75', null, false, '1px solid ', '', 'L', 'Century Gothic', '13', 'B', '', '');
