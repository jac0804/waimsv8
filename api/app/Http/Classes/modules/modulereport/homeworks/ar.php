...
class ar
{
    ...
    public function rpt_ar_header_default($params, $data)
    {
        ...
        $str .= $this->reporter->col('RECEIVABLE SETUP', '800', null, false, $border, '', 'L', $font, '18', 'B', '', '') . '<br />';
        ...
        $str .= $this->reporter->col((isset($data[0]['clientname']) ? $data[0]['clientname'] : ''), '350', null, false, $border, '', 'L', $font, $fontsize, '', '', '');
        $str .= $this->reporter->col('', '75', null, false, $border, '', 'L', $font, $fontsize, '', '', '');
        $str .= $this->reporter->col('', '75', null, false, $border, '', 'L', $font, $fontsize, '', '', '');
        $str .= $this->reporter->col('', '75', null, false, $border, '', 'L', $font, $fontsize, '', '', '');
        ...
        $str .= $this->reporter->col((isset($data[0]['address']) ? $data[0]['address'] : ''), '350', null, false, $border, '', 'L', $font, $fontsize, '', '', '');
        $str .= $this->reporter->col('', '75', null, false, $border, '', 'L', $font, $fontsize, '', '', '');
        $str .= $this->reporter->col('', '75', null, false, $border, '', 'L', $font, $fontsize, '', '', '');
        $str .= $this->reporter->col('', '75', null, false, $border, '', 'L', $font, $fontsize, '', '', '');
    ...
    public function default_AR_header_PDF($params, $data)
    {
        ...
        PDF::SetFont($fontbold, '', $fontsize);
        PDF::MultiCell(60, 0, "Ref: ", '', 'L', false, 0, '',  '');
        PDF::SetFont($font, '', $fontsize);
