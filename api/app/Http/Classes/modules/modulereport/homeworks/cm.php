...
class cm
{
    ...
    private function report_default_header($params, $data)
    {
        ...
        $str .= $this->reporter->col('D E S C R I P T I O N', '400', null, false, $border, 'B', 'L', $font, '12', 'B', '30px', '8px');
    ...
    public function default_cm_layout($params, $data)
    {
        ...
        $str .= $this->reporter->col('GRAND TOTAL :', '50', null, false, $border, 'T', 'L', $font, '12', 'B', '30px', '8px');
