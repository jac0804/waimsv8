...
class pv
{
    ...
    public function PDF_default_header_ccvoucher($params, $data)
    {
        ...
        PDF::MultiCell(340, 5, $this->modulename, '', 'L', false, 0);
        PDF::SetFont($font, '', $fontsize);
        PDF::MultiCell(195, 5, "DOCNO #: ", '', 'R', false, 0, '',  '');
        PDF::SetFont($fontbold, '', 12);
        PDF::MultiCell(185, 5, (isset($data[0]['docno']) ? $data[0]['docno'] : ''), '', 'R', false);
        ...
        PDF::SetFont($fontbold, '',  12);
        PDF::MultiCell(415, 25, (isset($data[0]['clientname']) ? $data[0]['clientname'] : ''), '', 'L', false, 0, '',  '');
        PDF::SetFont($font, '',  $fontsize);
        PDF::MultiCell(50, 25, 'DATE: ', '', 'R', false, 0);
        PDF::SetFont($fontbold, '',  12);

        $datehere = $data[0]['dateid'];
        $dates = date_format(date_create($datehere), 'M-d-Y');
        // PDF::MultiCell(5, 5, '', 'B', 'L', false, 0);
        PDF::MultiCell(185, 25, $dates, '', 'L', false);
        // PDF::MultiCell(150, 25, (isset($data[0]['dateid']) ? $data[0]['dateid'] : ''), '', 'L', false);

        PDF::SetFont($font, '',  $fontsize);
        PDF::MultiCell(75, 25, 'ADDRESS : ', '', 'L', false, 0);
        PDF::SetFont($fontbold, '',  12);
        PDF::MultiCell(385, 25, (isset($data[0]['address']) ? $data[0]['address'] : ''), '', 'L', false, 0, '',  '');
        PDF::SetFont($font, '',  $fontsize);
        PDF::MultiCell(75, 25, 'TAX ID No: ', '', 'R', false, 0);
        PDF::SetFont($fontbold, '',  12);
        PDF::MultiCell(185, 25, (isset($data[0]['tin']) ? $data[0]['tin'] : ''), '', 'L', false);


        PDF::SetFont($font, '',  $fontsize);
        PDF::MultiCell(75, 25, ' ', '', 'L', false, 0);
        PDF::SetFont($fontbold, '',  12);
        PDF::MultiCell(375, 25, '', '', 'L', false, 0, '',  '');
        PDF::SetFont($font, '',  $fontsize);
        PDF::MultiCell(85, 25, 'INVOICE No: ', '', 'R', false, 0);
        PDF::SetFont($fontbold, '',  12);
        PDF::MultiCell(185, 25, (isset($data[0]['yourref']) ? $data[0]['yourref'] : ''), '', 'L', false);
        ...
        PDF::MultiCell(375, 25, '', '', 'L', false, 0, '',  '');
        PDF::SetFont($font, '',  $fontsize);
        PDF::MultiCell(85, 25, 'DUE DATE :', '', 'R', false, 0);
        $datehere2 = $data[0]['due'];
        $due = date_format(date_create($datehere2), 'M-d-Y');
        PDF::SetFont($fontbold, '',  12);
        PDF::MultiCell(185, 25, $due, '', 'L', false);
        ...
        PDF::MultiCell(75, 25, ' ', '', 'L', false, 0);
        PDF::SetFont($fontbold, '',  12);
        PDF::MultiCell(370, 25, '', '', 'L', false, 0, '',  '');
        PDF::SetFont($font, '',  $fontsize);
        PDF::MultiCell(90, 25, 'COUNTER No: ', '', 'R', false, 0);
        PDF::SetFont($fontbold, '',  12);
        PDF::MultiCell(185, 25, (isset($data[0]['checkno']) ? $data[0]['checkno'] : ''), '', 'L', false);
    ...
    public function PDF_DEFAULT_CCVOUCHER_LAYOUT1($data, $params)
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            // }
            PDF::SetFont($font, '', 11);
            PDF::MultiCell(520, 25, $data[$i]['acnoname'], 'TBL', 'L', false, 0);
        ...
        PDF::MultiCell(60, 0, ' ', '', 'L', false, 0);
        PDF::MultiCell(200, 0, 'Checked By: ', '', 'L');
        ...
        PDF::MultiCell(60, 0, ' ', '', 'L', false, 0);
        PDF::MultiCell(200, 0, $approvedby, 'B', 'C', false, 0);
        PDF::MultiCell(60, 0, ' ', '', 'L', false, 0);
        PDF::MultiCell(200, 0, $checkedby, 'B', 'C', false);
        // PDF::MultiCell(30, 0, ' ', '', 'L', false);
    ...
    public function PDF_CV_WTAXREPORT_NEW($data, $params)
    {
        ...
        // (isset($data['head'][0]['payortin']) ? $data['head'][0]['payortin'] : '')
        ...
        //Row 15
        PDF::SetFont($fontbold, '', 11);
        PDF::MultiCell(780, 15, '', 'LR', '', false, 1, 10, 340);
        ...
        //(isset($data['head'][0]['payorcompname']) ? $data['head'][0]['payorcompname'] : '')
        PDF::SetCellPaddings(2, 2, 2, 2);
        PDF::MultiCell(5, 18, '', 'LTB', 'L', false, 0);
        ...
        //(isset($data['head'][0]['payoraddress']) ? $data['head'][0]['payoraddress'] : '')
        //Row 18
        PDF::SetFont($fontbold, '', 11);
        PDF::MultiCell(50, 18, '', 'L', '', false, 0);
        PDF::SetCellPaddings(2, 2, 2, 2);
        ...
        //Row 13
        PDF::MultiCell(780, 20, '', 'LRB', '', false, 1, 10, 425); //  1  1, 10, 425 
        PDF::SetFont($fontbold, '', 11);
        PDF::MultiCell(780, 18, 'Part III - Details of Monthly Income Payments and Taxes Withheld', 'LTRB', 'C', false);

        //Row 14
        PDF::MultiCell(200, 20, '', 'LTR', 'C', false, 0, 10, 463); //457 470
        PDF::MultiCell(80, 20, '', 'LTR', 'C', false, 0, 210, 463); //457
        PDF::MultiCell(380, 20, 'AMOUNT OF INCOME PAYMENTS', 'LTR', 'C', false, 0, 290, 463);
        PDF::MultiCell(120, 20, '', 'LTR', 'C', false, 1, 670, 463);
        ...
        //Row 21
        PDF::MultiCell(5, 10, '', 'TL', '', false, 0);
        PDF::MultiCell(195, 10, 'Money Payments Subjects to', 'TR', '', false, 0);
        PDF::MultiCell(80, 10, '', 'TLR', '', false, 0);
        PDF::MultiCell(95, 10, '', 'TLR', '', false, 0);
        PDF::MultiCell(95, 10, '', 'TLR', '', false, 0);
        PDF::MultiCell(95, 10, '', 'TLR', '', false, 0);
        ...
        PDF::MultiCell(195, 10, 'Withholding of Business Tax', 'R', '', false, 0);
        PDF::MultiCell(80, 10, '', 'LR', '', false, 0);
        PDF::MultiCell(95, 10, '', 'LR', '', false, 0);
        PDF::MultiCell(95, 10, '', 'LR', '', false, 0);
        PDF::MultiCell(95, 10, '', 'LR', '', false, 0);
        ...
        PDF::MultiCell(5, 10, '', 'L', '', false, 0);
        PDF::MultiCell(195, 10, '(Government & Private)', 'R', '', false, 0);
        PDF::MultiCell(80, 10, '', 'LR', '', false, 0);
        PDF::MultiCell(95, 10, '', 'LR', '', false, 0);
        PDF::MultiCell(95, 10, '', 'LR', '', false, 0);
        PDF::MultiCell(95, 10, '', 'LR', '', false, 0);
        ...
        PDF::SetFont($fontbold, '', 12);
        PDF::MultiCell(50, 30, '', 'LTB', 'L', false, 0, '', '', true, 0, false, true, 0, 'B', true);
        PDF::MultiCell(227, 30, $payor, 'TB', 'L', false, 0, '', '', true, 0, false, true, 0, 'B', true);
        PDF::MultiCell(226, 30, $tin, 'TB', 'C', false, 0, '', '', true, 0, false, true, 0, 'B', true);
        PDF::MultiCell(227, 30, $position, 'TB', 'R', false, 0, '', '', true, 0, false, true, 0, 'B', true);
        PDF::MultiCell(50, 30, '', 'TBR', 'L', false, 1, '', '', true, 0, false, true, 0, 'B', true);
    ...
    public function rpt_default_header_ccvoucher($data, $filters)
    {
        ...
        $str .= $this->reporter->begintable('800');
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col('ACCOUNTS PAYABLE VOUCHER', '800', null, false, '', '', 'L', 'Century Gothic', '18', 'B', '', '') . '<br />';
        $str .= $this->reporter->endrow();
        $str .= $this->reporter->endtable();
        ...
        $str .= $this->reporter->begintable('800');
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col('', '500', null, false, '1px  ', '', 'L', 'Century Gothic', '12', 'B', '30px', '4px');
        $str .= $this->reporter->col('', '100', null, false, '1px  ', 'B', 'L', 'Century Gothic', '12', '', '30px', '4px');
        $str .= $this->reporter->col('DOCNO #: ', '100', null, false, '', '', 'R', 'Century Gothic', '12', 'B', '', '');
        $str .= $this->reporter->col((isset($data[0]['docno']) ? $data[0]['docno'] : ''), '100', null, false, '', '', 'R', 'Century Gothic', '12', '', '', '');
        $str .= $this->reporter->endrow();
        $str .= $this->reporter->endtable();
        ...
        $str .= $this->reporter->begintable('800');
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col('PAID TO :', '500', null, false, '1px  ', '', 'L', 'Century Gothic', '12', 'B', '30px', '4px');
        $str .= $this->reporter->col((isset($data[0]['clientname']) ? $data[0]['clientname'] : ''), '100', null, false, '1px  ', 'B', 'L', 'Century Gothic', '12', '', '30px', '4px');
        $str .= $this->reporter->col('DATE :', '100', null, false, '', '', 'R', 'Century Gothic', '12', 'B', '', '');
        $str .= $this->reporter->col((isset($data[0]['dateid']) ? $data[0]['dateid'] : ''), '100', null, false, '', '', 'R', 'Century Gothic', '12', '', '', '');
        $str .= $this->reporter->endrow();
        $str .= $this->reporter->endtable();

        $str .= $this->reporter->begintable('800');
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col('ADDRESS&nbsp:', '500', null, false, '1px  ', '', 'L', 'Century Gothic', '12', 'B', '30px', '4px');
        $str .= $this->reporter->col((isset($data[0]['address']) ? $data[0]['address'] : ''), '100', null, false, '', '', 'L', 'Century Gothic', '12', '', '30px', '4px');
        $str .= $this->reporter->col('YOURREF&nbsp:', '100', null, false, '', '', 'R', 'Century Gothic', '12', 'B', '', '4px');
        $str .= $this->reporter->col((isset($data[0]['yourref']) ? $data[0]['yourref'] : ''), '100', null, false, '1px  ', 'B', 'R', 'Century Gothic', '12', '', '', '4px');
        $str .= $this->reporter->endrow();
        $str .= $this->reporter->endtable();
        ...
        $str .= $this->reporter->begintable('800');
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col('P A R T I C U L A R S', '500', null, false, '1px solid ', 'LTB', 'C', 'Century Gothic', '12', 'B', '', '3px');
        $str .= $this->reporter->col('', '100', null, false, '1px solid ', 'TB', 'C', 'Century Gothic', '12', 'B', '', '3px');
        $str .= $this->reporter->col('', '100', null, false, '1px solid ', 'TB', 'C', 'Century Gothic', '12', 'B', '', '3px');
        $str .= $this->reporter->col('AMOUNT', '100', null, false, '1px solid ', 'LRTB', 'R', 'Century Gothic', '12', 'B', '', '3px');
        $str .= $this->reporter->endrow();
        $str .= $this->reporter->endtable();
        return $str;
    }
    ...
    public function rpt_DEFAULT_CCVOUCHER_LAYOUT1($data, $filters)
    {
        ...
        $str .= $this->reporter->begintable('800');
        $str .= $this->reporter->startrow();
        $str .= $this->reporter->col($remarks, '500', null, false, '1px solid ', 'LBT', 'L', 'Century Gothic', '11', '', '', '3px');
        $str .= $this->reporter->col('', '100', null, false, '1px solid ', 'BT', 'L', 'Century Gothic', '11', '', '', '3px');
        $str .= $this->reporter->col('', '100', null, false, '1px solid ', 'BT', 'L', 'Century Gothic', '11', '', '', '3px');
        $str .= $this->reporter->col(number_format($totaldb, 2), '100', null, false, '1px solid ', 'LRBT', 'R', 'Century Gothic', '11', 'B', '', '3px');
        $str .= $this->reporter->endrow();
