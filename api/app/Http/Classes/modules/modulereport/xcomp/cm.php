...
class cm
{
  ...
  public function report_default_query($trno)
  {
    ...
    $query = "select head.vattype, head.tax, client.tel, stock.rem as remarks, m.model_name as model,item.sizeid,
      ...
      ag.client as agcode,wh.client as whcode,wh.clientname as whname, stock.line, prj.name as projectname
      from lahead as head
  ...
  public function default_cm_header_PDF($params, $data)
  {
    ...
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(470, 0, (isset($data[0]['agname']) ? $data[0]['agname'] : ''), 'B', 'L', false, 0, '',  '');
    PDF::SetFont($fontbold, '', $fontsize);
    ...
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(620, 00, (isset($data[0]['projectname']) ? $data[0]['projectname'] : ''), 'B', 'L', false, 0, '', '');
