...
class sj
{
  ...
  public function report_default_query($config)
  {
    ...
    whs.client as stockwh,head.clientname as transclient,head.VatType,head.tax, stockinfo.itemdesc as itemdesc
    from lahead as head
  ...
  public function DRP_header_PDF($params, $data)
  {
    ...
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(100, 0, (isset($data[0]['terms']) ? $data[0]['terms'] : ''), '', 'L', false, 0, '480',  '');
    PDF::SetFont($fontbold, '', 11);
  ...
  public function DRP_PDF($params, $data)
  {
      ...
      for ($i = 0; $i < count($data); $i++) {
        ...
        if ($data[$i]['itemname'] == '') {
          ...
          for ($r = 0; $r < $maxrow; $r++) {
            ...
            PDF::SetFont($font, '', $fontsize);
            PDF::MultiCell(80, 0, $qty, '', 'R', false, 0, '2', '', true, 1);

            PDF::MultiCell(100, 0, $uom, '', 'C', false, 0, '60', '', false, 1);
            PDF::MultiCell(230, 0, isset($itemname[$r]) ? $itemname[$r] : '', '', 'L', false, 0, '', '', false, 1);
    ...
    PDF::MultiCell(120, 0, number_format($totalext, 2), '', 'C', false, 0, '', '', true, 1);
  ...
  public function CSI_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(400, 0, (isset($data[0]['transclient']) ? $data[0]['transclient'] : ''), '', 'L', false, 0, '90',  '80');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(60, 0, (isset($data[0]['tin']) ? $data[0]['tin'] : ''), '', 'L', false, 0, '400',  '');
    PDF::SetFont($fontbold, '', 11);
  ...
  public function CSI_PDF($params, $data)
  {
    ...
    if ($data[0]['tax'] == 12) {
      ...
      PDF::MultiCell(350, 0, number_format($lessvat, 2), '', 'R', false, 0, '110',  '');
      PDF::MultiCell(0, 0, "\n");
      PDF::MultiCell(100, 0, number_format($nvat, 2), '', 'R', false, 0, '110',  '');
      PDF::MultiCell(350, 0, number_format($amtofnvat, 2), '', 'R', false, 0, '110',  '');
      PDF::MultiCell(0, 0, "\n");
      PDF::MultiCell(100, 0, number_format($vatex, 2), '', 'R', false, 0, '110',  '');
      PDF::MultiCell(350, 0, '', '', 'R', false, 0, '110',  '');
      PDF::MultiCell(0, 0, "\n");
      PDF::MultiCell(350, 0, number_format($amtdue, 2), '', 'R', false, 0, '110',  '');
      PDF::MultiCell(0, 0, "\n");
      PDF::MultiCell(100, 0, number_format($vatamt, 2), '', 'R', false, 0, '110',  '');
      PDF::MultiCell(350, 0, number_format($addvat, 2), '', 'R', false, 0, '110',  '');
      PDF::MultiCell(0, 0, "\n");
      PDF::MultiCell(350, 0, number_format($totalext, 2), '', 'R', false, 0, '110',  '');
      PDF::MultiCell(0, 0, "\n");
      PDF::MultiCell(350, 0, number_format($totalext, 2), '', 'L', false, 1, '320',  '435');
    } else {
      PDF::MultiCell(0, 0, "\n\n\n\n\n\n");
      // PDF::MultiCell(350, 0, number_format($totalext,2), '', 'R', false, 0,'110',  '');
      PDF::MultiCell(0, 0, "\n");
      ...
      // PDF::MultiCell(0, 0, "\n\n");
      // PDF::MultiCell(350, 0, number_format($totalext,2), '', 'L', false, 1,'600',  '');

    }
    PDF::MultiCell(0, 0, "\n\n\n\n\n\n");
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(80, 0, $params['params']['dataparams']['prepared'], '', 'L', false, 0, '80',  '');
    // PDF::MultiCell(80, 0, $params['params']['dataparams']['received'], '', 'L', false, 0,'',  '');
  ...
  public function DR_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(0, 0, $reporttimestamp, '', 'L', false, 1, '', '', true, 0, true);
    ...
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(320, 0, (isset($data[0]['agname']) ? $data[0]['agname'] : ''), 'B', 'L', false, 0, '',  '');
    PDF::SetFont($fontbold, '', $fontsize);
  ...
  public function DR_PDF($params, $data)
  {
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        $arr_itemdesc = $this->reporter->fixcolumn([$itemdesc], '35', 0);
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::MultiCell(220, 15, ' ' . (isset($arr_itemdesc[$r]) ? $arr_itemdesc[$r] : ''), '', 'L', false, 0, '',  '', true, 0, true, true, 0, 'M', false);
