...
namespace App\Http\Classes\modules\modulereport\excelin;
...
class sj
{
  ...
  public function reportplotting($params, $data)
  {
    if ($params['params']['dataparams']['print'] == "default") {
      ...
      return $this->sjlayout($params, $data);
    }
  }

  public function sjlayout($params, $data)
  {
    $printtr = true;
    $msg = '';
    if (!empty($data)) {
      foreach ($data as $res) {
        if ($res['limitcheck'] != 0) {
          ...
          if ($res['limitcheck'] == 1) {
            $msg = ' Some item amounts are below the default last price limit.';
          }
          if ($res['limitcheck'] == 2) {
            $msg = ' Some item costs are below the default cost.';
          }
    ...
    if ($printtr) {
      ...
      return $this->layout2($params, $data, $msg);
    }
  }
  ...
  public function layout2($params, $data, $msg)
  {
    $font = "";
    $fontbold = "";
    $fontsize = "11";
    ...
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(500, 0, $msg, '', 'L', false);
    PDF::SetFont($font, '', 5);
