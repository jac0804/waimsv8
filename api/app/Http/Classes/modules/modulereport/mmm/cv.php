...
class cv
{
  ...
  public function report_default_query($filters)
  {
    ...
    switch ($filters['params']['dataparams']['reporttype']) {
      ...
      default:
        ...
        detail.checkno, left(coa.alias,2) as alias, head2.yourref as invoiceno, emp.clientname as empname
  ...
  public function PDF_default_header($params, $data)
  {
    ...
    PDF::Image('public/images/mmm/3m.png', '40', '50', 180, 50, '', '', 'M', false, 300, 'M', false, false, 0, true, false, false);
    ...
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(120, 5, (isset($data[0]['dateid']) ? $data[0]['dateid'] : ''), '', 'L', false);
    ...
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(85, 5, 'EMPLOYEE : ', '', 'R', false, 0);
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(120, 5, (isset($data[0]['empname']) ? $data[0]['empname'] : ''), 'B', 'L', false);
  ...
  public function PDF_DEFAULT_CCVOUCHER_LAYOUT2($data, $params)
  {
    ...
    left join coa on coa.acnoid = detail.acnoid
    where trno = " . $data[0]['trno'] . " and coa.alias = 'PC3' 
    group by 
