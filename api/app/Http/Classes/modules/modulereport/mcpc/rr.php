...
class rr
{
    ...
    {
        return $this->default_RR_PDF($config, $data);
    }
    public function default_RR_header_PDF($params, $data)
    {
        ...
        PDF::SetFont($fontbold, '', $fontsize);
        PDF::MultiCell(90, 20, "Supplier : ", '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
        ...
        PDF::SetFont($fontbold, '', $fontsize);
        PDF::MultiCell(90, 20, "Address : ", '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
        PDF::SetFont($font, '', $fontsize);
        ...
        PDF::MultiCell(115, 0, "BARCODE", '', 'C', false, 0);
    ...
    public function default_RR_PDF($params, $data)
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            $arr_disc = $this->reporter->fixcolumn([$disc], '8', 0);
            ...
            for ($r = 0; $r < $maxrow; $r++) {
                ...
                PDF::SetFont($font, '', $fontsize);
                PDF::MultiCell(115, 15, ' ' . (isset($arr_barcode[$r]) ? $arr_barcode[$r] : ''), '', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
                PDF::MultiCell(50, 15, ' ' . $printqty, '', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
                ...
                PDF::MultiCell(75, 15, ' ' . $printamt, '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
                PDF::MultiCell(65, 15, ' ' . (isset($arr_disc[$r]) ? $arr_disc[$r] : ''), '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
                PDF::MultiCell(75, 15, ' ' . $printext, '', 'R', false, 1, '',  '', true, 0, false, true, 0, 'M', false);
            }
        ...
        PDF::MultiCell(670, 0, $data[0]['rem'], '', 'L', false, 1);
        PDF::MultiCell(0, 0, "\n\n\n");
