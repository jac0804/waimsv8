...
public function report_default_query($trno){
  ...
  public function reportplotting($params,$data){
   ...
   return $this->vitaline_DM_PDF($params, $data);
  }
  ...
  public function vitaline_DM_header_PDF($params, $data)
  {
    $center = $params['params']['center'];
    $username = $params['params']['user'];
  ...
  public function vitaline_DM_PDF($params, $data)
  {
    ...
    $this->vitaline_DM_header_PDF($params, $data);
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        for($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::MultiCell(300, 0, (isset($arr_itemname[$r]) ? $arr_itemname[$r] : ''), '', 'L', false, 0, '', '', false, 1);
