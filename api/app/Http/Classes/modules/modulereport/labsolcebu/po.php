...
class po
{
  ...
  public function report_default_query($trno)
  {
    ...
    item.itemname, stock.rrqty as qty, stock.uom, stock.rrcost as netamt, stock.disc, stock.ext,m.model_name as model,item.sizeid,stock.rem as srem
  ...
  public function reportplotting($params, $data)
  {
    ...
    return $this->vitaline_PO_PDF($params, $data);
  }
  ...
  public function title_header($params)
  {
    ...
    $str .= $this->reporter->col('NOTES', '100', null, false, $border, 'B', 'C', $font, '12', 'B', '30px', '8px');
  ...
  public function default_PO_LAYOUT($params, $data)
  {
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      $str .= $this->reporter->col($data[$i]['srem'], '100', null, false, $border, '', 'L', $font, $fontsize, '', '', '2px');
  ...
  public function vitaline_PO_header_PDF($params, $data)
  {
    $center = $params['params']['center'];
    $username = $params['params']['user'];
    ...
    PDF::MultiCell(80, 0, "UNIT PRICE", '', 'C', false, 0);
  ...
  public function vitaline_PO_PDF($params, $data)
  {
    ...
    $this->vitaline_PO_header_PDF($params, $data);
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        $arr_rem = $this->reporter->fixcolumn([$srem], '25', 0);

        $maxrow = $this->othersClass->getmaxcolumn([$arr_barcode, $arr_itemname, $arr_qty, $arr_uom, $arr_netamt, $arr_disc, $arr_ext,$arr_rem]);
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::MultiCell(170, 0, (isset($arr_itemname[$r]) ? $arr_itemname[$r] : ''), '', 'L', 0, 0, '', '', true, 0, true, false);
          PDF::MultiCell(90, 0, (isset($arr_rem[$r]) ? $arr_rem[$r] : ''), '', 'L', 0, 0, '', '', true, 0, true, false);
          PDF::MultiCell(80, 0, (isset($arr_netamt[$r]) ? $arr_netamt[$r] : ''), '', 'R', 0, 0, '', '', true, 0, true, false);
          PDF::MultiCell(80, 0, (isset($arr_disc[$r]) ? $arr_disc[$r] : ''), '', 'C', 0, 0, '', '', true, 0, true, false);
