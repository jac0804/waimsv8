...
class ts
{
    ...
    public function default_TS_header_PDF($params, $data)
    {
        ...
        PDF::MultiCell(100, 0, "LOT/SERIAL #", '', 'C', false, 0);
    ...
    public function default_TS_PDF($params, $data)
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            $maxrow = $this->othersClass->getmaxcolumn([
                $arr_barcode, $arr_itemname, $arr_qty, $arr_uom,
                $arr_amt, $arr_disc, $arr_ext, $arr_expiry, $arr_loc
            ]);
            ...
            for ($r = 0; $r < $maxrow; $r++) {
                ...
                PDF::MultiCell(100, 15, ' ' . (isset($arr_loc[$r]) ? $arr_loc[$r] : ''), '', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
                PDF::MultiCell(80, 15, ' ' . (isset($arr_expiry[$r]) ? $arr_expiry[$r] : ''), '', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
                if ($viewcost == '1') {
        ...
        PDF::SetFont($fontbold, '', $fontsize);
        PDF::MultiCell(610, 15, 'GRAND TOTAL: ', '', 'R', false, 0);
        PDF::MultiCell(90, 15, number_format($totalext, $decimalcurr), '', 'R', false);
