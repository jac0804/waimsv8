...
class po
{
  ...
  {
    $query = "select date_format(head.dateid,'%Y-%m-%d') as dateid, head.docno, client.client, client.clientname, head.address,
        ...
        union all
        select date_format(head.dateid,'%Y-%m-%d') as dateid, head.docno, client.client, client.clientname,
