...
class pq
{
  ...
  public function report_default_query($config){
    ...
    $query = "
      ...
      detail.amt,  detail.client as dclient
      ...
      coa.acno, coa.acnoname, detail.ref, 
      date(detail.postdate) as postdate, 
      detail.amt, dclient.client as dclient
  ...
  public function default_PQ_PDF($params, $data)
  {
    ...
    if (!empty($data)) {
      ...
      for ($i = 0; $i < count($data); $i++) {
        ...
        $arr_remarks = $this->reporter->fixcolumn([$remarks], '13', 0);
        

        $maxrow = $this->othersClass->getmaxcolumn([$arr_acno, $arr_acnonamedescs, $arr_postdate, $arr_amt, $arr_remarks]);
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::MultiCell(150, 15, ' ' . (isset($arr_remarks[$r]) ? $arr_remarks[$r] : ''), '', 'L', false, 1, '',  '', true, 0, false, true, 0, 'M', false);
    ...
    PDF::MultiCell(100, 0, number_format($totalamt, $decimalprice), '', 'R');
