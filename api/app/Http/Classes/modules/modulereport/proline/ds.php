...
class ds
{
  ...
  public function report_default_query($filters)
  {
    ...
    detail.cr, detail.line,coa.alias,hc.acnoname as contraname
    from ((lahead as head 
  ...
  public function default_DS_header_PDF($params, $data)
  {
    ...
    $ii = 0;
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(350, 0, $data[0]['contraname'], '', 'L', 0, 1, '', '');
    ...
    PDF::MultiCell(120, 0, "REFERENCE #", '', 'L', false, 0);
  ...
  public function default_DS_PDF($params, $data)
  {
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::MultiCell(120, 15, ' ' . (isset($arr_ref[$r]) ? $arr_ref[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
    ...
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(470, 0, 'GRAND TOTAL: ', '', 'R', false, 0);
