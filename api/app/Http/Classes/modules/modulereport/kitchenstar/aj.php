...
class aj
{
  ...
  public function report_default_query($filters)
  {
    ...
    $query = "
    select head.vattype, head.tax, stock.rem as remarks, item.color, 
  ...
  private function rpt_default_header($data, $filters)
  {
    ...
    $viewcost = $this->othersClass->checkAccess($filters['params']['user'], 368);
  ...
  public function default_aj_layout($filters, $data)
  {
    ...
    if($viewcost == 1){
        ...
        $str .= $this->reporter->col('', '120px', null, false, '1px dotted ', 'T', 'R', 'Century Gothic', '12', 'B', '', '');
        $str .= $this->reporter->col('', '125px', null, false, '1px dotted ', 'T', 'R', 'Century Gothic', '12', 'B', '', '');
    }
  ...
  public function default_AJ_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(250, 0, "D E S C R P T I O N", '', 'L', false, 0);
    if($viewcost =='1'){
