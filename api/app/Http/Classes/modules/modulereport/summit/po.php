...
class po
{
  ...
  {
    $fields = ['radioprint', 'radiotitleheader', 'prepared', 'approved', 'received'];
  ...
  public function default_header($params, $data)
  {
    ...
    $headeropt = $params['params']['dataparams']['radiotitleheader'];
    if ($headeropt == 0) {
      $header = 'Rod and Staff Agriventures Inc.';
    } else {
      $header = 'Summit Infinity Agricultural Farm Corporation';
    }
    ...
    $str .=  $this->reporter->col($username . ' - ' . date_format(date_create($current_timestamp), 'm/d/Y H:i:s') . '&nbsp;&nbsp;' . strtoupper($headerdata[0]->name), '600', null, false, '1px solid ', '', 'L', 'Century Gothic', '13', '', '', '');
    $str .= $this->reporter->endrow();
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col($header, '120', null, false, $border, '', 'C', $font, '18', 'B', '', '');
    $str .= $this->reporter->endrow();
  ...
  public function title_header($params)
  {
    ...
    $str .= $this->reporter->col('QTY', '150', null, false, $border, 'B', 'C', $font, '12', 'B', '30px', '8px');
    $str .= $this->reporter->col('UNIT', '50', null, false, $border, 'B', 'C', $font, '12', 'B', '30px', '8px');
    $str .= $this->reporter->col('D E S C R I P T I O N', '400', null, false, $border, 'B', 'C', $font, '12', 'B', '30px', '8px');
  ...
  public function default_po_layout($params, $data)
  {
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      $str .= $this->reporter->col(number_format($data[$i]['qty'], $this->companysetup->getdecimal('qty', $params['params'])), '150', null, false, $border, '', 'C', $font, $fontsize, '', '', '2px');
  ...
  public function default_PO_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(720, 0, $header, '', 'C', false, 0, '', '40');
    ...
    PDF::MultiCell(70, 0, "UNIT", '', 'L', false, 0);
