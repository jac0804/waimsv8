...
class pk
{
  ...
  private $modulename = "Production Return";
  ...
  public function report_default_query($config)
  {
    ...
    $query = "select stock.line,stock.rem as srem,head.rem,date_format(head.dateid,'%m/%d') as monthid,
            ...
            wh.client as whcode, wh.clientname as whname,coa.acno,coa.acnoname,proj.code as projcode,proj.name as projname
            from lahead as head
            ...
            where head.doc='PK' and head.trno='$trno'
            UNION ALL
            ...
            left join coa on coa.acno=head.contra
            left join projectmasterfile as proj on proj.line=head.projectid
            where head.doc='PK' and head.trno='$trno' order by line";
  ...
  public function default_header_PDF($params, $data)
  {
    ...
    PDF::SetFont($fontbold, '', 18);
    PDF::MultiCell(480, 20, "", '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::SetFont($fontbold, '', $fontsize);
    ...
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(80, 20, "Department : ", '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(410, 20, (isset($data[0]['client']) ? $data[0]['client'] : ''), 'B', 'L', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(90, 20, "Date : ", '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::SetFont($font, '', $fontsize);
    ...
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(410, 20, (isset($data[0]['whcode']) ? $data[0]['whcode'].'~'.$data[0]['whname'] : ''), 'B', 'L', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(90, 20, "AP Account : ", '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(120, 20, (isset($data[0]['acno']) ? $data[0]['acno'].'~'.$data[0]['acnoname'] : ''), 'B', 'L', false, 1, '', '', true, 0, false, true, 0, 'B', true);

    // PDF::MultiCell(0, 0, "\n");

    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(80, 20, "Name : ", '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(410, 20, (isset($data[0]['clientname']) ? $data[0]['clientname'] : ''), 'B', 'L', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(90, 20, "Terms : ", '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::SetFont($font, '', $fontsize);
    ...
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(410, 20, (isset($data[0]['yourref']) ? $data[0]['yourref'] : ''), 'B', 'L', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(90, 20, "Project : ", '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(120, 20,  (isset($data[0]['projcode']) ? $data[0]['projcode'].'~'.$data[0]['projname'] : ''), 'B', 'L', false, 1, '',  '', true, 0, false, true, 0, 'B', true);

    
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(80, 20, "Ourref : ", '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(410, 20, (isset($data[0]['ourref']) ? $data[0]['ourref'] : ''), 'B', 'L', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(90, 20, "", '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(120, 20,  '', 'B', 'L', false, 1, '',  '', true, 0, false, true, 0, 'B', true);
