...
class cr
{
    ...
    public function report_default_query($filters)
    {
        ...
        $query = "select head.trno, date(head.dateid) as dateid, head.docno, head.clientname, head.address, head.yourref,head.ourref, left(coa.alias, 2) as alias, coa.acno, coa.acnoname, coa.alias as ali,
                    client.client, detail.ref, date(detail.postdate) as postdate, detail.checkno, 
                    detail.db, detail.cr, detail.line,proj.code as projcode,proj.name as projname
                    from ((lahead as head 
    ...
    public function default_CR_header_PDF($params, $data)
    {
        ...
        PDF::MultiCell(535, 0, $this->modulename, '', 'L', false, 0, '',  '65');
        ...
        PDF::MultiCell(485, 0, '', '', 'L', false, 0, '',  '');
        PDF::MultiCell(50, 40, (isset($data[0]['projname']) ? $data[0]['projname'] : ''), '', 'L', false, 0, '',  '');
