...
class cr
{
  ...
  public function report_default_query($filters)
  {
    ...
    client.client, detail.ref, date(detail.postdate) as postdate, detail.checkno, detail.db, detail.cr, detail.line,detail.sortline
    from ((lahead as head 
    ...
    where head.doc='cr' and head.trno='$trno' order by sortline,line";
