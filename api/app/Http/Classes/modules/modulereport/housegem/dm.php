...
class dm
{
  ...
  item.itemname, stock.isqty as qty, stock.uom, stock.isamt as amt, stock.disc, stock.ext,stock.ref,date(stock.expiry) as expiry,stock.line,stock.sortline
  from lahead as head
  ...
  left join item on item.itemid=stock.itemid
  left join model_masterfile as m on m.model_id = item.model
  where head.doc='dm' and head.trno ='$trno' order by sortline,line";
