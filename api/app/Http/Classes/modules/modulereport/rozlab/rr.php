...
class rr
{
  ...
  {
    $fields = ['radioprint', 'radioreporttype', 'prepared', 'approved', 'audited', 'print'];
    $col1 = $this->fieldClass->create($fields);
    data_set($col1, 'radioprint.options', [
      ['label' => 'PDF', 'value' => 'PDFM', 'color' => 'red']
    ]);
    data_set($col1, 'radioreporttype.options', [
      ['label' => 'RR', 'value' => 'RR', 'color' => 'red'],
      ['label' => 'AP Invoice', 'value' => 'AP', 'color' => 'red']
    ]);
  ...
  public function report_default_query($config)
  {
    ...
    $query = "select head.docno,head.trno, head.clientname, head.address, date(head.dateid) as dateid, head.terms, head.rem,
        ...
        stock.uom, stock.disc, stock.ext, stock.line,wh.client as wh,wh.clientname as whname,stock.loc,stock.expiry,
        stock.rem as srem,item.sizeid,m.model_name as model,head.ourref,head.yourref
        from lahead as head
        ...
        item.barcode, item.itemname, stock.rrcost as gross, stock.cost as netamt, stock.rrqty as qty,
        stock.uom, stock.disc, stock.ext, stock.line,wh.client as wh,wh.clientname as whname,stock.loc,stock.expiry,stock.rem as srem,item.sizeid,m.model_name as model,head.ourref,head.yourref
        from (glhead as head
  ...
  public function report_detail_query($config)
  {
    ...
    where head.doc='RR' and head.trno='$trno'
    union all
  ...
  public function reportplotting($params, $data)
  {
    ...
    if ($params['params']['dataparams']['print'] == "default") {
      ...
      switch ($params['params']['dataparams']['reporttype']) {
        ...
        case 'AP':
          return $this->AP_Invoice_PDF($params, $data);
          break;
      }
    }
  }

  public function AP_Invoice_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(520, 0, 'A/P Invoice', '', 'L', false, 0);
    PDF::SetFont($fontbold, '', $fontsize);
    ...
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(80, 20, "Ourref : ", '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::SetFont($font, '', $fontsize);
    ...
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(120, 20, (isset($data[0]['yourref']) ? $data[0]['yourref'] : ''), 'B', 'L', false, 1, '',  '', true, 0, false, true, 0, 'B', true);
    ...
    PDF::MultiCell(60, 0, "LOT NO", '', 'L', false, 0);
  ...
  public function AP_Invoice_detail_Header_PDF($params, $data)
  {
    $center = $params['params']['center'];
    $username = $params['params']['user'];
    //$width = 800; $height = 1000;
    ...
    PDF::MultiCell(250, 0, "Acct Desc", '', 'C', false, 0);
    PDF::MultiCell(150, 0, "", '', 'C', false, 0);
    PDF::MultiCell(110, 0, "Debit", '', 'C', false, 0);
    PDF::MultiCell(110, 0, "Credit", '', 'C', false);
  ...
  public function AP_Invoice_PDF($params, $data)
  {
    ...
    $this->AP_Invoice_header_PDF($params, $data);
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      $maxrow = $this->othersClass->getmaxcolumn([$arr_barcode, $arr_itemname, $arr_loc,  $arr_expiry, $arr_qty, $arr_uom, $arr_amt, $arr_disc, $arr_ext]);
      for ($r = 0; $r < $maxrow; $r++) {
    ...
    if ($detailresult[0]['line'] != null) {
      ...
      $this->AP_Invoice_detail_Header_PDF($params, $data);
      ...
      for ($i = 0; $i < count($detailresult); $i++) {
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::SetFont($font, '', $fontsize);
          PDF::MultiCell(100, 15, ' ' . (isset($arr_acno[$r]) ? $arr_acno[$r] : ''), '', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          PDF::MultiCell(250, 15, ' ' . (isset($arr_acnoname[$r]) ? $arr_acnoname[$r] : ''), '', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
    ...
    PDF::MultiCell(253, 0, 'Audited By: ', '', 'L');

    PDF::MultiCell(0, 0, "\n");

    PDF::MultiCell(253, 0, $params['params']['dataparams']['prepared'], '', 'L', false, 0);
    PDF::MultiCell(253, 0, $params['params']['dataparams']['approved'], '', 'L', false, 0);
    PDF::MultiCell(253, 0, $params['params']['dataparams']['audited'], '', 'L');
  ...
  public function default_RR_header_PDF($params, $data)
  {
    ...
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(80, 20, "Yourref : ", '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(80, 20, (isset($data[0]['yourref']) ? $data[0]['yourref'] : ''), 'B', 'L', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::MultiCell(390, 20, '', '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::SetFont($fontbold, '', $fontsize);
