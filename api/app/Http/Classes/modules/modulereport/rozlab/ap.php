...
class ap
{
  ...
  {
    $fields = ['radioprint', 'prepared', 'audited', 'received', 'print'];
  ...
  public function default_ap_layout($params, $data)
  {
    ...
    $str .= $this->reporter->col('Audited By :', '266', null, false, '1px solid ', '', 'C', 'Century Gothic', '12', '', '', '');
    ...
    $str .= $this->reporter->col($params['params']['dataparams']["audited"], '266', null, false, '1px solid ', '', 'C', 'Century Gothic', '12', 'B', '', '');
  ...
  public function default_AP_header_PDF($params, $data)
  {
    ...
    PDF::SetSubject($this->modulename . ' AP Setup Print');
    PDF::setPageUnit('px');
  ...
  public function default_AP_PDF($params, $data)
  {
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      $arr_acnoname = $this->reporter->fixcolumn([$acnoname], '34', 0);
      ...
      for ($r = 0; $r < $maxrow; $r++) {
        ...
        PDF::MultiCell(200, 15, ' ' . (isset($arr_acnoname[$r]) ? $arr_acnoname[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
        PDF::MultiCell(100, 15, ' ' . (isset($arr_ref[$r]) ? $arr_ref[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
        PDF::MultiCell(70, 15, ' ' . (isset($arr_postdate[$r]) ? $arr_postdate[$r] : ''), '', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
        PDF::MultiCell(75, 15, ' ' . (isset($arr_db[$r]) ? $arr_db[$r] : ''), '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
        PDF::MultiCell(75, 15, ' ' . (isset($arr_cr[$r]) ? $arr_cr[$r] : ''), '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
    ...
    PDF::MultiCell(253, 0, 'Audited By: ', '', 'L', false, 0);
    PDF::MultiCell(253, 0, 'Received By: ', '', 'L');

    PDF::MultiCell(0, 0, "\n");

    PDF::MultiCell(253, 0, $params['params']['dataparams']['prepared'], '', 'L', false, 0);
    PDF::MultiCell(253, 0, $params['params']['dataparams']['audited'], '', 'L', false, 0);
