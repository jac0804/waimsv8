...
class sj
{
  ...
  public function report_default_query($config)
  {
    ...
    wh.client as whcode, wh.clientname as whname,client.bstyle,head.tax,head.vattype
    from lahead as head
  ...
  public function default_SI_PDF($params, $data)
  {
    ...
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(200, 0, (isset($data[0]['docno']) ? $data[0]['docno'] : ''), '', 'L', false, 1, '620',  '70', true, 0, false, true, 0, 'B', true);

    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(550, 0, (isset($data[0]['clientname']) ? $data[0]['client'] . ' ' . $data[0]['clientname'] : ''), '', 'L', false, 0, '70',  '', true, 0, false, true, 0, 'B', true);
    $date = date_create(isset($data[0]['dateid']) ? $data[0]['dateid'] : '');
    $date = date_format($date, "F j, Y");
    PDF::MultiCell(170, 0, $date, '', 'L', false, 1, '',  '', true, 0, false, true, 0, 'B', true);


    PDF::MultiCell(550, 0, (isset($data[0]['address']) ? $data[0]['address'] : ''), '', 'L', false, 0, '70',  '', true, 0, false, true, 0, 'B', true);
    PDF::MultiCell(170, 0, (isset($data[0]['terms']) ? $data[0]['terms'] : ''), '', 'L', false, 1, '',  '', true, 0, false, true, 0, 'B', true);


    PDF::MultiCell(550, 0, (isset($data[0]['tin']) ? $data[0]['tin'] : ''), '', 'L', false, 0, '70',  '', true, 0, false, true, 0, 'B', true);
    PDF::MultiCell(170, 0, (isset($data[0]['yourref']) ? $data[0]['yourref'] : ''), '', 'L', false, 1, '',  '', true, 0, false, true, 0, 'B', true);


    PDF::MultiCell(550, 0, (isset($data[0]['bstyle']) ? $data[0]['bstyle'] : ''), '', 'L', false, 0, '70',  '', true, 0, false, true, 0, 'B', true);
    PDF::MultiCell(170, 0, (isset($data[0]['agent']) ? $data[0]['agent'] : ''), '', 'L', false, 1, '',  '', true, 0, false, true, 0, 'B', true);
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        $barcode = $data[$i]['barcode'];
        $itemname = $barcode . ' - ' . $data[$i]['itemname'];
        $qty = number_format($data[$i]['qty'], 2);
        $uom = $data[$i]['uom'];
        $amt = number_format($data[$i]['amt'], 2);
        $disc = $data[$i]['disc'];
    ...
    PDF::MultiCell(150, 0, ' ' . number_format($amountnetofvat, 2), '', 'R', false, 1, '380',  '860', true, 0, false, true, 0, 'M', false);
    PDF::MultiCell(150, 0, ' ' . number_format($vatexemptsales, 2), '', 'R', false, 1, '380',  '875', true, 0, false, true, 0, 'M', false);
    PDF::MultiCell(150, 0, ' ' . number_format($zeroratedsales, 2), '', 'R', false, 1, '380',  '890', true, 0, false, true, 0, 'M', false);
    PDF::MultiCell(150, 0, ' ' . number_format($lessvat, 2), '', 'R', false, 1, '380',  '905', true, 0, false, true, 0, 'M', false);
    PDF::MultiCell(150, 0, ' ' . number_format($totalamountdue, 2), '', 'R', false, 1, '380',  '920', true, 0, false, true, 0, 'M', false);

    PDF::MultiCell(150, 0, ' ' . number_format($lessvat, 2), '', 'R', false, 1, '600',  '860', true, 0, false, true, 0, 'M', false);
    PDF::MultiCell(150, 0, ' ' . number_format($amountnetofvat, 2), '', 'R', false, 1, '600',  '875', true, 0, false, true, 0, 'M', false);
    PDF::MultiCell(150, 0, ' ' . number_format($lessscpwddisc, 2), '', 'R', false, 1, '600',  '890', true, 0, false, true, 0, 'M', false);
    PDF::MultiCell(150, 0, ' ' . number_format($amountdue, 2), '', 'R', false, 1, '600',  '905', true, 0, false, true, 0, 'M', false);
    PDF::MultiCell(150, 0, ' ' . number_format($addvat, 2), '', 'R', false, 1, '600',  '920', true, 0, false, true, 0, 'M', false);
    PDF::MultiCell(150, 0, ' ' . number_format($totalamountdue, 2), '', 'R', false, 1, '600',  '935', true, 0, false, true, 0, 'M', false);
