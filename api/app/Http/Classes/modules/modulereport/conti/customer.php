...
class customer
{
    ...
    public function reportdefaultAR_PDF($config, $data)
    {
        ...
        foreach ($data as $key => $data) {
            ...
            $arr_docno = $this->reporter->fixcolumn([$data->docno], '16', 0);
            $arr_dateid = $this->reporter->fixcolumn([$data->dateid], '16', 0);
            $arr_agent = $this->reporter->fixcolumn([$data->agent], '16', 0);
            $arr_rem = $this->reporter->fixcolumn([$data->rem], '16', 0);
            ...
            $arr_ref = $this->reporter->fixcolumn([$data->ref], '16', 0);
