...
class gj
{
  ...
  public function report_default_query($filters)
  {
    ...
    detail.db, detail.cr, detail.line
    from ((lahead as head 
  ...
  private function rpt_gj_header_default($config, $result)
  {
    ...
    $str .= $this->reporter->begintable('800');
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('CUSTOMER/SUPPLIER: ', '100', null, false, '1px solid ', '', 'L', 'Century Gothic', '12', 'B', '30px', '4px');
    $str .= $this->reporter->col((isset($result[0]->clientname) ? $result[0]->clientname : ''), '500', null, false, '1px solid ', 'B', 'L', 'Century Gothic', '12', '', '30px', '4px');
    $str .= $this->reporter->col('DATE : ', '40', null, false, '1px solid ', '', 'R', 'Century Gothic', '12', 'B', '', '');
    $str .= $this->reporter->col((isset($result[0]->dateid) ? $result[0]->dateid : ''), '160', null, false, '1px solid ', 'B', 'R', 'Century Gothic', '12', '', '', '');
    $str .= $this->reporter->endrow();
    $str .= $this->reporter->endtable();
    $str .= $this->reporter->begintable('800');
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('ADDRESS : ', '100', null, false, '1px solid ', '', 'L', 'Century Gothic', '12', 'B', '30px', '4px');
    $str .= $this->reporter->col((isset($result[0]->address) ? $result[0]->address : ''), '500', null, false, '1px solid ', 'B', 'L', 'Century Gothic', '12', '', '30px', '4px');
    $str .= $this->reporter->col('REF. :', '40', null, false, '1px solid ', '', 'R', 'Century Gothic', '12', 'B', '', '');
    ...
    $str .= $this->reporter->begintable('800');
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('ACCT.#', '75', null, false, '1px solid ', 'B', 'C', 'Century Gothic', '12', 'B', '', '2px');
    $str .= $this->reporter->col('ACCOUNT NAME', '280', null, false, '1px solid ', 'B', 'C', 'Century Gothic', '12', 'B', '', '2px');
    $str .= $this->reporter->col('REFERENCE&nbsp#', '75', null, false, '1px solid ', 'B', 'C', 'Century Gothic', '12', 'B', '', '2px');
    $str .= $this->reporter->col('DATE', '75', null, false, '1px solid ', 'B', 'C', 'Century Gothic', '12', 'B', '', '2px');
    $str .= $this->reporter->col('DEBIT', '100', null, false, '1px solid ', 'B', 'R', 'Century Gothic', '12', 'B', '', '2px');
    $str .= $this->reporter->col('CREDIT', '100', null, false, '1px solid ', 'B', 'R', 'Century Gothic', '12', 'B', '', '2px');
    $str .= $this->reporter->col('', '20', null, false, '1px solid ', 'B', 'R', 'Century Gothic', '12', 'B', '', '2px');
    $str .= $this->reporter->col('CLIENT', '75', null, false, '1px solid ', 'B', 'C', 'Century Gothic', '12', 'B', '', '2px');
    return $str;
  }
  ...
  public function default_gj_layout($config, $result)
  {
    ...
    foreach ($result as $key => $data) {
      ...
      $str .= $this->reporter->col($data->acnoname, '280', null, false, '1px solid ', '', 'L', 'Century Gothic', '11', '', '', '2px');
      ...
      $str .= $this->reporter->col($credit . '0.00', '100', null, false, '1px solid ', '', 'R', 'Century Gothic', '11', '', '', '2px');
    ...
    $str .= $this->reporter->col('', '75', null, false, '1px dotted ', 'T', 'C', 'Century Gothic', '12', 'B', '', '2px');
    $str .= $this->reporter->col('', '75', null, false, '1px dotted ', 'T', 'C', 'Century Gothic', '12', 'B', '', '2px');
    $str .= $this->reporter->col('GRAND TOTAL :', '263', null, false, '1px dotted ', 'T', 'R', 'Century Gothic', '12', 'B', '', '2px');
    ...
    $str .= $this->reporter->col('', '25', null, false, '1px dotted ', 'T', 'R', 'Century Gothic', '11', '', '', '2px');
    $str .= $this->reporter->col('', '92', null, false, '1px dotted ', 'T', 'C', 'Century Gothic', '12', 'B', '', '2px');
    $str .= $this->reporter->endrow();
    $str .= $this->reporter->endtable();
