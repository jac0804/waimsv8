...
public function createreportfilter($config)
  ...
  public function rpt_employee_PDF($config)
  {
    ...
    foreach ($dataeduc as $key => $data1) {
      PDF::SetFont($font, '', 10);
      PDF::MultiCell(220, 15, (isset($data1->school) ? $data1->school : ''), '', 'L', false,0);
      PDF::MultiCell(220, 15, (isset($data1->address) ? $data1->address : ''), '', 'L', false,0); 
      PDF::MultiCell(120, 15, (isset($data1->course) ? $data1->course : ''), '', 'L', false,0);
      PDF::MultiCell(100, 15, (isset($data1->sy) ? $data1->sy : ''), '', 'L', false,0); 
      PDF::MultiCell(100, 15, (isset($data1->honor) ? $data1->honor : ''), '', 'L', false); 
    }
    ...
    foreach ($dataemploy as $key => $data1) {
      PDF::SetFont($font, '', 10);
      PDF::MultiCell(190, 15, (isset($data1->company) ? $data1->company : ''), '', 'L', false,0);
      PDF::MultiCell(130, 15, (isset($data1->jobtitle) ? $data1->jobtitle : ''), '', 'L', false,0); 
      PDF::MultiCell(100, 15, (isset($data1->salary) ? $data1->salary : ''), '', 'R', false,0);
      PDF::MultiCell(20, 15, '', '', 'R', false,0);
      PDF::MultiCell(120, 15, (isset($data1->period) ? $data1->period : ''), '', 'L', false,0); 
      PDF::MultiCell(200, 15, (isset($data1->reason) ? $data1->reason : ''), '', 'L', false); 
    }
