...
class cv
{
  ...
  public function reportparamsdata($config)
  {
    ...
    $prepared = $approved = $received = $checked = $payor = $tin = $position = '';
    foreach ($signatories as $key => $value) {
      switch ($value->fieldname) {
        ...
        case 'checked': $checked = $value->fieldvalue; break;
        case 'payor': $payor = $value->fieldvalue; break;
        case 'tin': $tin = $value->fieldvalue; break;
        case 'position': $position = $value->fieldvalue; break;
      }
    }
  ...
  public function report_default_query($filters)
  {
    ...
    switch ($filters['params']['dataparams']['reporttype']) {
      ...
      default:
        $query = "select a.pdate,a.ref,a.trno,a.docno,a.dateid,a.postdate,a.client,a.clientname,
                            a.address,a.ourref,a.rem,a.acno,a.acnoname,sum(db) as db, sum(cr) as cr,a.checkno,a.alias,a.invoiceno,
                            a.projectid,a.projcode,a.projname,yourref,dyourref from (
                    select ifnull(DATE_FORMAT(cb.checkdate,'%Y-%m-%d'),DATE_FORMAT(head.dateid,'%Y-%m-%d')) as kdate,
                            ifnull(head2.yourref,'') as dyourref,detail.rem as drem,
                            ...
                            detail.projectid,proj.code as projcode,proj.name as projname
                    from ((lahead as head
                    left join ladetail as detail on detail.trno=head.trno)
                    ...
                    group by a.acno,a.acnoname,a.projectid,a.projcode,a.projname,a.pdate,a.trno,a.docno,a.ref,a.yourref,a.dyourref,a.client,a.clientname,
                              a.ourref,a.address,a.rem,a.dateid,a.postdate,a.checkno,
                              a.alias,a.invoiceno
                    order by acnoname,pdate,projcode";
  ...
  public function PDF_default_header($params, $data)
  {
    ...
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(125, 5, (isset($data[0]['dateid']) ? $data[0]['dateid'] : ''), '', 'L', false);
    ...
    PDF::SetFont($fontbold, '', 14);
    PDF::MultiCell(105, 5, 'REFERRENCE # :', '', 'L', false, 0);
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(125, 5, (isset($data[0]['yourref']) ? $data[0]['yourref'] : ''), '', 'L', false);
    ...
    PDF::MultiCell(70, 0, 'ACCT #', '', 'C', false, 0);
    PDF::MultiCell(205, 0, 'ACCOUNT NAME', '', 'C', false, 0);
    PDF::MultiCell(95, 0, 'REF NO', '', 'C', false, 0);
    PDF::MultiCell(50, 0, 'PROJECT', '', 'C', false, 0);
    PDF::MultiCell(75, 0, 'CHECK NO.', '', 'C', false, 0);
    PDF::MultiCell(75, 0, 'DATE', '', 'C', false, 0);
    PDF::MultiCell(75, 0, 'DEBIT', '', 'R', false, 0);
    PDF::MultiCell(75, 0, 'CREDIT', '', 'R', false);
  ...
  public function PDF_DEFAULT_CCVOUCHER_LAYOUT1($data, $params)
  {
    ...
    if (!empty($data)) {
      ...
      for ($i = 0; $i < count($data); $i++) {
        ...
        $arr_project = $this->reporter->fixcolumn([$project], '10', 0);
        $arr_checkno = $this->reporter->fixcolumn([$checkno], '10', 0);
        ...
        $maxrow = $this->othersClass->getmaxcolumn([$arr_acno, $arr_acnonamedescs, $arr_ref, $arr_project, $arr_checkno, $arr_pdate, $arr_debit, $arr_credit]);

        for ($r = 0; $r < $maxrow; $r++) {

          PDF::SetFont($font, '', $fontsize);
          PDF::MultiCell(70, 15, ' ' . (isset($arr_acno[$r]) ? $arr_acno[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          PDF::MultiCell(205, 15, ' ' . (isset($arr_acnonamedescs[$r]) ? $arr_acnonamedescs[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          PDF::MultiCell(95, 15, ' ' . (isset($arr_ref[$r]) ? $arr_ref[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          PDF::MultiCell(50, 15, ' ' . (isset($arr_project[$r]) ? $arr_project[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          PDF::MultiCell(75, 15, ' ' . (isset($arr_checkno[$r]) ? $arr_checkno[$r] : ''), '', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          ...
          PDF::MultiCell(75, 15, ' ' . (isset($arr_credit[$r]) ? $arr_credit[$r] : ''), '', 'R', false, 1, '',  '', true, 0, false, true, 0, 'M', false);
        }
    ...
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(550, 5, 'GRAND TOTAL : ', '', 'C', false, 0);
  ...
  public function PDF_DEFAULT_CCVOUCHER_LAYOUT2($data, $params)
  {
    ...
    for ($i = 0; $i < count($data2); $i++) {
      ...
      $cdate = date_create($data2[$i]['postdate']);
      ...
      PDF::MultiCell(320, 5, $this->ftNumberToWordsConverter($dd) . ' ONLY', '', 'L', false);
  ...
  public function PDF_CV_WTAXREPORT($data, $params)
  {
    ...
    PDF::MultiCell(10, 18, "", '', 'L', false, 0);
    PDF::MultiCell(80, 18, (isset($data['res'][0]['payorzipcode']) ? $data['res'][0]['payorzipcode'] : ''), 'LTRB', 'L', false, 0);
    PDF::MultiCell(10, 18, "", 'R', 'L', false);
  ...
  public function PDF_METROBANK_CHECK_LAYOUT($data, $filters)
  {
    ...
    for ($i = 0; $i < count($data2); $i++) {
      ...
      PDF::MultiCell(440, 0, strtoupper($data[0]['clientname']), '', 'L', false, 0);
      ...
      $dd = number_format((float)$cc, 2, '.', '');
      PDF::MultiCell(720, 0, '***' . $this->ftNumberToWordsConverter($dd) . ' ONLY***', '', 'L', false, 0, '40', '85');
  ...
  public function rpt_default_header($data, $filters)
  {
    ...
    $str .= $this->reporter->col((isset($data[0]['clientname']) ? $data[0]['clientname'] : ''), '520', null, false, '1px solid ', '', 'L', 'Century Gothic', '12', '', '30px', '4px');
    $str .= $this->reporter->col('DATE : ', '100', null, false, '1px solid ', '', 'L', 'Century Gothic', '12', 'B', '', '');
    $str .= $this->reporter->col((isset($data[0]['dateid']) ? $data[0]['dateid'] : ''), '100', null, false, '1px solid ', '', 'R', 'Century Gothic', '12', '', '', '');
    $str .= $this->reporter->endrow();
    $str .= $this->reporter->endtable();
    $str .= $this->reporter->begintable('800');
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('ADDRESS : ', '80', null, false, '1px solid ', '', 'L', 'Century Gothic', '12', 'B', '30px', '4px');
    $str .= $this->reporter->col((isset($data[0]['address']) ? $data[0]['address'] : ''), '520', null, false, '1px solid ', '', 'L', 'Century Gothic', '12', '', '30px', '4px');
    $str .= $this->reporter->col('REFERENCE # :', '100', null, false, '1px solid ', '', 'L', 'Century Gothic', '12', 'B', '', '');
    $str .= $this->reporter->col((isset($data[0]['yourref']) ? $data[0]['yourref'] : ''), '100', null, false, '1px solid ', '', 'R', 'Century Gothic', '12', '', '', '');
    $str .= $this->reporter->endrow();
    $str .= $this->reporter->endtable();
    $str .= $this->reporter->begintable('800');
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('NOTES : ', '80', null, false, '1px solid ', '', 'L', 'Century Gothic', '12', 'B', '30px', '4px');
    $str .= $this->reporter->col((isset($data[0]['rem']) ? $data[0]['rem'] : ''), '720', null, false, '1px solid ', '', 'L', 'Century Gothic', '12', '', '30px', '4px');
    $str .= $this->reporter->endrow();
    $str .= $this->reporter->endtable();
  ...
  public function rpt_default_header_layout1($data, $filters)
  {
    $companyid = $filters['params']['companyid'];
    $decimal = $this->companysetup->getdecimal('currency', $filters['params']);
    ...
    $str .= $this->reporter->col('ACCT.#', '75', null, false, '1px solid ', 'B', 'C', 'Century Gothic', '12', 'B', '30px', '8px');
    $str .= $this->reporter->col('ACCOUNT NAME', '200', null, false, '1px solid ', 'B', 'C', 'Century Gothic', '12', 'B', '30px', '8px');
    $str .= $this->reporter->col('REF NO', '100', null, false, '1px solid ', 'B', 'C', 'Century Gothic', '12', 'B', '30px', '8px');
    $str .= $this->reporter->col('PROJECT', '75', null, false, '1px solid ', 'B', 'C', 'Century Gothic', '12', 'B', '30px', '8px');
    $str .= $this->reporter->col('CHECK DETAILS', '75', null, false, '1px solid ', 'B', 'C', 'Century Gothic', '12', 'B', '30px', '8px');
    $str .= $this->reporter->col('DATE', '75', null, false, '1px solid ', 'B', 'C', 'Century Gothic', '12', 'B', '30px', '8px');
  ...
  public function rpt_DEFAULT_CCVOUCHER_LAYOUT1($data, $filters)
  {
    ...
    $str .= $this->rpt_default_header_layout1($data, $filters);
    $totaldb = 0;
    $totalcr = 0;
    for ($i = 0; $i < count($data); $i++) {
      ...
      $str .= $this->reporter->col($data[$i]['dyourref'], '100', null, false, '1px solid ', '', 'L', 'Century Gothic', '11', '', '', '2px');
      $str .= $this->reporter->col($data[$i]['projcode'], '75', null, false, '1px solid ', '', 'C', 'Century Gothic', '11', '', '', '2px');
      $str .= $this->reporter->col($data[$i]['checkno'], '75', null, false, '1px solid ', '', 'L', 'Century Gothic', '11', '', '', '2px');
    ...
    $str .= $this->reporter->begintable('800');
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('OURREF : ' . $data[0]['ourref'], '150', null, false, '1px dotted ', 'T', 'L', 'Century Gothic', '12', 'B', '', '2px');
    ...
    $str .= $this->reporter->col('Received By :', '350', null, false, '1px solid ', '', 'L', 'Century Gothic', '12', '', '', '');
    $str .= $this->reporter->col('Approved By :', '100', null, false, '1px solid ', '', 'L', 'Century Gothic', '12', '', '', '');
    $str .= $this->reporter->endrow();
    $str .= $this->reporter->endtable();
    ...
    $str .= $this->reporter->begintable('800');
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col($filters['params']['dataparams']['prepared'], '350', null, false, '1px solid ', '', 'L', 'Century Gothic', '12', 'B', '', '');
    $str .= $this->reporter->col($filters['params']['dataparams']['received'], '350', null, false, '1px solid ', '', 'L', 'Century Gothic', '12', 'B', '', '');
    $str .= $this->reporter->col($filters['params']['dataparams']['approved'], '100', null, false, '1px solid ', '', 'L', 'Century Gothic', '12', 'B', '', '');
    $str .= $this->reporter->endrow();
    $str .= $this->reporter->endtable();
  ...
  public function rpt_CV_WTAXREPORT($data, $filters)
  {
    ...
    switch ($month) {
      ...
      case '3':
        ...
        $str .= $this->reporter->col('01', '10', null, false, '2px solid', 'LRTB', 'C', 'Century Gothic', '10', 'B', '', '3px');
        $str .= $this->reporter->col($year, '10', null, false, '2px solid', 'LRTB', 'C', 'Century Gothic', '10', 'B', '', '3px');
