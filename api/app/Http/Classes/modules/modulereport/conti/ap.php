...
class ap
{
  ...
  public function default_AP_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(520, 0, 'PAYABLE SETUP', '', 'L', false, 0, '',  '100');
    ...
    PDF::MultiCell(100, 0, "CLIENT", '', 'R', false);
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::MultiCell(70, 15, ' ' . (isset($arr_postdate[$r]) ? $arr_postdate[$r] : ''), '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          ...
          PDF::MultiCell(100, 15, ' ' . (isset($arr_client[$r]) ? $arr_client[$r] : ''), '', 'R', false, 1, '',  '', true, 0, false, true, 0, 'M', false);
        }
