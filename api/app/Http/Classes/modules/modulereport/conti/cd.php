...
class cd
{
  ...
  private $modulename = "Canvass Sheet";
  private $fieldClass;
  ...
  public function reportplotting($params, $data)
  {
    if ($params['params']['dataparams']['print'] == "default") {
      return $this->default_cd_layout($params, $data);
    } else if ($params['params']['dataparams']['print'] == "PDFM") {
      return $this->default_CD_PDF($params, $data);
    }
  }
  ...
  public function default_header($params, $data)
  {
    ...
    $str .= $this->reporter->col('CANVASS SHEET', '580', null, false, $border, '', 'L', $font, '18', 'B', '', '');
    ...
    $str .= $this->reporter->col('UNIT PRICE', '100', null, false, $border, 'B', 'R', $font, '12', 'B', '30px', '8px');
    $str .= $this->reporter->col('(+/-) %', '75', null, false, $border, 'B', 'R', $font, '12', 'B', '30px', '8px');
    $str .= $this->reporter->col('TOTAL', '100', null, false, $border, 'B', 'R', $font, '12', 'B', '30px', '8px');
    return $str;
  }

  public function default_cd_layout($params, $data)
  {
  ...
  public function default_CD_header_PDF($params, $data)
  {
    $center = $params['params']['center'];
    $username = $params['params']['user'];
    ...
    PDF::MultiCell(520, 0, 'CANVASS SHEET', '', 'L', false, 0, '',  '100');
  ...
  public function default_CD_PDF($params, $data)
  {
    ...
    $this->default_CD_header_PDF($params, $data);
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        $uom = $data[$i]['uom'];
        $cost = number_format($data[$i]['netamt'], $decimalprice);
        $disc = $data[$i]['disc'];
        ...
        $arr_amt = $this->reporter->fixcolumn([$cost], '13', 0);
    ...
    // PDF::MultiCell(0, 0, '');
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(100, 0, 'ITEM(S)', '', 'L', false, 0);
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(50, 0, $i, '', 'L', false, 0);
    PDF::SetFont($fontbold, '', $fontsize);
