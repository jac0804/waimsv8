...
class cr
{
  ...
  public function report_default_query($filters)
  {
    ...
    from ((lahead as head left join ladetail as detail on detail.trno=head.trno) left join coa on coa.acnoid=detail.acnoid) left join client on client.client=detail.client
    ...
    left join client on client.clientid=detail.clientid where head.doc='cr' and head.trno='$trno' order by line
    ";
  ...
  public function rpt_default_header($data, $filters)
  {
    ...
    $str .= $this->reporter->begintable('800');
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('CUSTOMER : ', '90', null, false, '1px solid ', '', 'L', 'Avenir', '12', 'B', '30px', '4px');
    $str .= $this->reporter->col((isset($data[0]['clientname']) ? $data[0]['clientname'] : ''), '510', null, false, '1px solid ', 'B', 'L', 'Avenir', '12', '', '30px', '4px');
    $str .= $this->reporter->col('DATE : ', '50', null, false, '1px solid ', '', 'L', 'Avenir', '12', 'B', '', '');
    $str .= $this->reporter->col((isset($data[0]['dateid']) ? $data[0]['dateid'] : ''), '150', null, false, '1px solid ', 'B', 'R', 'Avenir', '12', '', '', '');
    $str .= $this->reporter->endrow();
    $str .= $this->reporter->endtable();
    $str .= $this->reporter->begintable('800');
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('ADDRESS : ', '90', null, false, '1px solid ', '', 'L', 'Avenir', '12', 'B', '30px', '4px');
    $str .= $this->reporter->col((isset($data[0]['address']) ? $data[0]['address'] : ''), '510', null, false, '1px solid ', 'B', 'L', 'Avenir', '12', '', '30px', '4px');
    $str .= $this->reporter->col('REF. :', '50', null, false, '1px solid ', '', 'L', 'Avenir', '12', 'B', '', '');
    $str .= $this->reporter->col((isset($data[0]['yourref']) ? $data[0]['yourref'] : ''), '150', null, false, '1px solid ', 'B', 'R', 'Avenir', '12', '', '', '');
    $str .= $this->reporter->endrow();
    $str .= $this->reporter->endtable();
    ...
    $str .= $this->reporter->startrow();
    //($txt='',$w=null,$h=null, $bg=false,$b=false,$b_='', $al='', $f='', $fs='',$fw='',$fc='',$pad='',$m='')
    $str .= $this->reporter->col('ACCT.#', '75', null, false, '1px solid ', 'B', 'C', 'Avenir', '12', 'B', '', '2px');
    $str .= $this->reporter->col('ACCOUNT NAME', '280', null, false, '1px solid ', 'B', 'C', 'Avenir', '12', 'B', '', '2px');
    $str .= $this->reporter->col('REFERENCE&nbsp#', '75', null, false, '1px solid ', 'B', 'C', 'Avenir', '12', 'B', '', '2px');
    $str .= $this->reporter->col('DATE', '75', null, false, '1px solid ', 'B', 'C', 'Avenir', '12', 'B', '', '2px');
    $str .= $this->reporter->col('DEBIT', '100', null, false, '1px solid ', 'B', 'R', 'Avenir', '12', 'B', '', '2px');
    $str .= $this->reporter->col('CREDIT', '100', null, false, '1px solid ', 'B', 'R', 'Avenir', '12', 'B', '', '2px');
    $str .= $this->reporter->col('', '20', null, false, '1px solid ', 'B', 'R', 'Century Gothic', '12', 'B', '', '2px');
    $str .= $this->reporter->col('CLIENT', '75', null, false, '1px solid ', 'B', 'C', 'Avenir', '12', 'B', '', '2px');
    return $str;
  }
  ...
  public function default_cr_layout($filters, $data)
  {
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      $str .= $this->reporter->col($data[$i]['acnoname'], '280', null, false, '1px solid ', '', 'L', 'Avenir', '11', '', '', '2px');
      $str .= $this->reporter->col($data[$i]['ref'], '75', null, false, '1px solid ', '', 'C', 'Avenir', '11', '', '', '2px');
      $str .= $this->reporter->col($data[$i]['postdate'], '75', null, false, '1px solid ', '', 'C', 'Avenir', '11', '', '', '2px');
      $str .= $this->reporter->col($debit, '100', null, false, '1px solid ', '', 'R', 'Avenir', '11', '', '', '2px');
      $str .= $this->reporter->col($credit, '100', null, false, '1px solid ', '', 'R', 'Avenir', '11', '', '', '2px');
      $str .= $this->reporter->col('', '20', null, false, '1px solid ', '', 'C', 'Avenir', '11', '', '', '2px');
    ...
    $str .= $this->reporter->col('Check # : ', '75', null, false, '1px solid ', '', 'R', 'Avenir', '12', 'i', '', '2px');
    for ($c = 0; $c < count($data); $c++) {
      $str .= $this->reporter->col($data[$c]['checkno'], '280', null, false, '1px solid ', '', 'L', 'Avenir', '12', '', '', '2px');
    }

    $str .= $this->reporter->col('', '75', null, false, '1px solid ', '', 'C', 'Avenir', '12', '', '', '2px');
    $str .= $this->reporter->col('', '100', null, false, '1px solid ', '', 'C', 'Avenir', '12', '', '', '2px');
    $str .= $this->reporter->col('', '100', null, false, '1px solid ', '', 'C', 'Avenir', '12', '', '', '2px');
    $str .= $this->reporter->col('', '20', null, false, '1px solid ', '', 'C', 'Avenir', '12', '', '', '2px');
    $str .= $this->reporter->col('', '75', null, false, '1px solid ', '', 'C', 'Avenir', '12', '', '', '2px');
    $str .= $this->reporter->endrow();
    $str .= $this->reporter->endtable();
    ...
    $str .= $this->reporter->begintable('800');
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('', '75', null, false, '1px dotted ', 'T', 'C', 'Avenir', '12', 'B', '', '2px');
    $str .= $this->reporter->col('', '75', null, false, '1px dotted ', 'T', 'C', 'Avenir', '12', 'B', '', '2px');
    $str .= $this->reporter->col('', '75', null, false, '1px dotted ', 'T', 'C', 'Avenir', '12', 'B', '', '2px');
    $str .= $this->reporter->col('GRAND TOTAL :', '275', null, false, '1px dotted ', 'T', 'R', 'Avenir', '12', 'B', '', '2px');
    $str .= $this->reporter->col(number_format($totaldb, $decimal), '110', null, false, '1px dotted ', 'T', 'R', 'Avenir', '12', 'B', '', '2px');
    $str .= $this->reporter->col(number_format($totalcr, $decimal), '98', null, false, '1px dotted ', 'T', 'R', 'Avenir', '12', 'B', '', '2px');
    $str .= $this->reporter->col('', '37', null, false, '1px dotted ', 'T', 'C', 'Avenir', '12', 'B', '', '2px');
    $str .= $this->reporter->col('', '75', null, false, '1px dotted ', 'T', 'C', 'Avenir', '12', 'B', '', '2px');
    $str .= $this->reporter->endrow();
    $str .= $this->reporter->endtable();
  ...
  public function default_CR_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(520, 0, 'RECEIVED PAYMENT', '', 'L', false, 0, '',  '100');
    ...
    PDF::MultiCell(80, 0, "ACCT NO.", '', 'C', false, 0);
  ...
  public function default_CR_PDF($params, $data)
  {
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      // PDF::SetFont($font, '', $fontsize);
      // // MultiCell($w, $h, $txt, $border=0, $align='J', $fill=0, $ln=1, $x='', $y='', $reseth=true, $stretch=0, $ishtml=false, $autopadding=true, $maxh=0)
      // PDF::MultiCell(80, 0, $data[$i]['acno'], '', 'C', 0, 0, '', '', true, 0, true, false);
      // PDF::MultiCell(220, 0, $data[$i]['acnoname'], '', 'L', 0, 0, '', '', true, 0, true, false);
      // PDF::MultiCell(100, 0, $data[$i]['ref'], '', 'C', 0, 0, '', '', true, 0, true, false);
      // PDF::MultiCell(75, 0, $data[$i]['postdate'], '', 'C', 0, 0, '', '', true, 0, true, false);
      // PDF::MultiCell(75, 0, $debit, '', 'R', 0, 0, '', '', true, 0, true, false);
      // PDF::MultiCell(75, 0, $credit, '', 'R', 0, 0, '', '', true, 0, true, false);
      // PDF::MultiCell(100, 0, $data[$i]['client'], '', 'L', 0, 1, '', '', true, 0, false, false);
      ...
      $arr_acno = $this->reporter->fixcolumn([$acno], '12', 0);
      ...
      $maxrow = $this->othersClass->getmaxcolumn([$arr_acno, $arr_acnonamedescs, $arr_ref, $arr_postdate, $arr_debit, $arr_credit]);

      for ($r = 0; $r < $maxrow; $r++) {

        PDF::SetFont($font, '', $fontsize);
        PDF::MultiCell(80, 15, ' ' . (isset($arr_acno[$r]) ? $arr_acno[$r] : ''), '', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
        PDF::MultiCell(220, 15, ' ' . (isset($arr_acnonamedescs[$r]) ? $arr_acnonamedescs[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
    ...
    for ($c = 0; $c < count($data); $c++) {
      if (!empty($data)) {
        if ($label == 0) {
          PDF::MultiCell(140, 0, 'CHECK # : ', '', 'R', false, 0);
          PDF::MultiCell(75, 0, $data[$c]['checkno'], '', 'L', false);
          $label = 1;
        } else {
        ...
        PDF::MultiCell(140, 0, 'CHECK # : ', '', 'R', false);
      }
