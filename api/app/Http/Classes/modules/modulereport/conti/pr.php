...
class pr
{
  ...
  public function default_PR_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(460, 0, "DESCRIPTION", '', 'L', false);
  ...
  public function default_PR_PDF($params, $data)
  {
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::MultiCell(50, 18, ' ' . (isset($arr_qty[$r]) ? $arr_qty[$r] : ''), '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          PDF::MultiCell(70, 18, ' ' . (isset($arr_uom[$r]) ? $arr_uom[$r] : ''), '', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          PDF::MultiCell(460, 18, ' ' . (isset($arr_itemname[$r]) ? $arr_itemname[$r] : ''), '', 'L', false, 1, '',  '', true, 0, false, true, 0, 'M', false);
        }
    ...
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(100, 0, 'TOTAL QUANTITY:', '', 'R', false, 0);
