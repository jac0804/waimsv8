...
class aj
{
  ...
  private function rpt_default_header($data, $filters)
  {
    ...
    $str .= $this->reporter->col('COST', '125px', null, false, '1px solid ', 'B', 'R', 'Century Gothic', '12', 'B', '30px', '8px');
    $str .= $this->reporter->col('TOTAL', '125px', null, false, '1px solid ', 'B', 'R', 'Century Gothic', '12', 'B', '30px', '8px');
    return $str;
  }
  ...
  public function default_AJ_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(520, 0, 'INVENTORY ADJUSTMENT', '', 'L', false, 0, '',  '100');
    ...
    PDF::MultiCell(120, 0, "PLU", '', 'C', false, 0);
