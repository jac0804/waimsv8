...
class is
{
  ...
  public function default_IS_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(115, 0, "BARCODE", '', 'L', false, 0);
    PDF::MultiCell(60, 0, "QTY", '', 'L', false, 0);
    PDF::MultiCell(60, 0, "UNIT", '', 'L', false, 0);
  ...
  public function default_IS_PDF($params, $data)
  {
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        $arr_cost = $this->reporter->fixcolumn([$cost], '17', 0);
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::SetFont($font, '', $fontsize);
          PDF::MultiCell(115, 15, ' ' . (isset($arr_barcode[$r]) ? $arr_barcode[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          PDF::MultiCell(60, 15, ' ' . (isset($arr_qty[$r]) ? $arr_qty[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          PDF::MultiCell(60, 15, ' ' . (isset($arr_uom[$r]) ? $arr_uom[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          PDF::MultiCell(265, 15, ' ' . (isset($arr_itemname[$r]) ? $arr_itemname[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
    ...
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(575, 0, 'GRAND TOTAL: ', '', 'R', false, 0);
