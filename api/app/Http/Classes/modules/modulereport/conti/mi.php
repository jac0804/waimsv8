...
class mi
{
  ...
  public function report_default_query($config)
  {
    ...
    wh.client as whcode, wh.clientname as whname,coa.acnoname as expacc,pm.name as projname,swh.client as stockwh from lahead as head
    ...
    left join client as swh on swh.clientid=stock.whid
    ...
    item.sizeid, ag.clientname as agname, item.brand,
    wh.client as whcode, wh.clientname as whname,coa.acnoname as expacc,pm.name as projname,swh.client as stockwh from glhead as head
  ...
  public function reportplotting($params, $data)
  {
    if ($params['params']['dataparams']['print'] == "default") {
      return $this->default_mi_layout($params, $data);
  ...
  public function default_mi_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(520, 0, 'STOCK ISSUANCE', '', 'L', false, 0, '',  '100');
    ...
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(80, 0, "Expense Acct: ", '', 'L', false, 0, '',  '');
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(470, 0, (isset($data[0]['expacc']) ? $data[0]['expacc'] : ''), 'B', 'L', false, 0, '',  '');
    PDF::SetFont($fontbold, '', $fontsize);
    ...
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(100, 0, (isset($data[0]['projname']) ? $data[0]['projname'] : ''), 'B', 'L', false, 0, '',  '');
    ...
    PDF::MultiCell(110, 0, "WAREHOUSE", '', 'C', false);
  ...
  public function default_mi_PDF($params, $data)
  {
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      $maxrow = $this->othersClass->getmaxcolumn([$arr_barcode, $arr_itemname, $arr_qty, $arr_uom, $arr_stockwh]);
      ...
      for ($r = 0; $r < $maxrow; $r++) {
        ...
        PDF::MultiCell(110, 15, ' ' . (isset($arr_stockwh[$r]) ? $arr_stockwh[$r] : ''), '', 'R', false, 1, '',  '', true, 0, false, true, 0, 'M', false);
      }
    ...
    PDF::MultiCell(50, 0, number_format($totalqty, $decimalprice), '', 'C');
