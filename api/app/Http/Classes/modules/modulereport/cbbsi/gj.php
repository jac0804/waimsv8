...
class gj
{
  ...
  public function report_default_query($filters)
  {
    ...
    head.clientname, head.address, head.yourref, head.ourref,head.rem,
  ...
  public function rpt_gj_header_default($config, $result)
  {
    ...
    $str .= $this->reporter->col('Yourref. :', '40', null, false, '1px solid ', '', 'L', 'Century Gothic', '12', 'B', '', '');
    ...
    $str .= $this->reporter->col((isset($result[0]->rem) ? $result[0]->rem : ''), '520', null, false, '1px solid ', 'B', 'L', 'Century Gothic', '12', '', '30px', '4px');
    $str .= $this->reporter->col('Ourref. :', '40', null, false, '1px solid ', '', 'L', 'Century Gothic', '12', 'B', '', '');
    $str .= $this->reporter->col((isset($result[0]->ourref) ? $result[0]->ourref : ''), '160', null, false, '1px solid ', 'B', 'R', 'Century Gothic', '12', '', '', '');
    $str .= $this->reporter->endrow();
    $str .= $this->reporter->endtable();
  ...
  public function default_GJ_PDF($params, $data)
  {
    ...
    if (!empty($data)) {
      ...
      for ($i = 0; $i < count($data); $i++) {
        ...
        $arr_acnoname = $this->reporter->fixcolumn([$acnoname], '24', 0);
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::MultiCell(150, 15, ' ' . (isset($arr_acnoname[$r]) ? $arr_acnoname[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
