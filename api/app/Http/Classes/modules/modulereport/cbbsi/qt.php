...
class qt
{
  ...
  public function reportplotting($params, $data)
  {
    if ($params['params']['dataparams']['print'] == "default") {
      return $this->default_qt_layout($params, $data);
    } else if ($params['params']['dataparams']['print'] == "PDFM") {
      return $this->default_QT_PDF($params, $data);
    }
  }
  ...
  public function default_header($params, $data)
  {
    ...
    $arr_address = $this->reporter->fixcolumn([$data[0]['address']], '65', 0);
    ...
    for ($r = 0; $r < $maxrow; $r++) {
      ...
      if ($r == 0) {
        ...
        $str .= $this->reporter->col('', '80', null, false, $border, '', 'L', $font, $fontsize, 'B', '30px', '4px');
      }

      $str .= $this->reporter->col((isset($arr_address[$r]) ? $arr_address[$r] : ''), '500', null, false, $border, 'B', 'L', $font, $fontsize, '', '30px', '4px');
  ...
  public function default_qt_layout($params, $data)
  {
  ...
  public function default_QT_header_PDF($params, $data)
  {
    $center = $params['params']['center'];
    $username = $params['params']['user'];
  ...
  public function default_QT_PDF($params, $data)
  {
    $companyid = $params['params']['companyid'];
    ...
    $this->default_QT_header_PDF($params, $data);
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      for ($r = 0; $r < $maxrow; $r++) {
        ...
        PDF::MultiCell(100, 15, ' ' . (isset($arr_netamt[$r]) ? $arr_netamt[$r] : ''), '', 'R', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
