...
class mr
{
  ...
  public function reportplotting($params, $data)
  {
    if ($params['params']['dataparams']['print'] == "default") {
      return $this->default_mr_layout($params, $data);
    } else if ($params['params']['dataparams']['print'] == "PDFM") {
      return $this->default_mr_PDF($params, $data);
    }
  }

  public function default_mr_layout($params, $data)
  {
  ...
  public function report_default_header($params, $data)
  {
    $center = $params['params']['center'];
    $username = $params['params']['user'];
  ...
  public function default_mr_header_PDF($params, $data)
  {
    $center = $params['params']['center'];
    $username = $params['params']['user'];
  ...
  public function default_mr_PDF($params, $data)
  {
    ...
    $this->default_mr_header_PDF($params, $data);
