...
class customer
{
    ...
    public function createreportfilter($config)
    {
        ...
        data_set($col1, 'radiocustreporttype.options', array(
    ...
    public function reportdefaultAR_PDF($config, $data)
    {
        ...
        if (isset($data[0]->crlimit)) {
            $creditlimit = $data[0]->crlimit - $totalcredit;
        } else {
            $creditlimit = 0;
        }
        ...
        PDF::MultiCell(120, 10, "Document #", '', 'C', false, 0);
        PDF::MultiCell(70, 10, "Date", '', 'C', false, 0);
        PDF::MultiCell(110, 10, "Agent", '', 'C', false, 0);
        PDF::MultiCell(120, 10, "Notes", '', 'C', false, 0);
        PDF::MultiCell(80, 10, "Debit", '', 'R', false, 0);
        PDF::MultiCell(80, 10, "Credit", '', 'R', false, 0);
        PDF::MultiCell(80, 10, "Balance", '', 'R', false, 0);
        ...
        if (empty($bdata)) {
            ...
            PDF::MultiCell(120, 15, 'Beginning Balance', '', 'L', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(70, 15, '', '', 'C', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(110, 15, '', '', 'L', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(120, 15, '', '', 'L', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(80, 15, '', '', 'R', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(80, 15, '', '', 'R', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(80, 15, '0.00', '', 'R', 0, 0, '', '', true, 0, true, false);
            ...
            PDF::MultiCell(80, 15, '', '', 'R', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(80, 15, '', '', 'R', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(80, 15, number_format($bdata[0]['begbal'], 2), '', 'R', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(5, 15, '', '', 'R', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(95, 15, '', '', 'L', 0, 1, '', '', true, 0, false, false);
        }
        ...
        foreach ($data as $key => $data) {
            ...
            PDF::SetFont($font, '', $fontsize);
            // MultiCell($w, $h, $txt, $border=0, $align='J', $fill=0, $ln=1, $x='', $y='', $reseth=true, $stretch=0, $ishtml=false, $autopadding=true, $maxh=0)
            PDF::MultiCell(120, 15, $data->docno, '', 'L', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(70, 15, $data->dateid, '', 'C', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(110, 15, $data->agentname, '', 'L', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(120, 15, $data->rem, '', 'L', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(80, 15, $debit, '', 'R', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(80, 15, $credit, '', 'R', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(80, 15, $balance, '', 'R', 0, 0, '', '', true, 0, true, false);
            PDF::MultiCell(5, 15, '', '', 'R', 0, 0, '', '', true, 0, true, false);
        ...
        PDF::MultiCell(70, 15, '', '', 'C', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(110, 15, '', '', 'L', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(120, 15, 'Grand Total : ', '', 'L', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(80, 15, number_format($totaldb, 2), '', 'R', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(80, 15, number_format($totalcr, 2), '', 'R', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(80, 15, number_format($rbalance, 2), '', 'R', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(5, 15, '', '', 'R', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(95, 15, '', '', 'L', 0, 1, '', '', true, 0, false, false);
