...
class tr
{
  ...
  public function createreportfilter()
  {
    ...
    data_set($col1, 'radioreporttype.options', [
      ['label' => 'Stock Request', 'value' => '1', 'color' => 'blue'],
      ['label' => 'Pull Out Request', 'value' => '2', 'color' => 'blue'],
      ['label' => 'Requisition Form', 'value' => '3', 'color' => 'blue'],
    ]);
  ...
  public function default_TR_header_PDF($params, $data)
  {
    ...
    switch($reporttype) {
      case '1':
        ...
        break;
      case '2':
        $reportname = "PULL OUT REQUEST";
        break;
      case '3':
        $reportname = "REQUISITION FORM";
        break;
    }
  ...
  public function default_TR_PDF($params, $data)
  {
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      for ($r = 0; $r < $maxrow; $r++) {
        ...
        PDF::MultiCell(230, 0, (isset($arr_itemname[$r]) ? $arr_itemname[$r] : ''), '', 'L', false, 0);
    ...
    public function pullout_and_requisition($params, $data)
  {
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      $maxrow = $this->othersClass->getmaxcolumn([$arr_barcode, $arr_itemname, $arr_uom, $arr_rrqty, $arr_stockwh, $arr_rem]);

      for ($r = 0; $r < $maxrow; $r++) {
        PDF::SetFont($font, '', $fontsize);
        PDF::MultiCell(100, 0, (isset($arr_barcode[$r]) ? $arr_barcode[$r] : ''), '', 'C', false, 0);
        PDF::MultiCell(200, 0, (isset($arr_itemname[$r]) ? $arr_itemname[$r] : ''), '', 'L', false, 0);
        PDF::MultiCell(100, 0, (isset($arr_stockwh[$r]) ? $arr_stockwh[$r] : ''), '', 'C', false, 0);
        PDF::MultiCell(50, 0, (isset($arr_uom[$r]) ? $arr_uom[$r] : ''), '', 'C', false, 0);
        PDF::MultiCell(70, 0, (isset($arr_rrqty[$r]) ? $arr_rrqty[$r] : ''), '', 'C', false, 0);
        PDF::MultiCell(100, 0, (isset($arr_rrdate[$r]) ? $arr_rrdate[$r] : ''), '', 'C', false, 0);
