...
class pr
{
  ...
  public function default_PR_header_PDF($params, $data)
  {
    ...
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(470, 20, '', '', 'L', false, 1, '',  '', true, 0, false, true, 0, 'B', true);
    // PDF::SetFont($fontbold, '', $fontsize);
    ...
    PDF::MultiCell(260, 25, "DESCRIPTION", 'TB', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', true);
    PDF::MultiCell(100, 25, "UNIT PRICE", 'TB', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', true);
    PDF::MultiCell(100, 25, "TOTAL", 'TB', 'C', false, 1, '',  '', true, 0, false, true, 0, 'M', true);
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      if ($data[$i]['itemname'] == '') {
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::SetFont($font, '', $fontsize);
          PDF::MultiCell(100, 18, ' ' . (isset($arr_barcode[$r]) ? $arr_barcode[$r] : ''), '', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          PDF::MultiCell(80, 18, ' ' . (isset($arr_qty[$r]) ? $arr_qty[$r] : ''), '', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          PDF::MultiCell(60, 18, ' ' . (isset($arr_uom[$r]) ? $arr_uom[$r] : ''), '', 'C', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
          PDF::MultiCell(260, 18, ' ' . (isset($arr_itemname[$r]) ? $arr_itemname[$r] : ''), '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', false);
