...
class gj
{
  ...
  public function default_GJ_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(110, 0, (isset($data[0]['docno']) ? $data[0]['docno'] : ''), ['B' => ['dash'=>1]], 'L', false, 0, '',  '');

    PDF::SetFont($font, 'B', $fontsize);
    PDF::MultiCell(0, 30, "", '', 'L');
    PDF::MultiCell(60, 0, "Client: ", '', 'L', false, 0, '',  '');
    PDF::MultiCell(460, 0, (isset($data[0]['clientname']) ? $data[0]['clientname'] : ''), ['B' => ['dash'=>1]], 'L', false, 0, '',  '');
    PDF::MultiCell(60, 0, "Date: ", '', 'L', false, 0, '',  '');
    PDF::MultiCell(120, 0, (isset($data[0]['dateid']) ? $data[0]['dateid'] : ''), ['B' => ['dash'=>1]], 'L', false, 0, '',  '');

    PDF::MultiCell(0, 0, "\n");

    PDF::SetFont($font, 'B', $fontsize);
    PDF::MultiCell(60, 0, "Address: ", '', 'L', false, 0, '',  '');
    PDF::MultiCell(460, 0, (isset($data[0]['address']) ? $data[0]['address'] : ''), ['B' => ['dash'=>1]], 'L', false, 0, '',  '');
    PDF::MultiCell(60, 0, "YourRef: ", '', 'L', false, 0, '',  '');
    PDF::MultiCell(120, 0, (isset($data[0]['yourref']) ? $data[0]['yourref'] : ''), ['B' => ['dash'=>1]], 'L', false, 0, '',  '');
    ...
    PDF::MultiCell(100, 0, "CLIENT", '', 'C', false, 0);
    ...
    PDF::MultiCell(100, 0, "REFERENCE #", '', 'L', false);
  ...
  public function default_GJ_PDF($params, $data)
  {
    ...
    if (!empty($data)) {
      ...
      for ($i = 0; $i < count($data); $i++) {
        ...
        for($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::MultiCell(100, 0, (isset($arr_client[$r]) ? $arr_client[$r] : ''), '', 'L', false, 0, '', '', false, 1);
          ...
          PDF::MultiCell(100, 0, (isset($arr_ref[$r]) ? $arr_ref[$r] : ''), '', 'L', false, 1, '', '', false, 1);
        }
    ...
    PDF::MultiCell(85, 0, 'P '.number_format($totaldb, $decimalcurr), '', 'R', false, 0);
    PDF::MultiCell(85, 0, 'P '.number_format($totalcr, $decimalcurr), '', 'R', false, 0);
