...
class rr
{
  private $modulename = "RECEIVED INVENTORY";
  private $fieldClass;
  ...
  public function report_default_query($config)
  {
    ...
    $query = "select head.docno,head.trno, head.clientname, head.address, date(head.dateid) as dateid, head.terms, head.rem,
        ...
        stock.uom, stock.disc, stock.ext, stock.line,wh.client as wh,wh.clientname as whname,stock.loc,date(stock.expiry) as expiry,stock.rem as srem,item.sizeid,m.model_name as model, head.ourref, head.yourref, head.rem
        from lahead as head
  ...
  public function default_RR_header_PDF($params, $data)
  {
    ...
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(300, 25, "", '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', true);
    PDF::MultiCell(60, 25, "D.R # : ", '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', true);
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(140, 25, '' . (isset($data[0]['ourref']) ? $data[0]['ourref'] : ''), 'B', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', true);
    PDF::MultiCell(20, 25, "", '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'M', true);
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(60, 25, "S.I.# : ", '', 'L', false, 0, '',  '', true, 0, false, true, 0, 'B', true);
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(140, 25, ': ' . (isset($data[0]['yourref']) ? $data[0]['yourref'] : ''), 'B', 'L', false, 1, '', '', true, 0, false, true, 0, 'M', true);
