...
class trapproval
{
  ...
  public function default_TRAPPROVAL_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(100, 0, "REQUEST QTY", '', 'C', false, 0);
    PDF::MultiCell(100, 0, "APPROVED QTY", '', 'C', false, 0);
  ...
  public function default_TRAPPROVAL_PDF($params, $data)
  {
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      $uom = $data[$i]['uom'];
      $reqqty = number_format($data[$i]['reqqty'],$decimalprice);
      $rrqty = number_format($data[$i]['rrqty'],$decimalprice);
      ...
      for($r = 0; $r < $maxrow; $r++) {
        ...
        PDF::MultiCell(100, 0, (isset($arr_reqqty[$r]) ? $arr_reqqty[$r] : ''), '', 'C', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(100, 0, (isset($arr_rrqty[$r]) ? $arr_rrqty[$r] : ''), '', 'C', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(100, 0, (isset($arr_stockwh[$r]) ? $arr_stockwh[$r] : ''), '', 'C', 0, 0, '', '', true, 0, true, false);
