...
class pc
{
  ...
  public function createreportfilter()
  {
    ...
    data_set($col1, 'radioreporttype.options', [
      ...
      ['label' => 'Inventory Reconcilliation', 'value' => 'BIN', 'color' => 'red']
    ]);
  ...
  public function report_default_query($filters)
  {
    ...
    item.itemname, stock.rrqty as qty, stock.uom, stock.rrcost as cost, stock.disc, stock.ext,stock.oqty as onhand, stock.asofqty, stock.rem as srem, stock.loc, stock.expiry
    from pchead as head 
  ...
  public function IR_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(55, 0, "UNIT", '', 'C', false, 0);
    PDF::MultiCell(180, 0, "DESCRIPTION", '', 'L', false, 0);
    PDF::MultiCell(55, 0, "LOCATION", '', 'L', false, 0);
    PDF::MultiCell(65, 0, "EXPIRY", '', 'L', false, 0);
    PDF::MultiCell(55, 0, "ON HAND", '', 'C', false, 0);
    PDF::MultiCell(55, 0, "COUNT", '', 'C', false, 0);
    PDF::MultiCell(65, 0, "DIFFERENCE", '', 'C', false, 0);
    PDF::MultiCell(90, 0, "REMARKS", '', 'L', false);
  ...
  public function IR_PDF($params, $data)
  {
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      $arr_itemname = $this->reporter->fixcolumn([$itemname], '39', 0);
      ...
      for ($r = 0; $r < $maxrow; $r++) {
        PDF::SetFont($font, '', $fontsize);
        PDF::MultiCell(70, 0, (isset($arr_barcode[$r]) ? $arr_barcode[$r] : ''), '', 'L', false, 0, '', '', true, 1);
        PDF::MultiCell(55, 0, (isset($arr_uom[$r]) ? $arr_uom[$r] : ''), '', 'C', false, 0, '', '', false, 1);
        PDF::MultiCell(180, 0, (isset($arr_itemname[$r]) ? $arr_itemname[$r] : ''), '', 'L', false, 0, '', '', false, 1);
        PDF::MultiCell(55, 0, (isset($arr_loc[$r]) ? $arr_loc[$r] : ''), '', 'L', false, 0, '', '', false, 1);
        PDF::MultiCell(65, 0, (isset($arr_expiry[$r]) ? $arr_expiry[$r] : ''), '', 'L', false, 0, '', '', false, 1);
        PDF::MultiCell(55, 0, (isset($arr_onhand[$r]) ? $arr_onhand[$r] : ''), '', 'R', false, 0, '', '', false, 1);
        PDF::MultiCell(55, 0, (isset($arr_qty[$r]) ? $arr_qty[$r] : ''), '', 'R', false, 0, '', '', false, 1);
        PDF::MultiCell(65, 0, (isset($arr_diff[$r]) ? $arr_diff[$r] : ''), '', 'R', false, 0, '', '', false, 1);
        PDF::MultiCell(90, 0, (isset($arr_rem[$r]) ? $arr_rem[$r] : ''), '', 'L', false, 1, '', '', false, 1);
      }
    ...
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(425, 0, 'GRAND TOTAL: ', '', 'L', false, 0);
    PDF::MultiCell(55, 0, number_format($totalonhand, $decimalqty), '', 'R', false, 0);
    PDF::MultiCell(55, 0, number_format($totalcount, $decimalqty), '', 'R', false, 0);
    PDF::MultiCell(65, 0, number_format($totaldiff, $decimalqty), '', 'R', false, 0);
    PDF::MultiCell(90, 0, '', '', 'R');
