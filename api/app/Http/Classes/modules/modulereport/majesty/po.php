...
class po
{
  ...
  public function reportplotting($params, $data)
  {
    if ($params['params']['dataparams']['print'] == "PDFM") {
      ...
      return $this->excel_po_layout($params, $data);
    }
  }

  public function excel_header($params, $data)
  {
    ...
    $str .= $this->reporter->col($this->modulename, '100', null, false, $border, '', 'L', $font, '18', 'B', '', '');
    $str .= $this->reporter->col('', '480', null, false, $border, '', 'L', $font, '18', 'B', '', '');
    $str .= $this->reporter->col('Docno #', '120', null, false, $border, '', 'L', $font, '13', 'B', '', '');
    ...
    $str .= $this->reporter->col((isset($data[0]['clientname']) ? ':'.$data[0]['clientname'] : ''), '500', null, false, $border, 'B', 'L', $font, '12', '', '30px', '4px');
    $str .= $this->reporter->col('Date ', '100', null, false, $border, '', 'L', $font, '12', 'B', '', '');
    // $str .= $this->reporter->col($date, '100', null, false, $border, 'B', 'R', $font, '12', '', '', '');
    $str .= $this->reporter->col((isset($date) ? ':'.$date  : ''), '100', null, false, $border, 'B', 'L', $font, '12', '', '', '');
    $str .= $this->reporter->endrow();
    $str .= $this->reporter->endtable();
    $str .= $this->reporter->begintable('800');
    $str .= $this->reporter->startrow();
    ...
    $str .= $this->reporter->begintable('800');
    $str .= $this->title_excelheader($params);
    return $str;
  }

  public function title_excelheader($params)
  {
    $border = "1px solid ";
    $font =  "Century Gothic";
    $str = "";
  ...
  public function excel_po_layout($params, $data)
  {
    ...
    $str .= $this->excel_header($params, $data);
    ...
    $str .= $this->reporter->startrow();
    $str .= $this->reporter->col('', '50', null, false, '1px solid ', 'T', 'C', $font, $fontsize, 'B', '', '');
    $str .= $this->reporter->col('', '50', null, false, '1px solid ', 'T', 'C', $font, $fontsize, 'B', '', '');
    $str .= $this->reporter->col('', '50', null, false, '1px solid ', 'T', 'C', $font, $fontsize, 'B', '', '');
    $str .= $this->reporter->col('', '440', null, false, '1px solid ', 'T', 'C', $font, $fontsize, 'B', '', '');
    $str .= $this->reporter->col('', '100', null, false, '1px solid ', 'T', 'C', $font, $fontsize, 'B', '', '');
    $str .= $this->reporter->col('GRAND TOTAL :', '110', null, false, '1px solid ', 'T', 'R', $font, $fontsize, 'B', '', '');
    $str .= $this->reporter->col(number_format($totalext, $decimal), '100', null, false, '1px solid ', 'T', 'R', $font, $fontsize, 'B', '', '');
    $str .= $this->reporter->endrow();
  ...
  public function default_PO_PDF($params, $data)
  {
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      $maxrow = $this->othersClass->getmaxcolumn([$arr_barcode, $arr_qty, $arr_uom, $arr_itemname, $arr_netamt, $arr_disc, $arr_ext]);
      ...
      for ($r = 0; $r < $maxrow; $r++) {
        ...
        PDF::MultiCell(210, 0, (isset($arr_itemname[$r]) ? $arr_itemname[$r] : ''), '', 'L', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(100, 0, (isset($arr_netamt[$r]) ? $arr_netamt[$r] : ''), '', 'R', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(90, 0, (isset($arr_disc[$r]) ? $arr_disc[$r] : ''), '', 'R', 0, 0, '', '', true, 0, true, false);
        PDF::MultiCell(100, 0, (isset($arr_ext[$r]) ? $arr_ext[$r] : ''), '', 'R', 0, 0, '', '', true, 0, true, false);
