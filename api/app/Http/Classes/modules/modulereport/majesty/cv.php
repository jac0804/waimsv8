  ...
  public function PDF_DEFAULT_CCVOUCHER_LAYOUT1($data,$params){
    ...
    if (!empty($data)) {
      ...
      for ($i = 0; $i < count($data); $i++) {
        ...
        $arr_pdate = $this->reporter->fixcolumn([$pdate],'16',0);
        $arr_debit = $this->reporter->fixcolumn([$debit],'13',0);
        $arr_credit = $this->reporter->fixcolumn([$credit],'13',0);
        $arr_drem = $this->reporter->fixcolumn([$drem],'16',0);

        $maxrow = $this->othersClass->getmaxcolumn([$arr_acno, $arr_acnoname, $arr_checkno, $arr_pdate, $arr_debit, $arr_credit, $arr_drem]);
        ...
        for($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::MultiCell(100, 0, (isset($arr_checkno[$r]) ? $arr_checkno[$r] : ''), '', 'L', false, 0, '', '', false, 1);
          PDF::MultiCell(75, 0, (isset($arr_pdate[$r]) ? $arr_pdate[$r] : ''), '', 'C', false, 0, '', '', false, 1);
          ...
          PDF::MultiCell(100, 0, (isset($arr_drem[$r]) ? $arr_drem[$r] : ''), '', 'L', false, 1, '', '', false, 1);
        }
