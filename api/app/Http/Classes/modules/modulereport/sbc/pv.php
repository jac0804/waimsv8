...
class pv
{
    ...
    public function reportplotting($config, $data)
    {
        ...
        if ($config['params']['dataparams']['print'] == "default") {
            ...
            switch ($config['params']['dataparams']['reporttype']) {
                case 0: // VOUCHER
                    $str = $this->PDF_DEFAULT_CCVOUCHER_LAYOUT1_SBC($data, $config);
                    break;
                case 2:
    ...
    public function PDF_default_header_ccvoucher_sbc($params, $data)
    {
        ...
        PDF::MultiCell(700, 15, $this->modulename, '', 'L', false, 1);

        PDF::SetFont($fontbold, '', 14);
        PDF::MultiCell(300, 15, '', '', 'L', false, 0);
        PDF::SetFont($font, '', $fontsize);
        PDF::MultiCell(290, 15, "Docno #: ", '', 'R', false, 0, '',  '');
        PDF::SetFont($fontbold, '', 12);
        PDF::MultiCell(110, 15, (isset($data[0]['docno']) ? $data[0]['docno'] : ''), '', 'R', false);

        PDF::SetFont($font, '',  $fontsize);
        PDF::MultiCell(70, 15, 'PAID TO : ', '', 'L', false, 0);
        PDF::SetFont($fontbold, '',  12);
        PDF::MultiCell(350, 15, (isset($data[0]['clientname']) ? $data[0]['clientname'] : ''), '', 'L', false, 0, '',  '');
        PDF::SetFont($font, '',  $fontsize);
        PDF::MultiCell(165, 15, 'DATE:', '', 'R', false, 0);
        PDF::SetFont($fontbold, '',  $fontsize);
        PDF::MultiCell(110, 15, (isset($data[0]['dateid']) ? date('m-d-Y', strtotime($data[0]['dateid'])) : ''), '', 'R', false);
        ...
        PDF::SetFont($font, '',  $fontsize);
        PDF::MultiCell(165, 25, 'YOURREF :', '', 'R', false, 0);
        PDF::SetFont($fontbold, '',  $fontsize);
        PDF::MultiCell(110, 25, (isset($data[0]['yourref']) ? $data[0]['yourref'] : ''), '', 'R', false);
    ...
    public function PDF_DEFAULT_CCVOUCHER_LAYOUT1_SBC($data, $params)
    {
        ...
        $this->PDF_default_header_ccvoucher_sbc($params, $data);
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            PDF::SetFont($font, '', 11);
            PDF::MultiCell(500, 25, $acname . $drem . ' ' . $data[$i]['project'], 'TBL', 'L', false, 0, '', '', true, 0, false, true, 0, 'M', true);
            PDF::MultiCell(100, 25, $debit, 'TBL', 'R', false, 0, '', '', true, 0, false, true, 0, 'M', true);
            PDF::MultiCell(100, 25, $credit, 'TBLR', 'R', false, 1, '', '', true, 0, false, true, 0, 'M', true);
        }
        ...
        PDF::MultiCell(253, 0, $params['params']['user'], '', 'L', false, 0);
