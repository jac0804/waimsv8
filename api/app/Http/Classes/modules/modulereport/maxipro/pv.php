...
class pv
{
  ...
  public function createreportfilter($config)
  {
    ...
    data_set(
      ...
      [
        ...
        ['label' => 'NEW VOUCHER PRINTOUT', 'value' => '1', 'color' => 'blue'],
  ...
  public function reportplotting($config, $data)
  {
    ...
    if ($config['params']['dataparams']['print'] == "default") {
      ...
      switch ($config['params']['dataparams']['reporttype']) {
        case 0: // VOUCHER
          $str = $this->PDF_maxipro_voucher_layout($data, $config);
          break;
        case 1: //NEW VOUCHER PRINTOUT
          $str = $this->PDF_CCVOUCHER_LAYOUT2($data, $config);
          break;
        case 2:
  ...
  public function PDF_maxipro_voucher_header($params, $data)
  {
    ...
    PDF::MultiCell(700, 25, "A C C O U N T S  P A Y A B L E  V O U C H E R", '', 'C', false);

    PDF::MultiCell(0, 0, "\n");

    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(80, 10, 'PAID TO', '', 'L', false, 0);
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(370, 10, (isset($data[0]['clientname']) ? $data[0]['clientname'] : ''), 'B', 'L', false, 0, '',  '');
    PDF::MultiCell(10, 10, "", '', 'R', false, 0, '',  '');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(100, 10, "AP Voucher NO. ", '', 'L', false, 0, '',  '');
    PDF::MultiCell(10, 10, "", '', 'R', false, 0, '',  '');
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(130, 10, (isset($data[0]['docno']) ? $data[0]['docno'] : ''), 'B', 'L', false);

    PDF::SetFont($font, '', 1);
    PDF::MultiCell(700, 3, '', '', 'L', false);

    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(80, 10, 'Address', '', 'L', false, 0);
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(370, 10, (isset($data[0]['address']) ? $data[0]['address'] : ''), 'B', 'L', false, 0, '',  '');
    PDF::MultiCell(10, 10, "", '', 'R', false, 0, '',  '');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(100, 10, "Date ", '', 'L', false, 0, '',  '');
    PDF::MultiCell(10, 10, "", '', 'R', false, 0, '',  '');
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(130, 10, date('m/d/Y', strtotime($data[0]['dateid'])), 'B', 'L', false);

    PDF::SetFont($font, '', 5);
    PDF::MultiCell(700, 3, '', '', 'L', false);

    $jcref = '';
    $jc = explode(',', $data[0]['jcref']);
    foreach ($jc as $key => $ref) {
      if ($ref != '') {
        $jcref .= $ref . "\n";
      }
    }
    ...
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(80, 10, 'Project', '', 'L', false, 0);
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(370, 10, (isset($data[0]['projname']) ? $data[0]['projname'] : ''), 'B', 'L', false, 0, '',  '');
    PDF::MultiCell(10, 10, "", '', 'R', false, 0, '',  '');
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(100, 10, "JC NO", '', 'L', false, 0, '',  '');
    PDF::MultiCell(10, 10, "", '', 'R', false, 0, '',  '');
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(130, 10, (isset($jcref) ? $jcref : ''), 'B', 'L', false);

    PDF::MultiCell(0, 0, "\n\n\n");
    PDF::SetFont($fontbold, '', 14);
    PDF::MultiCell(50, 15, '', '', 'C', false, 0);
    PDF::MultiCell(500, 15, 'PARTICULARS', 'TBL', 'C', false, 0);
    PDF::MultiCell(120, 15, 'AMOUNT', 'TBL', 'R', false, 0);
    PDF::MultiCell(10, 15, '', 'TBR', 'R', false, 0);
    PDF::MultiCell(20, 15, '', '', 'R', false);
  }

  public function PDF_maxipro_voucher_layout($data, $params)
  {
    ...
    $this->PDF_maxipro_voucher_header($params, $data);
    ...
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(50, 15, '', '', 'C', false, 0);
    PDF::MultiCell(10, 15, '', 'TL', 'L', false, 0);
    PDF::MultiCell(490, 15, $remarks, 'T', 'L', false, 0);
    PDF::SetFont('dejavusans', '', 11, '', true);
    PDF::MultiCell(20, 15, "<span>&#8369;</span>", 'TL', 'C', false, 0, '', '', false, 1, true);
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(100, 15, number_format($totaldb, 2), 'T', 'R', false, 0);
    PDF::MultiCell(10, 15, '', 'TR', 'R', false, 0);
    PDF::MultiCell(20, 15, '', '', 'R', false);

    PDF::SetFont($fontbold, '', 14);
    PDF::MultiCell(50, 15, '', '', 'C', false, 0);
    PDF::MultiCell(500, 15, '', 'L', 'C', false, 0);
    PDF::MultiCell(120, 15, '', 'L', 'R', false, 0);
    PDF::MultiCell(10, 15, '', 'R', 'R', false, 0);
    PDF::MultiCell(20, 15, '', '', 'R', false);
    ...
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(50, 15, '', '', 'C', false, 0);
    PDF::MultiCell(10, 15, '', 'TBL', 'L', false, 0);
    PDF::MultiCell(490, 15, 'Totals', 'TB', 'L', false, 0);
    PDF::SetFont('dejavusans', '', 11, '', true);
    PDF::MultiCell(20, 15, "<span>&#8369;</span>", 'TBL', 'C', false, 0, '', '', false, 1, true);
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(100, 15, number_format($totaldb, 2), 'TB', 'R', false, 0);
    PDF::MultiCell(10, 15, '', 'TBR', 'R', false, 0);
    PDF::MultiCell(20, 15, '', '', 'R', false);
    ...
    PDF::MultiCell(300, 15, 'ACCOUNTING ENTRY', 'TBL', 'C', false, 0);
    PDF::MultiCell(120, 15, 'DEBIT', 'TBL', 'C', false, 0);
    PDF::MultiCell(120, 15, 'CREDIT', 'TBLR', 'C', false, 0);
    PDF::MultiCell(20, 15, '', '', 'R', false);

    PDF::SetFont($font, '', 1);
    PDF::MultiCell(50, 5, '', '', 'C', false, 0);
    PDF::MultiCell(90, 5, '', 'L', 'C', false, 0);
    PDF::MultiCell(300, 5, '', 'L', 'C', false, 0);
    PDF::MultiCell(120, 5, '', 'L', 'C', false, 0);
    PDF::MultiCell(120, 5, '', 'LR', 'C', false, 0);
    PDF::MultiCell(20, 5, '', '', 'R', false);
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      PDF::SetFont($font, '', 9);
      PDF::MultiCell(50, 15, '', '', 'C', false, 0);
      PDF::MultiCell(90, 15, $accode, 'L', 'C', false, 0);
      PDF::MultiCell(10, 15, '', 'L', 'C', false, 0);
      PDF::MultiCell(290, 15, $acname, '', 'L', false, 0);
      PDF::SetFont('dejavusans', '', 11, '', true);
      PDF::MultiCell(20, 15, $dbcur, 'L', 'C', false, 0, '', '', false, 1, true);
      PDF::SetFont($font, '', 9);
      PDF::MultiCell(90, 15, $debit, '', 'R', false, 0);
      PDF::MultiCell(10, 15, '', '', 'R', false, 0);
      PDF::SetFont('dejavusans', '', 11, '', true);
      PDF::MultiCell(20, 15, $crcur, 'L', 'C', false, 0, '', '', false, 1, true);
      PDF::SetFont($font, '', 9);
      PDF::MultiCell(90, 15, $credit, '', 'R', false, 0);
      PDF::MultiCell(10, 15, '', 'R', 'R', false, 0);
      PDF::MultiCell(20, 15, '', '', 'R', false);
    }
    ...
    PDF::SetFont($font, '', 1);
    PDF::MultiCell(50, 5, '', '', 'C', false, 0);
    PDF::MultiCell(90, 5, '', 'T', 'C', false, 0);
    PDF::MultiCell(300, 5, '', 'T', 'C', false, 0);
    PDF::MultiCell(120, 5, '', 'T', 'C', false, 0);
    PDF::MultiCell(120, 5, '', 'T', 'C', false, 0);
    PDF::MultiCell(20, 5, '', '', '', false);
    ...
    PDF::MultiCell(103, 0, '', '', 'L', false, 0);
    PDF::MultiCell(250, 0, 'Checked By: ', '', 'L', false, 0);
    ...
    PDF::SetFont($font, '', 10);
    PDF::MultiCell(83, 0, '', '', 'L', false, 0);
    PDF::MultiCell(170, 0, $params['params']['dataparams']['prepared'], 'B', 'C', false, 0);
    PDF::MultiCell(183, 0, '', '', 'L', false, 0);
    PDF::MultiCell(170, 0, $params['params']['dataparams']['checked'], 'B', 'C', false, 0);
    PDF::MultiCell(103, 0, '', '', 'L');
  ...
  public function PDF_default_header_ccvoucher($params, $data)
  {
    ...
    PDF::Image('public/images/reports/tuv.jpg', '620', '35', 100, 40);
    ...
    PDF::SetFont($fontbold, '', 14);
    PDF::MultiCell(175, 25, 'JC REF. :', '', 'R', false, 0);
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(100, 25, (isset($data[0]['jcref']) ? $data[0]['jcref'] : ''), '', 'R', false);
  ...
  public function PDF_DEFAULT_CCVOUCHER_LAYOUT1($data, $params)
  {
    ...
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(550, 25, $remarks, 'TBL', 'L', false, 0);
    PDF::MultiCell(150, 25, number_format($totaldb, 2), 'TBLR', 'R', false);
    ...
    for ($i = 0; $i < count($data); $i++) {
      ...
      PDF::MultiCell(500, 25, $acname . ' ' . $data[$i]['project'], 'TBL', 'L', false, 0);
  ...
  public function PDF_CCVOUCHER_header2_LAYOUT2($data, $params)
  {
    $companyid = $params['params']['companyid'];
    $decimalcurr = $this->companysetup->getdecimal('currency', $params['params']);
    $decimalqty = $this->companysetup->getdecimal('qty', $params['params']);
    ...
    PDF::SetFont($fontbold, '', 14);
    PDF::MultiCell(300, 15, $this->modulename, '', 'L', false);

    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(600, 15, "APV #: ", '', 'R', false, 0, '',  '');
    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(100, 15, (isset($data[0]['docno']) ? $data[0]['docno'] : ''), 'B', 'C', false);

    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(100, 15, 'PAID TO : ', '', 'L', false, 0);
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(700, 15, (isset($data[0]['clientname']) ? $data[0]['clientname'] : ''), '', 'L', false);

    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(100, 15, 'ADDRESS : ', '', 'L', false, 0);
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(700, 15, (isset($data[0]['address']) ? $data[0]['address'] : ''), '', 'L', false);

    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(100, 15, 'PROJECT NAME : ', '', 'L', false, 0);
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(620, 15, (isset($data[0]['projname']) ? $data[0]['projname'] : ''), '', 'L', false);
    PDF::MultiCell(0, 0, "\n");

    PDF::SetFont($font, '', $fontsize);
    PDF::MultiCell(100, 15, 'REMARKS : ', '', 'L', false, 0);
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(700, 15, (isset($data[0]['rem']) ? $data[0]['rem'] : ''), '', 'L', false);
    ...
    // PDF::SetFont($font, '', $fontsize);
    // PDF::MultiCell(100, 0, 'JC# / Account ', 'TLRB', 'C', false, 0);
    // PDF::MultiCell(200, 0, 'Work Description', 'TLRB', 'C', false, 0);
    // PDF::MultiCell(100, 0, 'Notes', 'TLRB', 'C', false, 0);
    // PDF::MultiCell(100, 0, 'Amount', 'TLRB', 'C', false, 0);
    // PDF::MultiCell(100, 0, 'Deduction', 'TLRB', 'C', false, 0);
    // PDF::MultiCell(100, 0, 'Net Amount', 'TLRB', 'C', false);
  } //end fn

  public function PDF_CCVOUCHER_LAYOUT2($data, $params)
  {
    $companyid = $params['params']['companyid'];
    $decimalcurr = $this->companysetup->getdecimal('currency', $params['params']);
    $decimalqty = $this->companysetup->getdecimal('qty', $params['params']);
    ...
    PDF::SetMargins(40, 40);
    $this->PDF_CCVOUCHER_header2_LAYOUT2($data, $params);
    ...
    if (!empty($data)) {
      for ($i = 0; $i < count($data); $i++) {
        ...
        $wdescword = explode(' ', $data[$i]['workdesc']);
        $wdescwordstring = '';
        foreach ($wdescword as $word) {
          $wdescwordstring = $wdescwordstring . $word . ' ';
          if (strlen($wdescwordstring) > 30) {
            $wdescwordstring = str_replace($word, '', $wdescwordstring);
            array_push($arrwdesc, $wdescwordstring);
            $wdescwordstring = '';
            $wdescwordstring = $wdescwordstring . $word . ' ';
          }
        }
        ...
        if (!empty($arrwdesc)) {
          foreach ($arrwdesc as $arri) {
            if (strstr($arri, "\n")) {
              $array = preg_split("/\r\n|\n|\r/", $arri);
              foreach ($array as $arr) {
                array_push($wdescname, $arr);
              }
            } else {
              array_push($wdescname, $arri);
            }
          }
        }
        ////////////////////// end workdesc
        ...
        $remword = explode(' ', $data[$i]['jcrem']);
        $remwordstring = '';
        foreach ($remword as $word) {
          $remwordstring = $remwordstring . $word . ' ';
          if (strlen($remwordstring) > 19) {
            $remwordstring = str_replace($word, '', $remwordstring);
            array_push($arrrem, $remwordstring);
            $remwordstring = '';
            $remwordstring = $remwordstring . $word . ' ';
          }
        }
        ...
        if (!empty($arrrem)) {
          foreach ($arrrem as $arri) {
            if (strstr($arri, "\n")) {
              $array = preg_split("/\r\n|\n|\r/", $arri);
              foreach ($array as $arr) {
                array_push($remname, $arr);
              }
            } else {
              array_push($remname, $arri);
            }
          }
        }
        ////////////////////// end rem
        ...
        if ($data[$i]['jcdocno'] == "") {
          $jcdocno =  $data[$i]['acnoname'];
        } else {
          $jcdocno =  $data[$i]['jcdocno'];
        }
        ...
        $acctword = explode(' ', $jcdocno);
        $acctwordstring = '';
        foreach ($acctword as $word) {
          $acctwordstring = $acctwordstring . $word . ' ';
          if (strlen($acctwordstring) > 40) {
            $acctwordstring = str_replace($word, '', $acctwordstring);
            array_push($arracct, $acctwordstring);
            $acctwordstring = '';
            $acctwordstring = $acctwordstring . $word . ' ';
          }
        }
        ...
        if (!empty($arracct)) {
          foreach ($arracct as $arri) {
            if (strstr($arri, "\n")) {
              $array = preg_split("/\r\n|\n|\r/", $arri);
              foreach ($array as $arr) {
                array_push($acctname, $arr);
              }
            } else {
              array_push($acctname, $arri);
            }
          }
        }
        ////////////////////// end acct
        ...
        $countarrrem = count($remname);
        $countarracct = count($acctname);

        if ($countarr > $countarrrem || $countarr > $countarracct) {
          $maxrow = $countarr;
        } elseif ($countarrrem > $countarr || $countarrrem > $countarracct) {
          $maxrow = $countarrrem;
        } else {
          $maxrow = $countarracct;
        }
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          if ($data[$i]['refx'] == 0 && $data[$i]['acnoid'] == 5182) {
            PDF::SetFont($font, '', $fontsize);
            PDF::setCellPadding($left, $top, $right, $bottom);
            PDF::MultiCell(300, 0, isset($acctname[$r]) ? ' ' . $acctname[$r] : '', 'LR', 'L', false, 0, '', '', true, 1);
            PDF::MultiCell(100, 0, isset($remname[$r]) ? ' ' . $remname[$r] : '', 'LR', 'L', false, 0, '', '', false, 1);
            PDF::MultiCell(100, 0, '', 'LR', 'R', false, 0, '', '', false, 1);
            PDF::MultiCell(100, 0, '', 'LR', 'R', false, 0, '', '', false, 1);
            PDF::MultiCell(100, 0, $credit . ' ', 'LR', 'R', false, 1, '', '', false, 1);
          } else {
            ...
            if ($data[$i]['refx'] == 0) {
              ...
              PDF::MultiCell(100, 0, isset($acctname[$r]) ? ' ' . $acctname[$r] : '', 'LR', 'L', false, 0, '', '', true, 1);
              PDF::MultiCell(200, 0, isset($wdescname[$r]) ? ' ' . $wdescname[$r] : '', 'LR', 'L', false, 0, '', '', false, 1);
            }

            PDF::MultiCell(100, 0, isset($remname[$r]) ? ' ' . $remname[$r] : '', 'LR', 'L', false, 0, '', '', false, 1);
            PDF::MultiCell(100, 0, $debit . ' ', 'LR', 'R', false, 0, '', '', false, 1);
            PDF::MultiCell(100, 0, $credit . ' ', 'LR', 'R', false, 0, '', '', false, 1);
            PDF::MultiCell(100, 0, '', 'LR', 'R', false, 1, '', '', false, 1);
          }
        }
        PDF::SetFont($font, '', 0);
        PDF::MultiCell(700, 0, '', 'LRB', 'L');
        // }
        if (intVal($i) + 1 == $page) {
          $page += $count;
        }
    ...
    PDF::MultiCell(253, 0, $params['params']['dataparams']['prepared'], '', 'L', false);
    ...
    PDF::MultiCell(0, 0, "\n");
    PDF::MultiCell(100, 0, '', '', 'L', false, 0);
    PDF::MultiCell(253, 0, $params['params']['dataparams']['checked'], '', 'L', false);
    ...
    PDF::MultiCell(0, 0, "\n");
    PDF::MultiCell(100, 0, '', '', 'L', false, 0);
    PDF::MultiCell(253, 0, $params['params']['dataparams']['approved'], '', 'L', false);
  ...
  public function PDF_CV_WTAXREPORT($data, $params)
  {
    ...
    PDF::MultiCell(220, 30, (isset($data['head'][0]['tin']) ? $data['head'][0]['tin'] : ''), 'TBLR', 'C', false, 0, 165, 252);
    ...
    PDF::MultiCell(610, 30, (isset($data['head'][0]['payee']) ? $data['head'][0]['payee'] : ''), 'TBLR', 'L', false, 0, 165, 302);
    ...
    PDF::MultiCell(410, 30, (isset($data['head'][0]['address']) ? $data['head'][0]['address'] : ''), 'TBLR', 'L', false, 0, 165, 348);
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(30, 25, '4A', '', 'R', false, 0, 575, 353);
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(70, 25, 'Zip Code', '', 'L', false, 0, 605, 353);
    PDF::MultiCell(100, 30, (isset($data['res'][0]['zipcode']) ? $data['res'][0]['zipcode'] : ''), 'TBLR', 'C', false, 0, 675, 348);
    PDF::MultiCell(15, 30, '', 'R', 'C', false);
    ...
    PDF::MultiCell(410, 30, '', 'TBLR', 'C', false, 0, 165, 385);
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(30, 25, '5A', '', 'R', false, 0, 575, 390);
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(70, 25, 'Zip Code', '', 'L', false, 0, 605, 390);
    PDF::MultiCell(100, 30, '', 'TBLR', 'C', false, 0, 675, 385);
    PDF::MultiCell(15, 30, '', 'R', 'C', false);
    ...
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(125, 22, 'Tax Payer', '', 'L', false, 0);
    PDF::MultiCell(220, 30, (isset($data['head'][0]['payortin']) ? $data['head'][0]['payortin'] : ''), 'TBLR', 'L', false, 0, 165, 455);
    PDF::MultiCell(405, 30, '', 'R', 'C', false);
    ...
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(125, 26, "Payee's Name", '', 'L', false, 0, 40, 505);
    PDF::MultiCell(610, 30, (isset($data['head'][0]['payorcompname']) ? $data['head'][0]['payorcompname'] : ''), 'TBLR', 'L', false, 0, 165, 495);
    PDF::MultiCell(15, 30, '', 'R', 'C', false);
    ...
    //21st row
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(30, 25, '8', 'L', 'C', false, 0, 10, 540);
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(125, 25, "Registered Address", '', 'L', false, 0, 40, 540);
    PDF::MultiCell(410, 30, (isset($data['head'][0]['payoraddress']) ? $data['head'][0]['payoraddress'] : ''), 'TBLR', 'L', false, 0, 165, 540);
    PDF::SetFont($fontbold, '', 11);
    PDF::MultiCell(30, 25, '8A', '', 'R', false, 0, 575, 540);
    PDF::SetFont($font, '', 11);
    PDF::MultiCell(70, 25, 'Zip Code', '', 'L', false, 0, 605, 540);
    PDF::MultiCell(100, 30, (isset($data['head'][0]['payorzipcode']) ? $data['head'][0]['payorzipcode'] : ''), 'TBLR', 'C', false, 0, 675, 540);
    PDF::MultiCell(15, 30, '', 'R', 'C', false);
    ...
    if ($params['params']['dataparams']['tin'] == '') {
      PDF::MultiCell(165, 20, (isset($data['head'][0]['payortin']) ? $data['head'][0]['payortin'] : ''), 'B', 'C', false, 0);
    } else {
  ...
  public function report_default_query($filters)
  {
    ...
    switch ($filters['params']['dataparams']['reporttype']) {
      case 1:
        $query = "select head.trno,date(head.dateid) as dateid, right(head.docno,12) as docno,client.client,client.clientname,
                          head.address, head.terms,head.rem,proj.code as projcode, proj.name as projname,
                          detail.db,detail.cr,detail.refx,detail.linex,detail.damt,head.rem, jch.docno as jcdocno,
                          jch.workloc, jch.workdesc,jch.rem as jcrem,detail.acnoid,coa.acnoname
                  from lahead as head
                  left join ladetail as detail on detail.trno= head.trno
                  left join client on client.client=head.client
                  left join projectmasterfile as proj on proj.line= head.projectid
                  left join hjchead as jch on jch. trno = detail.refx
                  left join coa on coa.acnoid=detail.acnoid
                  where head.doc='PV' and head.trno = $trno and detail.db <> 0
                  union all
                  select head.trno,date(head.dateid) as dateid, right(head.docno,12) as docno,client.client,client.clientname,
                          head.address, head.terms,head.rem,proj.code as projcode, proj.name as projname,
                          detail.db,detail.cr,detail.refx,detail.linex,detail.damt,head.rem, jch.docno as jcdocno,
                          jch.workloc, jch.workdesc,jch.rem as jcrem,detail.acnoid,coa.acnoname
                  from glhead as head
                  ...
                  left join hjchead as jch on jch. trno = detail.refx
                  left join coa on coa.acnoid=detail.acnoid
                  where head.doc='PV' and head.trno = $trno and detail.cr <> 0
                  union all
                  select head.trno,date(head.dateid) as dateid, right(head.docno,12) as docno,client.client,client.clientname,
                          head.address, head.terms,head.rem,proj.code as projcode, proj.name as projname,
                          detail.db,detail.cr,detail.refx,detail.linex,detail.damt,head.rem, jch.docno as jcdocno,
      ...
      case 3:
        ...
        client.zipcode, center.tin as payortin, center.address as payoraddress, center.zipcode as payorzipcode, 
        center.name as payorcompname
        from lahead as head
        left join ladetail as detail on detail.trno=head.trno
        left join client on client.client=head.client
      ...
      default:
        $query = "select date(head.dateid) as dateid, head.docno, client.client, client.clientname, head.address, head.terms,
          ...
          (select  group_concat(ladetail.ref) as ref
          from lahead left join ladetail on ladetail.trno=lahead.trno
          where lahead.trno=head.trno) as jcref,proj.code as projcode,proj.name as projname
          from lahead as head 
          left join ladetail as detail on detail.trno=head.trno 
          left join client on client.client=head.client
          left join coa on coa.acnoid=detail.acnoid
          ...
          (select  group_concat(gldetail.ref) as ref
          from glhead left join gldetail on gldetail.trno=glhead.trno
          where glhead.trno=head.trno) as jcref,proj.code as projcode ,proj.name as projname
          from glhead as head 
          left join gldetail as detail on detail.trno=head.trno 
          left join client on client.clientid=head.clientid
          left join coa on coa.acnoid=detail.acnoid 
