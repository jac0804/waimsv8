...
class ba
{
  ...
  public function report_default_query($config)
  {
    ...
    $query = "select head.projectid,proj.code as projcode,proj.name as projname,head.rem,
                  ...
                  stock.rrqty,stock.rrcost,stock.ext,
                  (select uom from psubactivity as p where p.line=stock.subactivity and uom <> '' limit 1) as uom
              from bahead as head
  ...
  public function default_BA_PDF($params, $data)
  {
    ...
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(550, 0, 'Item No./Description', 'TLRB', 'C', false, 0);
    PDF::MultiCell(80, 0, 'Qty', 'TLRB', 'C', false, 0);
    PDF::MultiCell(80, 0, 'Unit', 'TLRB', 'C', false, 0);
    PDF::MultiCell(100, 0, 'Unit Price', 'TLRB', 'C', false, 0);
    PDF::MultiCell(100, 0, 'Total Price', 'TLRB', 'C', false);


    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(550, 0, 'A. ' . $data[0]['subproject'], 'TLRB', 'L', false, 0);
    PDF::MultiCell(80, 0, '', 'TLRB', 'C', false, 0);
    PDF::MultiCell(80, 0, '', 'TLRB', 'C', false, 0);
    PDF::MultiCell(100, 0, '', 'TLRB', 'C', false, 0);
    PDF::MultiCell(100, 0, '', 'TLRB', 'C', false);
    ...
    for ($i = 0; $i < count($data); $i++) {
      if ($data[$i]['subactivity'] == $subactivity) {
        ...
        PDF::MultiCell(520, 0, ' A. ' . '1.' . $aa . '.' . $o . ' ' . $data[$i]['description'], 'TRB', 'L', false, 0);
        PDF::MultiCell(80, 0, number_format($data[$i]['rrqty'], 2), 'TLRB', 'R', false, 0);
        PDF::MultiCell(80, 0, $data[$i]['uom'], 'TLRB', 'C', false, 0);
        PDF::MultiCell(100, 0, number_format($data[$i]['rrcost'], 2), 'TLRB', 'R', false, 0);
        PDF::MultiCell(100, 0, number_format($data[$i]['ext'], 2), 'TLRB', 'R', false);
        ...
        PDF::SetFont($fontbold, '', $fontsize);
        PDF::MultiCell(550, 0, 'A.' . '1.' . $aa . ' ' . $data[$i]['subactivity'], 'TLRB', 'L', false, 0);
        PDF::MultiCell(80, 0, '', 'TLRB', 'C', false, 0);
        PDF::MultiCell(80, 0, '', 'TLRB', 'C', false, 0);
        PDF::MultiCell(100, 0, '', 'TLRB', 'C', false, 0);
        PDF::MultiCell(100, 0, '', 'TLRB', 'C', false);
        ...
        $arr_description = $this->reporter->fixcolumn([$data[$i]['description']], '90', 0);
        $maxrow = count($arr_description);
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::MultiCell(520, 0, $a . $aa . '.' . $bb . ' ' . (isset($arr_description[$r]) ? $arr_description[$r] : ''), 'R', 'L', false, 0);
          PDF::MultiCell(80, 0, $qty, 'LR', 'R', false, 0);
          PDF::MultiCell(80, 0, $uom, 'LR', 'C', false, 0);
          PDF::MultiCell(100, 0, $rrcost, 'LR', 'R', false, 0);
          PDF::MultiCell(100, 0, $ext, 'LR', 'R', false);
          $bb = 0;
        }
    ...
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(30, 0, '', 'TLB', 'C', false, 0);
    PDF::MultiCell(520, 0, '', 'TB', 'L', false, 0);
    PDF::MultiCell(80, 0, '', 'TB', 'R', false, 0);
    PDF::MultiCell(80, 0, '', 'TB', 'C', false, 0);
    PDF::MultiCell(100, 0, 'Total Amount', 'TRB', 'R', false, 0);
    PDF::MultiCell(100, 0, number_format($totalprice, 2), 'TLRB', 'R', false);
