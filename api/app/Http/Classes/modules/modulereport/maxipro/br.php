...
class br
{
  ...
  public function default_BR_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(100, 20, "Qty", 'TLB', 'C', false, 0, '', '', true, 0, false, true, 0, 'M', true);
    ...
    PDF::MultiCell(200, 20, "Remarks", 'TLBR', 'C', false, 1, '', '', true, 0, false, true, 0, 'M', true);
  }
  ...
  public function default_BR_PDF($params, $data)
  {
    ...
    if (!empty($data)) {
      ...
      for ($i = 0; $i < count($data); $i++) {
        ...
        for ($r = 0; $r < $maxrow; $r++) {
          ...
          PDF::MultiCell(100, 0, (isset($arr_qty[$r]) ? $arr_qty[$r] : ''), 'L', 'C', false, 0, '', '', false, 1);
          ...
          PDF::SetFont($font, '', $fontsize);
          PDF::MultiCell(200, 0, (isset($arr_rem[$r]) ? $arr_rem[$r] : ''), 'LR', 'L', false);
        }
    ...
    PDF::MultiCell(650, 20, '***** NOTHING FOLLOWS *****', 'LB', 'C', false, 0, '', '', false, 1);
    PDF::MultiCell(200, 20, '', 'LRB', 'L', false);
    ...
    PDF::SetFont($fontbold, '', $fontsize);
    PDF::MultiCell(500, 20, "TOTAL ", 'TLB', 'R', false, 0, '', '', true, 0, false, true, 0, 'M', true);
    ...
    PDF::MultiCell(200, 20, '', 'TLBR', 'L', false, 1, '', '', false, 1);
  ...
  private function addrow($border)
  {
    ...
    PDF::MultiCell(100, 0, '', $border, 'R', false, 0, '', '', false, 1);
    PDF::MultiCell(100, 0, '', $border, 'R', false, 0, '', '', false, 1);
    PDF::MultiCell(200, 0, '', $border, 'L', false);
  }
}
