...
class ds
{
  ...
  public function report_default_query($filters)
  {
    ...
    detail.cr, detail.line,coa.alias,hcoa.acnoname as bankname
    from ((lahead as head 
    ...
    where head.doc='ds' and md5(head.trno)='$trno' order by db desc";
  ...
  public function default_DS_header_PDF($params, $data)
  {
    ...
    PDF::MultiCell(520, 0, strtoupper($this->modulename), '', 'L', false, 0, '',  '120');
    ...
    PDF::MultiCell(410, 0, (isset($data[0]->bankname) ? $data[0]->bankname : ''), 'B', 'L', false, 0, '',  '');
    PDF::SetFont($fontbold, '', $fontsize);
