...
class entrypayrollpicture
{
    ...
    private $table = 'loan_picture';
    private $othersClass;
    public $style = 'width:100%;min-width:100%;';
    private $fields = ['doc', 'trno', 'line', 'title', 'picture'];
    ...
    public function createTab($config)
    {
        ...
        $submited = $this->coreFunctions->datareader("select date(submitdate) as value from loanapplication where trno = ?", [$trno]);
    ...
    private function selectqry($config)
    {
        ...
        $qry = "'$doc' as type,md5(trno) as trno2,md5(line) as line2,trno,line,title,picture,
