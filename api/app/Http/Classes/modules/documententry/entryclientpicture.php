...
class entryclientpicture
{
  ...
  public function createTab($config)
  {
    ...
    if ($doc == 'MYINFO') {
      $this->modulename = 'DOCUMENTS - ' . $customername;
    } else {
  ...
  {
    $qry = "'ledger' as type,md5(trno) as trno2,md5(line) as line2,trno,line,title,picture,left(encodeddate, 10) as encodeddate,encodedby,right(picture,3) as ext";
