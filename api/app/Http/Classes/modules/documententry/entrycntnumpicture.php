...
class entrycntnumpicture
{
  ...
  {
    $qry = "'cp' as type,md5(trno) as trno2,md5(line) as line2,trno,line,title,picture,left(encodeddate, 10) as encodeddate,encodedby,SUBSTRING_INDEX(picture,'.',-1) as ext";
