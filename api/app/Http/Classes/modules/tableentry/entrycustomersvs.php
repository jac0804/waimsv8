...
class entrycustomersvs
{
    private $fieldClass;
    private $tabClass;
    public $modulename = 'SVS #';
    ...
    private $fields = ['clientid', 'sano', 'issvs'];
    ...
    public function createTab($config)
    {
        ...
        $obj[0][$this->gridname]['columns'][$sano]['label'] = "SVS #";
        return $obj;
    }
    ...
    {
        $select = "sa.line, sa.clientid, sa.sano, sa.issvs";
        return $select;
    }
    ...
    private function loaddataperrecord($config, $line)
    {
        ...
        $qry = "select  " . $select . ", '' as bgcolor
            ...
            where sa.clientid = ? and sa.line = ? and sa.issvs = 1";
    ...
    public function loaddata($config)
    {
        ...
        $qry = "select " . $select . ", '' as bgcolor 
                from clientsano as sa
                where sa.clientid = ? and sa.issvs = 1 ";
