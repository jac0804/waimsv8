...
class entryqtnotes
{
  ...
  public function createTab($config)
  {
    ...
    if ($isposted || $islocked) {
      ...
      $obj[0][$this->gridname]['columns'][1]['lookupclass'] = 'addonrem';
    }
    return $obj;
  }
  ...
  {
    $qry = "select line, trno, rem, '' as bgcolor from qtaddons where trno=? and line=? and addontype=4 union all select line, trno, rem, '' as bgcolor from hqtaddons where trno=? and line=? and addontype=4";
  ...
  {
    $tableid = $config['params']['tableid'];
    $qry = "select line, trno, rem, '' as bgcolor from qtaddons where trno=? and addontype=4 union all select line, trno, rem, '' as bgcolor from hqtaddons where trno=? and addontype=4 order by line";
  ...
  public function lookupsetup($config)
  {
    ...
    switch ($lookupclass2) {
      case 'addonrem':
        ...
        $qry = "select distinct rem from qtaddons where addontype=4 order by rem";
