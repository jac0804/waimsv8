...
class entrywhjobreq
{
  private $fieldClass;
  private $tabClass;
  public $modulename = 'JOB REQUESTS';
  public $gridname = 'inventory';
  private $companysetup;
  private $coreFunctions;
  private $logger;
  private $table = 'whjobreq';
  private $othersClass;
  ...
  public function createTab($config)
  {
    $tab = [
      $this->gridname => [
        'gridcolumns' => ['action', 'docno', 'issued', 'expiry', 'dateid', 'oic1', 'oic2', 'status']
      ]
    ];
    ...
    $obj[0][$this->gridname]['columns'][1]['style'] = "width:700px;whiteSpace: normal;min-width:700px;";
    ...
    $obj[0][$this->gridname]['columns'][5]['style'] = "width:100px;whiteSpace: normal;min-width:150px;";
    $obj[0][$this->gridname]['columns'][6]['style'] = "width:100px;whiteSpace: normal;min-width:150px;";
    $obj[0][$this->gridname]['columns'][7]['style'] = "width:500px;whiteSpace: normal;min-width:500px;";
    $obj[0][$this->gridname]['columns'][8]['style'] = "width:100px;whiteSpace: normal;min-width:150px;";


    $obj[0][$this->gridname]['columns'][1]['label'] = "Job Requests";
    $obj[0][$this->gridname]['columns'][2]['type'] = "date";
    $obj[0][$this->gridname]['columns'][2]['readonly'] = false;
    $obj[0][$this->gridname]['columns'][3]['type'] = "date";
    $obj[0][$this->gridname]['columns'][3]['readonly'] = false;
    $obj[0][$this->gridname]['columns'][4]['label'] = 'Date Needed';
    return $obj;
  }
    ...
    foreach ($data as $key => $value) {
      ...
      if ($data[$key]['bgcolor'] != '') {
        ...
        if ($data[$key]['line'] == 0) {
          ...
          $data2['rem'] = '';
          $this->logger->sbcwritelog($tableid, $config, 'WH JOB REQUESTS', ' CREATE - ' . $data[$key]['docno']);
  ...
  public function save($config)
  {
    ...
    if ($row['line'] == 0) {
      ...
      if ($line != 0) {
        ...
        $this->logger->sbcwritelog($tableid, $config, 'WH JOB REQUESTS', ' CREATE - ' . $data['docno']);
  ...
  public function delete($config)
  {
    ...
    if (!empty($data)) {
      $this->logger->sbcwritelog($tableid, $config, 'WH JOB REQUESTS', 'REMOVE - ' . $data[0]->docno);
    }
  ...
  public function lookuplogs($config)
  {
    ...
    where log.trno= ? and log.field = 'WH JOB REQUESTS'
    union all
