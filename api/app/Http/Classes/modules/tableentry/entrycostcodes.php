...
class entrycostcodes
{
  private $fieldClass;
  private $tabClass;
  public $modulename = 'COST CODES';
  public $gridname = 'inventory';
  private $companysetup;
  private $coreFunctions;
  private $table = 'costcode_masterfile';
  private $othersClass;
  ...
  public function createTab($config)
  {
    ...
    $obj[0][$this->gridname]['columns'][1]['style'] = "width:90px;whiteSpace: normal;min-width:90px;";
    $obj[0][$this->gridname]['columns'][2]['style'] = "width:200px;whiteSpace: normal;min-width:200px;";

    $obj[0][$this->gridname]['columns'][1]['maxlength'] = 20;
  ...
  public function saveallentry($config)
  {
    ...
    $dateTables = ['costcode_masterfile'];
    ...
    foreach ($data as $key => $value) {
      ...
      if ($data[$key]['bgcolor'] != '') {
        ...
        if ($data[$key]['line'] == 0) {
          ...
          $this->logger->sbcmasterlog($line, $config, ' CREATE - ' . $data[$key]['code'] . ' - ' . $data[$key]['name']);
        } else {
  ...
  public function delete($config)
  {
    ...
    $qry = "select costcodeid as value from lahead where costcodeid = ? union all
            select costcodeid as value from glhead where costcodeid = ?";
  ...
  public function loaddata($config)
  {
    ...
    $select = $this->selectqry();
    $select = $select . ",'' as bgcolor ";
    $qry = "select " . $select . " from " . $this->table . " where 1=1 " . $filtersearch . " order by name "  . $l;
