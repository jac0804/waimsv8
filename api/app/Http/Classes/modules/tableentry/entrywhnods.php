...
class entrywhnods
{
  private $fieldClass;
  private $tabClass;
  public $modulename = 'NODS';
  public $gridname = 'inventory';
  private $companysetup;
  private $coreFunctions;
  private $logger;
  private $table = 'whnods';
  private $othersClass;
  ...
  public function createTab($config)
  {
    ...
    $obj[0][$this->gridname]['columns'][1]['label'] = "Nods";
    ...
    foreach ($data as $key => $value) {
      ...
      if ($data[$key]['bgcolor'] != '') {
        ...
        if ($data[$key]['line'] == 0) {
          ...
          $data2['rem'] = '';
          $this->logger->sbcwritelog($tableid, $config, 'WH NODS', ' CREATE - ' . $data[$key]['docno']);
  ...
  public function save($config)
  {
    ...
    if ($row['line'] == 0) {
      ...
      if ($line != 0) {
        ...
        $this->logger->sbcwritelog($tableid, $config, 'WH NODS', ' CREATE - ' . $data['docno']);
  ...
  public function delete($config)
  {
    ...
    if (!empty($data)) {
      $this->logger->sbcwritelog($tableid, $config, 'WH NODS', 'REMOVE - ' . $data[0]->docno);
    }
  ...
  public function lookuplogs($config)
  {
    ...
    where log.trno= ? and log.field = 'WH NODS'
    union all
