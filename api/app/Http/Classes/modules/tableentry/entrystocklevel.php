...
class entrystocklevel
{
  private $fieldClass;
  private $tabClass;
  public $modulename = 'STOCK LEVEL';
  ...
  private $fields = ['center', 'itemid', 'min', 'max'];
  ...
  public function createTab($config)
  {
    ...
    $tab = [
      $this->gridname => [
        'gridcolumns' => ['action', 'center', 'min', 'max']
      ]
    ];
    ...
    // uom    
    $obj[0][$this->gridname]['columns'][1]['label'] = "Warehouse";
  ...
  {
    if ($config['params']['lookupclass2'] == 'addwarehouse') {
  ...
  public function lookupwh($config)
  {
    ...
    $qry = "select client,clientname from client where iswarehouse=1";
  ...
  private function loaddataperrecord($itemid, $line)
  {
    ...
    $qry = "select " . $select . " from itemlevel where itemid=? and id=?";
  ...
  public function loaddata($config)
  {
    ...
    $select = $this->selectqry();
    $select = $select . ",'' as bgcolor ";
    $qry = "select " . $select . " from itemlevel where itemid=? order by id";
