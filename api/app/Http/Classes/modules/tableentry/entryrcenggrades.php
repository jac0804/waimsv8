...
class entryrcenggrades
{
  private $fieldClass;
  private $tabClass;
  public $modulename = 'ENGLISH GRADES';
  ...
  public function loaddata($config)
  {
    ...
    $qry = "select qg.trno, qg.line, qg.scoregrade as gcscoregrade, qg.totalgrade as gcsubnoofitems, qg.quarterid, round(qg.tentativetotal,2) as gcpercentgrade, round(qg.finaltotal,2) as gcfinaltotal, round(qg.rcardtotal," . $rcdecimal . ") as gcrcardtotal, sub.subjectname, q.name as quartername, '' as bgcolor from " . $this->table . " as qg left join en_subject as sub on sub.trno=qg.subjectid left join en_quartersetup as q on q.line=qg.quarterid where qg.clientid=? and sub.ischinese=0 and qg.isconduct=0 ";
