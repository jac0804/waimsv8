...
class entrycustomerpo
{
    ...
    private $fields = ['clientid', 'sano', 'ispo'];
    ...
    public function createTab($config)
    {
        ...
        $obj[0][$this->gridname]['columns'][$sano]['label'] = "PO #";
        return $obj;
    }
    ...
    {
        $select = "sa.line, sa.clientid, sa.sano, sa.ispo";
        return $select;
    }
    ...
    private function loaddataperrecord($config, $line)
    {
        ...
        $qry = "select  " . $select . ", '' as bgcolor
            ...
            where sa.clientid = ? and sa.line = ? and sa.ispo = 1";
    ...
    public function loaddata($config)
    {
        ...
        $qry = "select " . $select . ", '' as bgcolor 
                from clientsano as sa
                where sa.clientid = ? and sa.ispo = 1 ";
