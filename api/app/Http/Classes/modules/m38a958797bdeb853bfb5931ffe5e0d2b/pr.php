...
namespace App\Http\Classes\modules\m38a958797bdeb853bfb5931ffe5e0d2b;
...
when num.postdate is null and num.statid=36 then 'APPROVED' when num.postdate is not null then 'POSTED' else 'DRAFT' end) ";
        }
    ...
    public function createTab($access, $config)
    {
        ...
        $obj[0]['inventory']['columns'][$whname]['type'] = 'hidden';
        $obj[0]['inventory']['columns'][$whname]['label'] = '';
        $obj[0]['inventory']['columns'][$whname]['style'] = 'width: 40px;whiteSpace: normal;min-width:40px;max-width:40px';

        $obj[0]['inventory']['columns'][$rem]['type'] = 'input';
        $obj[0]['inventory']['columns'][$rem]['label'] = 'Reason';

        $obj[0]['inventory']['columns'][$requestorname]['type'] = 'input';
        $obj[0]['inventory']['columns'][$requestorname]['label'] = 'Requestor';
        $obj[0]['inventory']['columns'][$requestorname]['readonly'] = 'false';
        $obj[0]['inventory']['columns'][$requestorname]['style'] = 'width: 150px;whiteSpace: normal;min-width:150px;max-width:150px';
    ...
    public function posttrans($config)
    {
        ...
        if ($posthead) {
            ...
            if ($this->coreFunctions->execqry($qry, 'insert', [$trno])) {
                ...
                $this->coreFunctions->execqry("delete from " . $this->stock . " where trno=?", "delete", [$trno]);
                $this->coreFunctions->execqry("delete from " . $this->head . " where trno=?", "delete", [$trno]);
                $this->coreFunctions->execqry("delete from " . $this->infostock . " where trno=?", "delete", [$trno]);
    ...
    public function unposttrans($config)
    {
        ...
        from " . $this->hstock . " where trno=?";
            ...
            if ($this->coreFunctions->execqry($qry, 'insert', [$trno])) {
                ...
                $this->coreFunctions->execqry("delete from " . $this->hinfostock . " where trno=?", "delete", [$trno]);
    ...
    public function openstock($trno, $config)
    {
        ...
        left join $this->infostock as sit on sit.trno = stock.trno and sit.line=stock.line
        ...
        left join frontend_ebrands as brand on brand.brandid = item.brand
        left join iteminfo as i on i.itemid  = item.itemid
        left join $this->hinfostock as sit on sit.trno = stock.trno and sit.line=stock.line
        ...
        ";
            ...
            if (!empty($data)) {
                foreach ($data as $key2 => $value) {
                    ...
                    $config['params']['data']['requestorname'] = '';
    ...
    public function additem($action, $config)
    {
        ...
        $requestorname = '';
        if (isset($config['params']['data']['requestorname'])) {
    ...
    public function deleteitem($config)
    {
        ...
        $this->coreFunctions->execqry('delete from ' . $this->infostock . ' where trno=? and line=?', 'delete', [$trno, $line]);
