...
class ab
{
    ...
    private $fieldClass;
    private $tabClass;
    public $modulename = 'BILLET TO FINISHED GOODS';
    ...
    public function createTab($access, $config)
    {
        ...
        $columns = ['action', 'itemdescription', 'rrqty', 'uom', 'rrcost', 'cost', 'ext', 'wh', 'ref', 'itemname', 'barcode'];
    ...
    public function createHeadField($config)
    {
        ...
        data_set($col2, 'isacnoname.label', 'IN Account');
        data_set($col2, 'isacnoname.lookupclass', 'IN');
    ...
    stock.projectid as projectid,prj.code as project,
    ...
    {
        $companyid = $config['params']['compnayid'];
