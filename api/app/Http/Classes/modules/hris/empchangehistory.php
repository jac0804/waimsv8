...
class empchangehistory
{
    private $btnClass;
    private $fieldClass;
    private $tabClass;
    public $modulename = 'EMPLOYMENT STATUS CHANGE HISTORY';
    ...
    public function loaddoclisting($config)
    {
        ...
        $qry = "select e.empid as clientid, client.client as empcode,
          ...
          where 1=1 and e.resigned is null " . $filtersearch . "
          ";
    ...
    {
        $tbuttons = ['viewempstatchangehistory'];
    ...
    public function loadheaddata($config)
    {
        ...
        $qry = "select e.empid as clientid, client.client as client,
            concat(e.empfirst,' ',e.empmiddle, ' ', e.emplast) as empname,
            jt.docno as jobcode, jt.jobtitle,c.client as deptcode, c.clientname as deptname,
            jt.line as jobid,
            date(e.hired) as hired
