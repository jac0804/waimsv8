...
class ho
{
  ...
  public $head = 'turnoveritemhead';
  public $hhead = 'hturnoveritemhead';
  public $detail = 'turnoveritemdetail';
  public $hdetail = 'hturnoveritemdetail';
  ...
  public function createdoclisting($config)
  {
    ...
    $cols[$empname]['style'] = 'width:400px;whiteSpace: normal;min-width:400px;';
    return $cols;
  }
  ...
  public function createTab($access, $config)
  {
    ...
    $obj[0][$this->gridname]['columns'][$itemname]['style'] = "width:650px;whiteSpace: normal;min-width:650px;";
  ...
  public function createHeadField($config)
  {
    ...
    data_set($col2, 'jobtitle.readonly', true);
  ...
  public function posttrans($config)
  {
    ...
    if ($result === 1) {
      ...
      $qry = "insert into " . $this->hdetail . " (trno, line, itemname, amt, rem) select trno, line, itemname, amt, rem from " . $this->detail . " where trno=?";
      $result = $this->coreFunctions->execqry($qry, 'insert', [$trno]);
      if ($result === 1) {
      } else {
  ...
  public function unposttrans($config)
  {
    ...
    if ($result === 1) {
      ...
      $qry = "insert into " . $this->detail . " (trno, line, itemname, amt, rem) select trno, line, itemname, amt, rem from " . $this->hdetail . " where trno=?";
      $result = $this->coreFunctions->execqry($qry, 'insert', [$trno]);
      if ($result === 1) {
      } else {
  ...
  {
    $qry = "line,trno,itemname,amt,rem,'' as bgcolor";
    return $qry;
  }
  ...
  public function deleteallitem($config)
  {
    ...
    $trno = $config['params']['trno'];
    $this->coreFunctions->execqry('delete from ' . $this->detail . ' where trno=?', 'delete', [$trno]);
    $this->logger->sbcwritelog($trno, $config, 'ITEM', 'DELETED ALL ITEMS');
