...
class restday
{
    ...
    public function paramsdata($config)
    {
        ...
        $query = "
                ...
                where cs.status= 0 and cs.line = ? and cs.isrestday = 1";
    ...
    public function loaddata($config)
    {
        ...
        if (isset($config['params']['dataparams']['line'])) {
            ...
            if ($update) {
                ...
                return ['status' => true, 'msg' => 'Successfully ' . $label . ' ', 'data' => [], 'reloadsbclist' => true, 'action' => 'restday'];
            }
        }
