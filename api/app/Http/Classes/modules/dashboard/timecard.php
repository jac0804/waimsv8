...
class timecard
{
    ...
    public function createHeadField($config)
    {
        ...
        $daytype = isset($config['params']['data']['daytype']) ? $config['params']['data']['daytype'] : '';
    ...
    public function paramsdata($config)
    {
        ...
        switch ($label) {
            case "n": //notice
                $this->modulename = 'SCHEDULE NOTICE';
                $query = "select dateid,title,rem from waims_notice where empid = " . $empid . " and line = " . $line;
