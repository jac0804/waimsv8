...
class so
{
    private $fieldClass;
    private $tabClass;
    public $modulename = 'SO TRANSACTION';
    ...
    public function paramsdata($config)
    {
        ...
        switch ($classid) {
            case 'posted':
                $this->modulename = 'POSTED - SO TRANSACTION';
                break;
            case 'unposted':
                $this->modulename = 'UNPOSTED - SO TRANSACTION';
                break;
        }
    ...
    public function loaddata($config)
    {
        ...
        switch ($classid) {
            case 'posted':
                ...
                where head.doc = '$doc' and num.center = '$center' $filter
