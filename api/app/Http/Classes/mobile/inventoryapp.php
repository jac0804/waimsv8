...
class inventoryapp
{
  ...
  public function getDownloads()
  {
    $downloads = [
      ...
      ['name' => 'viewclientitem', 'label' => 'View Client Item Table', 'func' => 'viewclientitem'],
      ['name' => 'viewitembal', 'label' => 'View Item Balance', 'func' => 'viewitembal'],
      ['name' => 'viewitemitable', 'label' => 'View Item', 'func' => 'viewitemitable'],
