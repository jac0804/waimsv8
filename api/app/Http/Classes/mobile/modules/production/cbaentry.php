...
class cbaentry {
  ...
  public function getLayout() {
    ...
    array_push($cLookupHeadButtons, ['form'=>'cbaentrydocLookupHeadButtons', 'btns'=>$docLookupButtons]);

    $btns = ['stockinfo'];
    $docLookupTableButtons = $this->buttonClass->create($btns);

    array_push($cLookupTableButtons, ['form'=>'cbaentrydocLookupTableButtons', 'btns'=>$docLookupTableButtons]);

    array_push($cLookupHeadFields, ['form'=>'cbaentrydocLookupFields', 'fields'=>$docLookupFields]);
    ...
    array_push($cLookupTableCols, ['form'=>'cbaentrydocLookupTableCols', 'fields'=>$docLookupTableCols]);
