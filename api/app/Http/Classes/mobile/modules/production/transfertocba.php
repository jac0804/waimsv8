...
class transfertocba {
  ...
  public function getLayout() {
    ...
    array_push($cLookupHeadButtons, ['form'=>'tscbadocLookupHeadButtons', 'btns'=>$docLookupButtons]);

    $btns = ['stockinfo'];
    $docLookupTableButtons = $this->buttonClass->create($btns);

    array_push($cLookupTableButtons, ['form'=>'tscbadocLookupTableButtons', 'btns'=>$docLookupTableButtons]);

    array_push($cLookupHeadFields, ['form'=>'tscbadocLookupFields', 'fields'=>$docLookupFields]);
    ...
    array_push($cLookupTableCols, ['form'=>'tscbadocLookupTableCols', 'fields'=>$docLookupTableCols]);
