...
class receivingreport {
  ...
  public function getLayout() {
    ...
    data_set($docLookupButtons, 'scan.color', 'white');
    data_set($docLookupButtons, 'upload.color', 'white');
    array_push($cLookupHeadButtons, ['form'=>'rrdocLookupHeadButtons', 'btns'=>$docLookupButtons]);

    $btns = ['stockinfo'];
    $docLookupTableButtons = $this->buttonClass->create($btns);

    array_push($cLookupTableButtons, ['form'=>'rrdocLookupTableButtons', 'btns'=>$docLookupTableButtons]);

    array_push($cLookupHeadFields, ['form'=>'rrdocLookupFields', 'fields'=>$docLookupFields]);
    ...
    array_push($cLookupTableCols, ['form'=>'rrdocLookupTableCols', 'fields'=>$docLookupTableCols]);
    ...
    data_set($stockLookupFields, 'rem.label', 'Issue Remarks');
    array_push($inputLookupFields, ['form'=>'rrstockLookupFields', 'fields'=>$stockLookupFields]);
    ...
    array_push($inputLookupButtons, ['form'=>'rrstockLookupButtons', 'btns'=>$stockLookupButtons]);

    $fields = ['codenotlocate', 'searchcode'];
    $codeNotLocatedLookupFields = $this->fieldClass->create($fields);
    array_push($inputLookupFields, ['form'=>'rrcodeNotLocatedFields', 'fields'=>$codeNotLocatedLookupFields]);

    $btns = ['saverecord', 'cancelrecord'];
    $codeNotLocatedLookupButtons = $this->buttonClass->create($btns);
    data_set($codeNotLocatedLookupButtons, 'saverecord.func', 'searchCodeProd');
    data_set($codeNotLocatedLookupButtons, 'saverecord.functype', 'global');
    data_set($codeNotLocatedLookupButtons, 'saverecord.label', 'Search');
    data_set($codeNotLocatedLookupButtons, 'cancelrecord.func', 'cancelsearchCodeProd');
    data_set($codeNotLocatedLookupButtons, 'cancelrecord.functype', 'global');
    array_push($inputLookupButtons, ['form'=>'rrcodeNotLocatedButtons', 'btns'=>$codeNotLocatedLookupButtons]);
