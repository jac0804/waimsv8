...
class transfertoga {
  ...
  public function getLayout() {
    ...
    array_push($cLookupHeadButtons, ['form'=>'tsgadocLookupHeadButtons', 'btns'=>$docLookupButtons]);

    $btns = ['stockinfo'];
    $docLookupTableButtons = $this->buttonClass->create($btns);

    array_push($cLookupTableButtons, ['form'=>'tsgadocLookupTableButtons', 'btns'=>$docLookupTableButtons]);

    array_push($cLookupHeadFields, ['form'=>'tsgadocLookupFields', 'fields'=>$docLookupFields]);
    ...
    array_push($cLookupTableCols, ['form'=>'tsgadocLookupTableCols', 'fields'=>$docLookupTableCols]);
