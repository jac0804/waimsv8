...
use App\Http\Classes\mobile\modules\timeinapp\timeinout;
...
class timeinapp {
  ...
  public function manualLoginLayout () {
    ...
    data_set($loginBtns, 'login.func', 'timeinAppGuardLogin');
    $mlbuttons = [];
  ...
  public function getMainMenu () {
    $menu = [
      ['type'=>'timeinapp', 'name'=>'timeinout', 'label'=>'Time In/Out', 'doc'=>'timeinout', 'icon'=>'table_chart', 'layout'=>'customform', 'isdefault'=>true]
    ];
    return $menu;
  }
