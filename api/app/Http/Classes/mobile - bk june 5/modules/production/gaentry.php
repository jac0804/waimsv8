...
class gaentry {
  ...
  public function getLayout() {
    ...
    array_push($cLookupHeadButtons, ['form'=>'gaentrydocLookupHeadButtons', 'btns'=>$docLookupButtons]);

    $btns = ['stockinfo'];
    $docLookupTableButtons = $this->buttonClass->create($btns);

    array_push($cLookupTableButtons, ['form'=>'gaentrydocLookupTableButtons', 'btns'=>$docLookupTableButtons]);

    array_push($cLookupHeadFields, ['form'=>'gaentrydocLookupFields', 'fields'=>$docLookupFields]);
    ...
    array_push($cLookupTableCols, ['form'=>'gaentrydocLookupTableCols', 'fields'=>$docLookupTableCols]);
