...
class cclexit {
  ...
  public function getLayout() {
    ...
    $cLookupHeadFields = [];
    $fields = ['barcode', 'itemname', 'groupid', 'class', 'thickness', 'width', 'shiftt', 'seltype', 'designation', 'mass', 'weight', 'color', 'paintsupp', 'addexit'];
    ...
    data_set($stockLookupFields, 'color.type', 'lookup');
    data_set($stockLookupFields, 'color.action', 'colorlookup');
    data_set($stockLookupFields, 'color.fields', 'color');
