...
class transfertoccl {
  ...
  public function getLayout() {
    ...
    array_push($cLookupHeadButtons, ['form'=>'tsccldocLookupHeadButtons', 'btns'=>$docLookupButtons]);

    $btns = ['stockinfo'];
    $docLookupTableButtons = $this->buttonClass->create($btns);

    array_push($cLookupTableButtons, ['form'=>'tsccldocLookupTableButtons', 'btns'=>$docLookupTableButtons]);

    array_push($cLookupHeadFields, ['form'=>'tsccldocLookupFields', 'fields'=>$docLookupFields]);
    ...
    array_push($cLookupTableCols, ['form'=>'tsccldocLookupTableCols', 'fields'=>$docLookupTableCols]);
